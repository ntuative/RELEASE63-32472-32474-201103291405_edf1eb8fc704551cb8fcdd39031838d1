package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_525:IKeyExchange;
      
      private var var_977:String;
      
      private var _view:HabboLoginDemoView;
      
      private var var_2577:PseudoRandom;
      ...
      private const const_1792:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_637 = param1;
            this.var_56.initConnection(HabboConnectionType.const_232);
         }
      }
      ...
      {
         if(this.var_56 && this.var_164 && this.var_15 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_637 = this.var_164.getKey("sso.ticket",null);
         this.var_1830 = this.var_164.getKey("flash.client.url","");
         this.var_2578 = this.var_164.getKey("external.variables.txt","");
         if(this.var_224 == null)
         {
            this.var_224 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
         if(_loc3_)
         {
            this.var_56.mode = HabboConnectionType.const_92;
            if(this.var_637)
            {
               this.var_56.initConnection(HabboConnectionType.const_232);
            }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_56.mode = HabboConnectionType.const_1061;
            }
         }
         this.var_56.initConnection(HabboConnectionType.const_232);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_798);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2577 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_56.mode)
         {
            case HabboConnectionType.const_92:
               ...
               this.var_224.loadBannerImage(_loc7_ + "?token=" + this.var_1452,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1061:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1725:
               this.var_977 = this.generateRandomHexString(30);
               this.var_525 = new DiffieHellman(new BigInteger(this.var_164.getKey("connection.development.prime"),16),new BigInteger(this.var_164.getKey("connection.development.generator"),16));
               this.var_525.init(this.var_977);
               _loc8_ = this.var_525.getPublicKey(10);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_525.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_525.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2577);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         this.var_1453 = true;
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_263);
         connection.send(new VersionCheckMessageComposer(401,this.var_1830,this.var_2578));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1792,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_637 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_637);
            _loc2_.send(_loc4_);
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2579)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         this.var_525 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_525.init(_loc14_);
            _loc15_ = this.var_525.getPublicKey(10);
            if(_loc15_.length >= 64)
            {
               _loc12_ = _loc15_;
               this.var_977 = _loc14_;
            }
