package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_169.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_150,HabboWindowStyle.const_43,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_1792,"/");
         if(_loc5_ != null)
         {
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_1792,"/");
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         {
            this.var_142.removeEventListener(SSOTicket.const_397,this.onParsedTicketSuccess);
            this.var_142.removeEventListener(SSOTicket.const_283,this.onParsedTicketFailure);
            this.var_142 = null;
         }
         var _loc2_:String = "";
         ...
         this.var_142.addEventListener(SSOTicket.const_397,this.onParsedTicketSuccess);
         this.var_142.addEventListener(SSOTicket.const_283,this.onParsedTicketFailure);
      }
