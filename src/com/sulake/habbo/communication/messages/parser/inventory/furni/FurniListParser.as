package com.sulake.habbo.communication.messages.parser.inventory.furni
{
   ...
   public class FurniListParser implements IMessageParser
   {
      ...
      protected var var_2858:String;
      
      protected var var_2859:int;
      
      protected var var_2857:int;
      
      protected var var_1568:Array;
      ...
      {
         this.var_2858 = param1.readString();
         ...
         while(_loc3_ < _loc2_)
         {
            this.var_1568.push(this.parseItem(param1));
            _loc3_++;
         }
         return true;
      }
