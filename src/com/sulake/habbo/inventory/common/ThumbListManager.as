package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1527:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_668 = BitmapData(_loc7_.content);
         }
         ...
         this._thumbWidth = this.var_668.width;
         this.var_94 = this.var_668.height;
         this.var_1267 = param5;
         this.var_1032 = param6;
         this.var_233 = Math.floor(this.var_1267 / this._thumbWidth);
         this.var_26 = new BitmapData(this.var_1267,this.var_1032);
      }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         this.var_669 = this.resolveRowCountFromList();
         if(this.var_669 == 0)
         {
            this.var_26 = new BitmapData(this.var_1267,this.var_1032);
            return;
         }
         this.var_26 = new BitmapData(Math.max(this.var_233 * this._thumbWidth,this.var_1267),Math.max(this.var_669 * this.var_94,this.var_1032),true,16777215);
         this.var_26.fillRect(this.var_26.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = this.getList();
         var _loc3_:int = 0;
         while(_loc3_ < this.var_669)
         {
            _loc4_ = 0;
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == this.var_233 && this.var_26.height < _loc3_.y * this.var_94)
         {
         ...
         _loc4_ = new Rectangle(this._thumbWidth * (this.var_233 - 1),0,this._thumbWidth,this.var_26.height);
         _loc2_.copyPixels(this.var_26,_loc4_,new Point(0,this.var_94),null,null,true);
         _loc4_ = new Rectangle(0,this.var_94,this._thumbWidth * (this.var_233 - 1),this.var_26.height - this.var_94);
      ...
      private function getList() : Array
      {
         ...
         {
            _loc1_ = this.var_1527.getDrawableList();
         }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(this.var_26.height < this.var_1032)
         {
            _loc12_ = new BitmapData(this.var_26.width,this.var_1032);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(this.var_668.width,this.var_668.height);
         if(param2)
         {
            _loc3_.copyPixels(this._itemBgImageSelected,this.var_668.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(this.var_668,this.var_668.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
