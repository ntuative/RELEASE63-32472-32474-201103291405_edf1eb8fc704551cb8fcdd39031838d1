package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      public function getItemStats() : void
      {
         ...
         this.var_2837 = _loc2_;
         this.var_2836 = this.var_220.type;
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         {
            case 1:
               this._view.showMakeOffer(this.var_220);
               break;
            case 2:
            ...
            case 3:
               ...
               break;
            case 4:
               this._view.showBuyTokens(this.var_2034,this.var_2035);
         }
      }
      ...
      {
         if(param1 != this.var_2837 || param2 != this.var_2836)
         {
            return;
         }
         if(!this._view)
         ...
         this._view.updateAveragePrice(param3,this.var_2586);
      }
