package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_2853:BitmapData;
      
      private const const_2043:int = 8947848;
      
      private const const_2042:int = 13421772;
      
      private const const_1761:Number = 1;
      
      private const const_1760:Number = 0.2;
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2852 == FurniModel.const_45)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1559));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2081);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1760;
               _loc1_.blend = this.const_1760;
            }
            else
            {
         ...
         if(_loc5_)
         {
            if(this.var_2080 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2853;
               _loc5_.visible = true;
            }
            else
            {
