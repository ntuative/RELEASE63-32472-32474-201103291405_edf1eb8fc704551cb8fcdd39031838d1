package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1528:uint = 9;
      ...
      public static const const_299:uint = 3;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_58.updateItemList(this.var_820);
         this.var_58.updateItemList(this.var_1523);
      ...
      public function close() : void
      {
         if(this.var_776)
         {
            if(this._state != const_204 && this._state != const_268)
            {
      ...
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_819 + " OTHER: " + this.var_1257);
         ...
         {
            case const_204:
               if(param1 == const_176 || param1 == const_268)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_58.alertPopup(TradingView.const_1127);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_820)
            {
               this.var_819 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_820)
            {
               this.var_58.alertPopup(TradingView.const_1200);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_276.length < const_1528)
         {
