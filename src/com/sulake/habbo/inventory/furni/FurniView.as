package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_954:int = 1;
      
      private const const_1768:int = 2;
      
      private const const_1770:int = 3;
      
      private const const_1771:int = 42;
      
      private const const_1769:int = 120;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboSoundManager)
      {
         ...
         this.var_501 = param6;
         this.var_501.events.addEventListener(SongInfoReceivedEvent.TRAX_SONG_INFO_RECEIVED,this.onSongInfoReceivedEvent);
         this.var_426 = new Map();
         this.var_426.add(FurniModel.const_45,new FurniGridView(this.var_68,FurniModel.const_45,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_426.add(FurniModel.const_51,new FurniGridView(this.var_68,FurniModel.const_51,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_501)
            {
               this.var_501.events.removeEventListener(SongInfoReceivedEvent.TRAX_SONG_INFO_RECEIVED,this.onSongInfoReceivedEvent);
               this.var_501 = null;
            }
            this.var_190 = null;
            this._disposed = true;
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_426.getValue(this.var_427);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_68.getCategoryContent(this.var_427);
         if(!this.var_68.isListInited())
         {
            _loc2_ = this.const_954;
         }
         ...
         if(this.var_2356 == _loc2_)
         {
            return;
         }
         this.var_2356 = _loc2_;
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_68.getGroupItemInIndex(_loc3_,this.var_427);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            ...
            else if(_loc5_.category == FurniCategory.const_372)
            {
         ...
         if(_loc13_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               {
                  _loc21_ = this.var_501.musicController.getSongInfo(_loc5_.extra);
                  if(_loc21_ != null)
                  {
                  ...
                  {
                     this.var_501.musicController.requestSongInfoWithoutSamples(_loc5_.extra);
                     this.var_190.push(_loc5_.extra);
                  }
               }
            }
         ...
         if(_loc14_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               if(_loc5_.category == FurniCategory.const_866)
               {
                  _loc22_ = this.var_501.musicController.getSongInfo(_loc5_.extra);
                  if(_loc22_ != null)
                  {
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > this.const_1769)
         {
            _loc3_ = this.const_1769;
         }
         ...
         else if(param1.type == WindowEvent.const_62)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModel.const_409);
            }
         }
      }
      ...
      {
         if(this.var_190.indexOf(param1.id as Number) != -1)
         {
            this.updateActionView();
            while(this.var_190.indexOf(param1.id as Number) != -1)
            {
               this.var_190.splice(this.var_190.indexOf(param1.id as Number),1);
            }
         }
      }
   }
