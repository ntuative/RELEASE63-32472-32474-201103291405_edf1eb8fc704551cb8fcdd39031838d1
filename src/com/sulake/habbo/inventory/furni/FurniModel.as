package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_409:String = "pets";
      
      private static const const_1316:int = 100;
      ...
      private var var_1729:Vector.<Array>;
      
      private var var_1730:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_501 = param8;
         this.var_604 = new Timer(const_1316,1);
         ...
         this.var_2344 = XML(_loc10_.content);
         this.clearFurniList();
         this._view = new FurniView(this,param2,this._windowManager,this._assets,this._roomEngine,this.var_501);
         this._view.switchCategory(const_45);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               this.var_202.removeEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
               this.var_202.stop();
               this.var_202 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_45)
            {
               ...
               {
                  this.var_1729 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1729;
            }
            else
            {
               if(this.var_1730 == null)
               {
                  this.var_1730 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1730;
            }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         else if(param3 == FurniCategory.const_372)
         {
         ...
         if(this.var_919 == null)
         {
            this.var_919 = this._windowManager.buildFromXML(this.var_2344) as IWindowContainer;
         }
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            this.var_202 = new Timer(param1,1);
            this.var_202.addEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
            this.var_202.start();
         }
         else
         {
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_605.add(const_51,new Array());
         if(this._view != null)
         {
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_372 || _loc3_.category == FurniCategory.const_385 || _loc3_.category == FurniCategory.const_360)
         {
            if(param1)
            {
               return false;
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            while(_loc4_ < _loc3_.length)
            {
               ...
               if(_loc5_.category == FurniCategory.const_908)
               {
                  _loc6_ = 1;
               }
               _loc7_ = 0;
