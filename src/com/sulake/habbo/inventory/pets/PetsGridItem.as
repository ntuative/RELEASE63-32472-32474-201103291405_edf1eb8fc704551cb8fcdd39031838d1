package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_41:
               this.var_1520.setSelectedGridItem(this);
               this.var_1519 = true;
               break;
            ...
            case WindowMouseEvent.const_25:
               ...
               {
                  this.var_1519 = false;
                  this.var_1520.placePetToRoom(this._petData.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         this.var_1339.color = !!this._isSelected ? uint(this.const_2043) : uint(this.const_2042);
      }
