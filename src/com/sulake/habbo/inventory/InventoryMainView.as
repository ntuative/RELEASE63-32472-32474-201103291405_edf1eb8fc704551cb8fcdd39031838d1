package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      public function showInventory() : void
      {
         ...
         _loc1_.visible = true;
         if(this.var_181 != null && this.var_1084)
         {
            this.var_181.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_55,HabboToolbarIconEnum.INVENTORY,_loc1_ as IWindowContainer));
            this.var_1084 = false;
         }
         this._controller.inventoryViewOpened(this.var_711);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true) : void
      {
         ...
         else
         {
            ...
            if(this.var_181 != null && this.var_1084)
            {
               this.var_181.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_55,HabboToolbarIconEnum.INVENTORY,_loc3_ as IWindowContainer));
               this.var_1084 = false;
            }
      ...
      public function updateSubCategoryView() : void
      {
         ...
         this.setSubViewToCategory(this.var_711);
      }
      ...
      public function setHabboToolbarIcon() : void
      {
         ...
         {
            this.var_181.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_156,HabboToolbarIconEnum.INVENTORY));
         }
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         _loc2_.container.removeChild(this.var_1627);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_712 == InventoryCategory.const_132)
            {
               this.toggleCategoryView(InventoryCategory.const_132);
            }
            else if(this.var_712 == InventoryCategory.const_76)
            {
