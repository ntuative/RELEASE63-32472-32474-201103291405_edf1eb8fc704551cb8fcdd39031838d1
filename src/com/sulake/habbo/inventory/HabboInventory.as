package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_2060:int = 500;
      ...
      public function get tradingModel() : TradingModel
      {
         ...
         return TradingModel(this.var_51.getValue(InventorySubCategory.const_323));
      }
      ...
      public function get effectsModel() : EffectsModel
      {
         ...
         return EffectsModel(this.var_51.getValue(InventoryCategory.const_731));
      }
      ...
      public function get achievementsModel() : AchievementsModel
      {
         ...
         return AchievementsModel(this.var_51.getValue(InventoryCategory.const_412));
      }
      ...
      public function get petsModel() : PetsModel
      {
         ...
         return PetsModel(this.var_51.getValue(InventoryCategory.const_132));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_51.getValue(InventoryCategory.const_390) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1368 = new IncomingMessages(this);
      ...
      {
         this.var_295 = ISessionDataManager(param2);
         this.initInventory();
      }
      ...
      {
         this.var_501 = IHabboSoundManager(param2);
         this.initInventory();
      }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_295 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_15 || !this.var_181 || !this.var_501)
         {
            return;
         }
         ...
         this.var_51.add(InventoryCategory.const_390,_loc1_);
         var _loc2_:FurniModel = new FurniModel(this,_loc1_,this._windowManager,this._communication,this._assetLibrary,this._roomEngine,this._catalog,this.var_501);
         this.var_51.add(InventoryCategory.const_76,_loc2_);
         var _loc3_:BadgesModel = new BadgesModel(this,this._windowManager,this._communication,this._assetLibrary,this.var_295);
         ...
         this.var_51.add(InventoryCategory.const_731,_loc4_);
         var _loc5_:AchievementsModel = new AchievementsModel(this,this._windowManager,this._communication,this._assetLibrary,this._localization,this.var_295);
         this.var_51.add(InventoryCategory.const_412,_loc5_);
         var _loc6_:TradingModel = new TradingModel(this,this._windowManager,this._communication,this._assetLibrary,this._roomEngine,this._localization,this.var_501);
         this.var_51.add(InventorySubCategory.const_323,_loc6_);
         ...
         this.var_51.add(InventoryCategory.const_132,_loc8_);
         this.var_195 = true;
         if(this.var_2313)
         {
            this.requestData();
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_2060);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_695));
      }
