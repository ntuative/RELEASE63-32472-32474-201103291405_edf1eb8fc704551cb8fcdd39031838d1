package com.sulake.habbo.inventory
{
   ...
   public class ItemPopupCtrl
   {
      ...
      public static const const_475:int = 2;
      
      private static const const_962:int = 5;
      
      private static const const_1327:int = 250;
      
      private static const const_1329:int = 100;
      
      private static const const_1328:int = 180;
      
      private static const const_1330:int = 200;
      ...
      {
         this.var_357 = new Timer(const_1327,1);
         this.var_356 = new Timer(const_1329,1);
         super();
         if(param1 == null)
         {
            return;
         ...
         if(_loc3_ != null && _loc3_.content != null)
         {
            this.var_733 = _loc3_.content as BitmapData;
         }
      }
      ...
      public function updateContent(param1:IWindowContainer, param2:String, param3:BitmapData, param4:int = 2) : void
      {
         ...
         if(_loc6_)
         {
            _loc7_ = new BitmapData(Math.min(const_1328,param3.width),Math.min(const_1330,param3.height),true,16777215);
      ...
      public function show() : void
      {
         ...
         this.refreshArrow(this.var_1737);
         switch(this.var_1737)
         {
            case const_1212:
               this.var_81.x = -1 * this.var_81.width - const_962;
               break;
            case const_475:
               this.var_81.x = this._parent.width + const_962;
         }
      ...
      private function refreshArrow(param1:int = 2) : void
      {
         ...
         switch(param1)
         {
            case const_1212:
               ...
               _loc2_.y = (this.var_81.height - this.var_921.height) / 2;
               _loc2_.x = this.var_81.width - 1;
               break;
            case const_475:
               _loc2_.bitmap = this.var_733.clone();
               _loc2_.width = this.var_733.width;
               _loc2_.height = this.var_733.height;
               _loc2_.y = (this.var_81.height - this.var_733.height) / 2;
               _loc2_.x = -1 * this.var_733.width + 1;
         }
         _loc2_.invalidate();
      }
