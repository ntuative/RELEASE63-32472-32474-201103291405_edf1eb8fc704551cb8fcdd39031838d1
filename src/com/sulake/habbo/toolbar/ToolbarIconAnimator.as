package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         if(_loc9_.length() > 0)
         {
            ...
            while(_loc10_ < _loc9_.length())
            {
               ...
               if(_loc8_ != null)
               {
                  this.var_992.push(_loc11_);
                  this.var_994.push(_loc8_);
               }
               _loc10_++;
            }
         }
         else
         {
            ...
            if(_loc8_ != null)
            {
               this.var_992.push(new XML());
               this.var_994.push(_loc8_);
            }
         }
         if(param6 != null)
         {
            this.var_994[this._frame] = param6.clone();
         }
      ...
      {
         if(this.var_1466 == true || this.var_993 == 0)
         {
            if(this.var_992.length > 0)
            {
               ++this._frame;
               if(this._frame >= this.var_992.length)
               {
                  this._frame = 0;
                  ++this.var_993;
               }
      ...
      {
         return this.var_992.length;
      }
      
      public function hasNextState() : Boolean
      {
         return this.var_1466 == false && this.var_993 == 1 && this.var_1602 != this._state;
      }
      ...
      private function updateAssetInWindow(param1:IBitmapWrapperWindow) : void
      {
         ...
         {
            _loc2_ = this.var_994[this._frame];
