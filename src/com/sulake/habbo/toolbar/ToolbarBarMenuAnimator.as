package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1300:Number = 25;
      
      private static const const_1369:Number = 90;
      
      private static const const_953:int = 50;
      
      private static const const_1299:int = 50;
       
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_1364:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         this.var_723 = new Timer(const_1300);
      ...
      public function refresh() : void
      {
         ...
         {
            this.repositionWindow(this.var_349[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_953 + this._toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_953 || param1.desktop.height - param1.y < const_1299;
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = this.var_1364.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
            ...
            this.var_349.push(_loc3_.menuId);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Point = this.var_1364.getIconLoc(param1.iconId);
      ...
      {
         return this.var_594[this.var_595.indexOf(param1)];
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return this.var_595[this.var_594.indexOf(param1)];
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = this.var_595.indexOf(param2);
         if(_loc3_ > -1)
         {
            this.var_595.splice(_loc3_,1);
            this.var_594.splice(_loc3_,1);
         }
         this.var_594.push(param1.name);
         this.var_595.push(param2);
         param1.addEventListener(WindowEvent.const_350,this.windowEventListener);
         param1.addEventListener(WindowEvent.const_255,this.windowEventListener);
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(this.var_596[_loc3_] == null)
            {
               this.var_596[_loc3_] = new Array();
            }
            if(this.var_596[_loc3_].indexOf(param1) < 0)
            {
               this.var_596[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      public function removeItem(param1:String) : void
      {
         if(this.var_349.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               this.var_349.splice(this.var_349.indexOf(param1),1);
            }
         }
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         {
            if(this.var_594[_loc2_] == param1.window.name)
            {
               _loc3_ = this.var_595[_loc2_];
               if(this.var_596[_loc3_] != null)
               {
                  _loc4_ = 0;
                  while(_loc4_ < this.var_596[_loc3_].length)
                  {
                     this.repositionWindow(this.var_596[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
      ...
      private function animationUpdate(param1:TimerEvent) : void
      {
         ...
         var _loc7_:int = 0;
         while(_loc7_ < this.var_349.length)
         {
            _loc2_ = this._itemList[this.var_349[_loc7_]];
            if(_loc2_.active)
            {
