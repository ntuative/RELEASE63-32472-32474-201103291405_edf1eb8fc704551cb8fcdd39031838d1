package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private var var_1428:LogoutController;
      ...
      {
         this._view = new ToolbarView(this._windowManager,this._assetLibrary,this.var_290.getHabboMainConnection(null),events,this._config);
         if(this._config && this._config.getKey("client.logout.enabled","false") == "true")
         {
            this.var_1428 = new LogoutController(this._windowManager,this._assetLibrary,events);
         }
         if(this._view == null)
         {
            return;
         }
         events.addEventListener(HabboToolbarSetIconEvent.const_156,this.onSetToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_1144,this.onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_127,this.onRemoveToolbarIconEvent);
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_576,this.onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1055,this.onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1048,this.onHideWindowEvent);
         this._state = true;
