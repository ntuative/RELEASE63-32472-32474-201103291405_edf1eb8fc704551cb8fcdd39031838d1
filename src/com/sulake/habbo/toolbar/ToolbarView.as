package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_1273:Number = 1;
      
      private var var_1539:Number = 0;
      
      private var var_2009:Number = 15;
      
      private var var_2008:Number = 5;
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IConnection, param4:IEventDispatcher, param5:IHabboConfigurationManager)
      {
         ...
         this.var_234 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_67,HabboWindowStyle.const_1064,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         this.var_1274 = String(_loc8_.relocate_by_drag.@state) == "true";
         if(this.var_1274)
         {
         ...
         this.var_1273 = _loc8_.toolbar.@margin_top;
         this.var_1539 = _loc8_.toolbar.@margin_bottom;
         this.var_2009 = _loc8_.toolbar.@min_group_margin;
         this.var_2008 = _loc8_.toolbar.@margin_to_extrabar;
         ...
         this.createGroupsFromXmlList(_loc9_,this.var_279,param1,param2,param3,this._window,this.var_294);
         this.createGroupsFromXmlList(_loc10_,this.var_674,param1,param2,param3,this.var_234,this.var_294);
         this.alignWindows();
      }
      ...
      public function dispose() : void
      {
         ...
         while(this.var_674.length > 0)
         {
            _loc1_ = this.var_674.shift();
            _loc1_.dispose();
            _loc1_ = null;
         }
         if(this._window != null)
      ...
      {
         this.alignWindows();
         var _loc2_:HabboToolbarEvent = new HabboToolbarEvent(HabboToolbarEvent.const_776);
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         _loc3_ = 0;
         while(_loc3_ < this.var_674.length)
         {
            _loc2_ = this.var_674[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      private function alignWindows() : void
      {
         ...
         switch(this.orientation)
         {
            case "LEFT":
               ...
               this._window.x = 0;
               this._window.y = 0;
               this.var_234.x = this.var_173 + this.var_2008;
               this.var_234.y = 0;
            ...
            case "TOP":
               ...
               this._window.y = 0;
               this.var_234.x = 0;
               this.var_234.y = this.var_173 + this.var_2008;
         ...
         var _loc6_:* = 0;
         var _loc7_:Number = this.var_1273;
         var _loc8_:* = 1;
         if(_loc5_ > _loc4_)
         {
         ...
         else
         {
            ...
            if(this.var_279.length > 1)
            {
               if(this.orientation == "LEFT" || this.orientation == "RIGHT")
               {
                  _loc6_ = Number(Math.max(this.var_2009,(this._window.height - _loc5_ * _loc8_ - this.var_1273 - this.var_1539) / (this.var_279.length - 1)));
               }
               else
               {
                  _loc6_ = Number(Math.max(this.var_2009,(this._window.width - _loc5_ * _loc8_ - this.var_1273 - this.var_1539) / (this.var_279.length - 1)));
               }
            }
         }
         _loc2_ = 0;
      ...
      private function onStageMouseMove(param1:MouseEvent) : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_1274 && this.var_1540)
         {
