package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1415:String = AvatarSetType.const_36;
      ...
      private var var_1034:IActiveActionData;
      ...
      private var var_2741:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.var_1034 = new ActiveActionData(AvatarAction.const_384);
         this.var_1034.definition = this._structure.getActionDefinition(const_1413);
         this.resetActions();
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_656,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_275.length == 1 && this.var_90 == this.var_1920)
         {
            return this.var_90 + this.var_541 + this.var_656 % 4;
         }
         if(this.var_275.length == 2)
         {
            for each(_loc1_ in this.var_275)
            {
               ...
               {
                  return this.var_90 + this.var_541 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_656 % 11;
                  return this.var_90 + "_" + this.var_1920 + this.var_541 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2743 || param2 != this.var_2742 || param1 != this.var_2741)
         {
            this.var_2743 = param3;
            this.var_2742 = param2;
            this.var_2741 = param1;
            this.var_1969 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_656);
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_656);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_333.push(new ActiveActionData(param1,param2,this.var_656));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_287 = this.var_1034;
         this.var_287.definition = this.var_1034.definition;
         this.resetBodyPartCache(this.var_1034);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_541 = "";
         this.var_275 = this._structure.sortActions(this.var_333);
         if(this.var_275 == null)
         {
            this.var_705 = new Array(0,0,0);
            if(this.var_1511 != "")
            {
               _loc1_ = true;
               this.var_1511 = "";
         ...
         {
            this.var_705 = this._structure.getCanvasOffsets(this.var_275,this._scale,this.var_90);
            for each(_loc4_ in this.var_275)
            {
               this.var_541 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_322)
               {
            ...
            if(this.var_1511 != this.var_541)
            {
               _loc1_ = true;
               this.var_1511 = this.var_541;
            }
         }
         this.var_1512 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_275)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_979 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        this.var_1968 = _loc2_.directionData.offset;
                     }
               ...
               if(_loc1_.actionType == AvatarAction.const_297 || _loc1_.actionType == AvatarAction.const_241 || _loc1_.actionType == AvatarAction.const_374)
               {
                  this.var_979 = true;
               }
            }
