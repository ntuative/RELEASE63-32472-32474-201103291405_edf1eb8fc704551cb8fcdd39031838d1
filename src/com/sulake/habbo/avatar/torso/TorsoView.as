   ...
   public class TorsoView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_38)
         {
            ...
            var_38["null"] = new AvatarEditorGridView(var_68,FigureData.const_223,_windowManager,_assetLibrary);
            var_38["null"] = new AvatarEditorGridView(var_68,FigureData.const_183,_windowManager,_assetLibrary);
         ...
         if(var_68 && var_150 == "")
         {
            var_68.switchCategory(FigureData.const_183);
         }
      }
