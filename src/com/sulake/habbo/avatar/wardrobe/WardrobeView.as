package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeView implements ISideContentView
   {
      ...
      private var var_1035:IItemListWindow;
      
      private var var_1275:IItemListWindow;
      ...
      public function WardrobeView(param1:WardrobeModel)
      {
         ...
         this.var_1035 = this._window.findChildByName("hc_slots") as IItemListWindow;
         this.var_1275 = this._window.findChildByName("vip_slots") as IItemListWindow;
      ...
      public function update() : void
      {
         ...
         if(this.var_1035)
         {
            this.var_1035.removeListItems();
         }
         if(this.var_1275)
         {
            this.var_1275.removeListItems();
         }
         ...
         while(_loc3_ < _loc1_.length)
         {
            ...
            if(_loc3_ < 5)
            {
               if(this.var_1035)
               {
                  this.var_1035.addListItem(_loc2_.view);
                  _loc2_.view.visible = true;
               }
            }
            else if(this.var_1275)
            {
               this.var_1275.addListItem(_loc2_.view);
               _loc2_.view.visible = true;
            }
            _loc3_++;
         }
