package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeSlot implements IOutfit, IAvatarImageListener
   {
      ...
      public function updateView() : void
      {
         ...
         if(this.var_643 && this.var_1473)
         {
            _loc5_ = this._controller.avatarRenderManager.createAvatarImage(this.figure,AvatarScaleType.const_87,this.var_995,this);
            if(_loc5_)
            {
               _loc5_.setDirection(AvatarSetType.const_36,parseInt(FigureData.const_802));
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            case "set_button":
               this.var_643 = this._controller.figureData.getFigureString();
               this.var_995 = this._controller.gender;
               this._controller.handler.saveWardrobeOutfit(this.var_1886,this);
               this.updateView();
               break;
            case "get_button":
               if(this.var_643)
               {
                  this._controller.loadAvatarInEditor(this.var_643,this.var_995,this._controller.clubMemberLevel);
               }
         }
      }
