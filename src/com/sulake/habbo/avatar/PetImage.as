   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc9_ = _loc3_.getImageContainer(_loc8_,this.var_656);
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               {
                  _loc18_ = _loc15_[0];
                  _loc19_ = _loc18_.getFrameIndex(this.var_656);
                  _loc20_ = this.var_90;
                  _loc21_ = 1;
                  switch(this.var_90)
                  {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc10_ = _loc2_.getImageContainer(_loc9_,this.var_656);
            if(_loc10_ != null)
            {
               ...
               {
                  _loc19_ = _loc16_[0];
                  _loc20_ = _loc19_.getFrameIndex(this.var_656);
                  _loc21_ = this.var_90;
                  _loc22_ = 1;
                  switch(this.var_90)
                  {
      ...
      private function resetActions() : Boolean
      {
         ...
         this.setActionToParts(this.var_1034);
         this.getCache().resetBodyPartCache(this.var_1034);
         return true;
      }
      ...
      private function sortActions() : void
      {
         ...
         {
            this.var_705 = this._structure.getCanvasOffsets(this.var_1537,this._scale,this.var_90);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_1537)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_374)
               {
                  this.var_979 = true;
               }
               if(_loc1_.actionType == AvatarAction.const_241)
               {
                  this.var_979 = true;
               }
