package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_1042:AvatarActionManager;
      ...
      private var var_842:AnimationManager;
      
      private var var_1034:ActionDefinition;
      
      private var var_555:String;
      
      private var var_1565:PartOffsetData;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:String, param3:PartOffsetData)
      {
         ...
         this.var_842 = new AnimationManager();
         this.var_555 = param2;
      ...
      {
         this.var_1565.loadOffsets(param1);
      }
      ...
      public function initActions(param1:IAssetLibrary, param2:XML) : void
      {
         ...
         this.var_1042 = new AvatarActionManager(param1,this.var_555,param2);
         this.var_1034 = this.var_1042.getDefaultAction();
      }
      ...
      public function initPartSets(param1:XML) : Boolean
      {
         ...
         {
            if(this.var_555 == AvatarType.const_120)
            {
      ...
      public function registerAnimations(param1:AssetLibraryCollection, param2:String = "fx", param3:int = 200) : void
      {
         ...
         while(_loc5_ < param3)
         {
            if(param1.hasAsset(param2 + _loc5_))
            {
               ...
               this.var_842.registerAnimation(this,_loc4_);
            }
            _loc5_++;
         }
      }
      ...
      {
         return this.var_842.getLayerData(param1,param2,param3) as AnimationLayerData;
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return this.var_842.getAnimation(param1) as Animation;
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return this.var_1042.getActionDefinition(param1);
      }
      
      public function getActionDefinitionWithState(param1:String) : ActionDefinition
      {
         return this.var_1042.getActionDefinitionWithState(param1);
      }
      ...
      {
         return this.var_1042.sortActions(param1);
      }
      ...
      public function getMandatorySetTypeIds(param1:String, param2:int) : Array
      {
         ...
         {
            this.var_683[param1] = new Dictionary();
         }
         if(this.var_683[param1][param2])
         {
            return this.var_683[param1][param2];
         }
         this.var_683[param1][param2] = this.var_396.getMandatorySetTypeIds(param1,param2);
         return this.var_683[param1][param2];
      }
      
      public function method_3(param1:String, param2:String) : IFigurePartSet
      {
         return this.var_396.method_3(param1,param2);
      }
      
      public function getCanvasOffsets(param1:Array, param2:String, param3:int) : Array
      {
         return this.var_1042.getCanvasOffsets(param1,param2,param3);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = this.var_842.getAnimation(_loc6_) as Animation;
            if(_loc7_ != null)
            {
      ...
      public function getParts(param1:String, param2:IAvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         if(param3.definition.isAnimation)
         {
            ...
            _loc9_ = this.var_842.getAnimation(_loc23_) as Animation;
            if(_loc9_ != null)
            {
      ...
      {
         return this.var_1565.getOffset(param1,param2,param3,param4,param5,param6);
      }
