package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private var var_459:AvatarImageBodyPartContainer;
      ...
      private var var_2224:ImageData;
      
      private var var_1009:PaletteMap;
      ...
      public function setGeometryType(param1:String) : void
      {
         ...
         if(this.var_716 == GeometryType.const_1138 && param1 == GeometryType.const_1091 || this.var_716 == GeometryType.const_1091 && param1 == GeometryType.const_1138)
         {
            this.var_716 = param1;
            this.var_84 = null;
            return;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
            ...
            if(this.var_344.definition.isAnimation)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc14_ != null)
                  {
                     ...
                     if(_loc14_.type == AnimationLayerData.const_657)
                     {
                        if(_loc14_.action != null)
                        {
         ...
         if(_loc10_ == null)
         {
            _loc15_ = this._structure.getParts(param1,this.var_1429.getFigure(),_loc5_,this.var_716,_loc3_,_loc6_,_loc7_);
            _loc10_ = new AvatarImageDirectionCache(_loc15_);
            _loc9_.updateDirectionCache(_loc3_,_loc10_);
         }
         this.var_459 = _loc10_.getImageContainer(_loc4_);
         if(this.var_459 == null)
         {
            _loc16_ = _loc10_.getPartList();
            this.var_459 = this.renderBodyPart(_loc3_,_loc16_,_loc4_,this.var_344);
            if(this.var_459 == null)
            {
               return null;
            }
            _loc10_.updateImageContainer(this.var_459,_loc4_);
         }
         this.var_459.offset = _loc8_;
         return this.var_459;
      }
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         if(!this.var_84)
         {
            this.var_84 = this._structure.getCanvas(this._scale,this.var_716);
            if(!this.var_84)
            {
               return null;
            }
            this.var_2222 = new Point(0,this.var_84.height - int(this.var_84.width / 4));
         }
         var _loc5_:int = param1;
         var _loc6_:Boolean = AvatarDirectionAngle.const_1738[param1];
         var _loc9_:String = param4.definition.assetPartDefinition;
         var _loc10_:String = param4.definition.state;
         var _loc11_:Boolean = _loc10_ == AvatarAction.const_928 || _loc10_ == AvatarAction.const_374;
         ...
         while(_loc8_ >= 0)
         {
            ...
            {
               this.var_1347 = this.var_112.bodyPartId;
               this.var_183 = this.var_112.partType;
               this.var_1641 = this.var_112.partId;
               ...
               if(_loc6_)
               {
                  ...
                  else
                  {
                     ...
                     if(this.var_112.flippedPartType != this.var_183)
                     {
                        this.var_183 = this.var_112.flippedPartType;
                     }
                  }
               }
               this.var_1346 = this._scale + "_" + this.var_112.action.assetPartDefinition + "_" + this.var_183 + "_" + this.var_1641 + "_" + _loc5_ + "_" + this._frame;
               this.var_414 = this._assets.getAssetByName(this.var_1346) as BitmapDataAsset;
               if(this.var_414 == null)
               {
                  this.var_1346 = this._scale + "_std_" + this.var_183 + "_" + this.var_1641 + "_" + _loc5_ + "_0";
                  this.var_414 = this._assets.getAssetByName(this.var_1346) as BitmapDataAsset;
               }
               if(!(!this.var_414 || !this.var_414.content))
               {
                  if(this.var_112.paletteMapId > -1)
                  {
                     this.var_1009 = this._structure.renderManager.paletteManager.getPalette(this.var_112.paletteMapId);
                     if(this.var_1009 != null)
                     {
                        this.var_891 = this.var_414.content as BitmapData;
                        this.var_184 = new BitmapData(this.var_891.width,this.var_891.height);
                        this.var_2223 = this.var_1009.colorize(this.var_891.getPixels(this.var_891.rect));
                        this.var_184.setPixels(this.var_184.rect,this.var_2223);
                     }
                     else
                     {
                        this.var_184 = (this.var_414.content as BitmapData).clone();
                     }
                  }
                  else
                  {
                  ...
                  if(_loc11_ && (this.var_1347 == AvatarBodyPartType.const_222 || this.var_1347 == AvatarBodyPartType.const_1552 || this.var_1347 == AvatarBodyPartType.const_1564) && this.var_112.color != null)
                  {
                     _loc16_ = 0.7;
                  ...
                  {
                     this.var_184.colorTransform(this.var_184.rect,this.var_112.color.colorTransform);
                  }
                  if(this.var_112.isBlendable)
                  {
                     this.var_184.colorTransform(this.var_184.rect,this.var_112.blendTransform);
                  }
                  this.var_892 = this.var_414.offset.clone();
                  if(_loc7_)
                  {
                     if(this._scale == AvatarScaleType.const_57)
                     {
                  ...
                  this.var_2224 = new ImageData(this.var_184,this.var_892,_loc7_);
                  this.var_890.push(this.var_2224);
               }
            }
            _loc8_--;
         }
         ...
         var _loc14_:Point = new Point(-1 * _loc13_.regpoint.x,this.var_2222.y - _loc13_.regpoint.y);
         if(_loc6_)
         {
            if(this._scale == AvatarScaleType.const_57)
            {
