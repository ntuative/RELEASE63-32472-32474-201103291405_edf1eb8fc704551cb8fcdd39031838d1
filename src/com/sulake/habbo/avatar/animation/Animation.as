package com.sulake.habbo.avatar.animation
{
   ...
   public class Animation implements IAnimation
   {
      ...
      private var var_1988:AvatarDataContainer;
      
      private var var_1529:Array;
      
      private var var_1989:DirectionDataContainer;
      
      private var var_1990:ShadowDataContainer;
      ...
      public function Animation(param1:AvatarStructure, param2:XML)
      {
         ...
         {
            this.var_1866 = String(param2.@desc);
         }
         else
         {
            this.var_1866 = this._id;
         }
         if(param2.hasOwnProperty("sprite"))
         {
            for each(_loc3_ in param2.sprite)
            {
               this.var_1530.push(new SpriteDataContainer(this as IAnimation,_loc3_));
            }
         }
         if(param2.hasOwnProperty("avatar"))
         {
            this.var_1988 = new AvatarDataContainer(param2.avatar[0]);
         }
         if(param2.hasOwnProperty("canvas"))
         {
            for each(_loc4_ in param2.canvas)
            {
               this.var_1529.push(new CanvasDataContainer(_loc4_));
            }
         }
         if(param2.hasOwnProperty("direction"))
         {
            this.var_1989 = new DirectionDataContainer(param2.direction[0]);
         }
         if(param2.hasOwnProperty("shadow"))
         {
            this.var_1990 = new ShadowDataContainer(param2.shadow[0]);
         }
         ...
         if(param2.hasOwnProperty("add"))
         {
            ...
            {
               this.var_823.push(new AddDataContainer(_loc6_));
            }
         }
         if(param2.hasOwnProperty("com.sulake.core.communication.protocol"))
         {
      ...
      private function parseFrames(param1:Array, param2:XMLList, param3:AvatarStructure) : void
      {
         ...
         for each(_loc7_ in param2)
         {
            ...
            for each(_loc8_ in _loc7_.bodypart)
            {
               ...
               _loc10_ = new AnimationLayerData(param3,_loc8_,AnimationLayerData.const_657,_loc6_,_loc5_);
               _loc4_.push(_loc10_);
            }
      ...
      public function getAnimatedBodyPartIds(param1:int, param2:String = null) : Array
      {
         ...
         {
            if(_loc4_.type == AnimationLayerData.const_657)
            {
      ...
      {
         return this.var_1989 != null;
      }
      
      public function hasShadowData() : Boolean
      {
         return this.var_1990 != null;
      }
