package com.sulake.habbo.avatar.pets
{
   ...
   public class PetDataManager implements IPetDataManager
   {
      ...
      {
         if(param1 == null || this.var_554 == null)
         {
            return;
         }
         var _loc2_:int = this.var_554.indexOf(param1);
         if(_loc2_ != -1)
         {
      ...
      private function notifyListeners() : void
      {
         ...
         {
            _loc1_ = this.var_554.pop() as IPetDataListener;
      ...
      public function assetsReady(param1:int, param2:String, param3:IPetDataListener = null) : Boolean
      {
         ...
         {
            if(this.var_1564.indexOf(_loc6_) == -1)
            {
               _loc7_ = false;
               if(this.var_682.getValue(_loc6_) == null)
               {
                  ...
                  if(param3 != null && this.var_554.indexOf(param3) == -1)
                  {
                     this.var_554.push(param3);
                  }
               }
            }
         }
