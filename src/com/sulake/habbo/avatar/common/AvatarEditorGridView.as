package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridView
   {
      ...
      public function initFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         var _loc1_:CategoryData = this.var_68.getCategoryData(this.var_1398);
         if(!_loc1_)
         {
            return;
         }
      ...
      private function partEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_41)
         {
            ...
            this.var_68.selectPart(this.var_1398,_loc3_);
         }
      }
         ...
         if(param1.type == WindowMouseEvent.const_41)
         {
            ...
            while(_loc7_ < this.const_1335)
            {
               if(this.var_509.length > _loc7_)
               {
                  ...
                  if(_loc5_ > -1)
                  {
                     this.var_68.selectColor(this.var_1398,_loc5_,_loc7_);
                     return;
                  }
               }
               _loc7_++;
