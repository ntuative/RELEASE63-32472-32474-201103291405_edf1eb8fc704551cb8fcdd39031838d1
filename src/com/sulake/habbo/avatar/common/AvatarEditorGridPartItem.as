package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridPartItem implements IAvatarImageListener
   {
      ...
      private const const_2042:int = 16777215;
      ...
      public function AvatarEditorGridPartItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:Array, param5:Boolean = true)
      {
         ...
         this.var_764 = param3;
         this._window = param1;
         this.var_1339 = this._window.findChildByTag("BG_COLOR");
         this._colors = param4;
         ...
         if(param3 != null)
         {
            ...
            {
               this.var_1808 = Math.max(this.var_1808,_loc6_.colorLayerIndex);
            }
         }
         this.var_438 = this.var_68.controller.avatarRenderManager;
      ...
      private function updateThumbVisualization() : void
      {
         ...
         if(_loc1_)
         {
            if(this.var_684 != null && !this.var_1809)
            {
               _loc3_ = this.var_684;
            }
            else
            ...
            if(this.var_764)
            {
               switch(this.var_764.clubLevel)
               {
                  ...
                  case HabboClubLevelEnum.const_44:
                     _loc2_.style = HabboIconType.const_653;
                     break;
         ...
         if(this.isSelected)
         {
            this.var_1339.color = this.const_2043;
         }
         else
         {
            this.var_1339.color = this.const_2042;
         }
      ...
      private function analyzePartLayers() : Boolean
      {
         ...
         for each(_loc2_ in this.partSet.parts)
         {
            if(_loc7_)
            {
               _loc3_ = "undefined_undefined_" + _loc2_.type + "_" + _loc2_.id + "_" + this.const_342[_loc6_] + "_" + FigureData.const_150;
      ...
      private function renderThumb() : BitmapData
      {
         ...
         if(this.var_631 == null)
         {
            if(!this.analyzePartLayers())
            {
               if(!this.var_1807)
               {
                  ...
                  this.var_1807 = _loc9_.content as BitmapData;
               }
         ...
         _loc1_ = new BitmapData(this.var_631.width,this.var_631.height,true,16777215);
         var _loc6_:int = 0;
         var _loc7_:Boolean = false;
         ...
         for each(_loc2_ in _loc8_)
         {
            ...
            if(_loc4_)
            {
               ...
               _loc10_ = -1 * _loc4_.offset.x - this.var_631.x;
               _loc11_ = -1 * _loc4_.offset.y - this.var_631.y;
               if(this.var_1809 && _loc2_.colorLayerIndex > 0)
               {
