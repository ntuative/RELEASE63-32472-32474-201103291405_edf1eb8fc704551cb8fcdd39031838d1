package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_976.width,this.var_976.height,true,0);
            _loc5_ = this.var_976.clone();
            ...
            if(this.var_870)
            {
               switch(this.var_870.clubLevel)
               {
                  ...
                  case HabboClubLevelEnum.const_44:
                     _loc4_.style = HabboIconType.const_653;
                     _loc4_.visible = true;
                     break;
