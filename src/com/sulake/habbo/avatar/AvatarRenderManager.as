package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_2072:String = "hd-99999-99999";
      ...
      private var var_779:PaletteManager;
      ...
      private var var_1850:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_586 = RenderMode.const_1511;
         ...
         this.var_105.add(AvatarType.const_120,_loc4_);
         ...
         this.var_779 = new PaletteManager(param1.assets as AssetLibraryCollection);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_311.init();
         this.var_779.init();
         _loc2_ = this.var_105.getValue(AvatarType.const_120) as AvatarStructure;
         if(_loc2_)
         {
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_105.getValue(AvatarType.const_120) as AvatarStructure;
            if(_loc3_ != null)
            {
      ...
      private function checkIfReady() : void
      {
         if(!this.var_880)
         {
            if(this.var_2590 && this.var_2589 && this.var_2591)
            {
      ...
      {
         var _loc5_:AvatarStructure = this.var_105.getValue(AvatarType.const_120) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(!this.var_1850)
         {
            this.var_1850 = new AvatarFigureContainer(this.const_2072);
         }
         this.var_225.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_1850,param2);
      }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1501)
         {
      ...
      {
         var _loc3_:AvatarStructure = this.var_105.getValue(AvatarType.const_120) as AvatarStructure;
      ...
      private function validateAvatarFigure(param1:AvatarFigureContainer, param2:String) : Boolean
      {
         ...
         if(_loc6_)
         {
            ...
            for each(_loc8_ in _loc6_)
            {
               ...
               {
                  _loc9_ = _loc3_.method_3(_loc8_,param2);
                  if(_loc9_)
                  {
               ...
               else
               {
                  ...
                  if(!_loc11_)
                  {
                     _loc12_ = _loc3_.method_3(_loc8_,param2);
                     if(_loc12_)
                     {
