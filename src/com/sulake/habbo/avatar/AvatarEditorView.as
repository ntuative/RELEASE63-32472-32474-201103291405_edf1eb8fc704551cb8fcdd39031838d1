package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1296:IWindowContainer;
      
      public static var var_1566:IWindowContainer;
      
      public static var var_2048:int = 6710886;
      ...
      private var var_2631:Boolean = true;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1218 = [];
         this.var_1434 = [AvatarEditorFigureCategory.const_683,AvatarEditorFigureCategory.const_52,AvatarEditorFigureCategory.const_222,AvatarEditorFigureCategory.const_734,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_107];
         super();
         ...
         if(var_1296 == null)
         {
            ...
            var_1296 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1566 == null)
         {
            _loc8_ = this._controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1566 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_448 = new Timer(1000);
         this.var_448.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1434;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1434);
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2631 = this.canChangeOutfit();
            this.var_448.stop();
            if(this._window)
            {
      ...
      private function attachImages() : void
      {
         ...
         var _loc1_:Array = this.var_1434;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_44) && (this.var_1877 == AvatarEditorSideCategory.const_107 || this.var_2630))
         {
      ...
      {
         if(this.var_1877 == AvatarEditorSideCategory.const_107)
         {
            this.var_2630 = false;
            this.setSideContent(AvatarEditorSideCategory.const_658);
         }
         else
         {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "save":
                  ...
                  this.var_2284 = new Date().valueOf();
                  this.var_2631 = false;
                  this.var_448.start();
      ...
      private function canChangeOutfit() : Boolean
      {
         ...
         return _loc1_ - this.var_2284 > 5000;
      }
   }
}
