package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1336:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1334:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_720:ISessionDataManager;
      
      private var _view:AvatarEditorView;
      
      private var var_1137:AvatarEditorHandler;
      ...
      private var var_928:IFigureData;
      ...
      private function init(param1:Array = null) : void
      {
         ...
         if(!this.var_195)
         {
            ...
            this.var_607["null"] = new FigureData(this);
            this.var_607["null"] = new FigureData(this);
            _loc2_ = this.var_607["null"];
            _loc3_ = this.var_607["null"];
            _loc2_.loadAvatarData(const_1336,FigureData.const_77);
            _loc3_.loadAvatarData(const_1334,FigureData.FEMALE);
            this.var_101 = new Map();
            this.var_507 = new Map();
            this.var_101.add(AvatarEditorFigureCategory.const_683,new BodyModel(this));
            this.var_101.add(AvatarEditorFigureCategory.const_52,new HeadModel(this));
            this.var_101.add(AvatarEditorFigureCategory.const_222,new TorsoModel(this));
            this.var_101.add(AvatarEditorFigureCategory.const_734,new LegsModel(this));
            ...
            this.var_507.add(AvatarEditorSideCategory.const_107,new WardrobeModel(this));
            this.var_507.add(AvatarEditorSideCategory.const_528,new ClubPromoModel(this));
            this.var_195 = true;
         }
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var _loc4_:FigureData = this.var_607[param2];
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_928.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_928.getPalette(param1);
      }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         else
         {
            if(this.var_256 == null)
            {
               this.var_256 = this._windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_67,HabboWindowStyle.const_32,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_683);
         }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_720 = param2 as ISessionDataManager;
      }
      ...
      {
         this.var_928 = this.var_506.getFigureData(AvatarType.const_120);
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1137 = new AvatarEditorHandler(this,this._communication);
      }
      ...
      {
         return this.var_607[this.var_995];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         if(this.var_1397 != null)
         {
            ...
            this.var_1397.saveFigure(_loc1_,_loc2_);
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_1750;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_1138 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < this.const_1335)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1566.clone() as IWindowContainer,param1,_loc13_);
            ...
            if(_loc15_)
            {
               ...
               if(_loc21_)
               {
                  ...
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1296.clone() as IWindowContainer,param1,null,null,false);
            ...
            for each(_loc6_ in _loc8_.partSets)
            {
               ...
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1296.clone() as IWindowContainer,param1,_loc6_,_loc11_,_loc16_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_507.getValue(AvatarEditorSideCategory.const_107);
      }
