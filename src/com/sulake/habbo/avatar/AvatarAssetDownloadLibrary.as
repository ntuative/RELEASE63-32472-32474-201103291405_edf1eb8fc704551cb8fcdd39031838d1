package com.sulake.habbo.avatar
{
   ...
   public class AvatarAssetDownloadLibrary extends EventDispatcher
   {
      ...
      private static var var_1759:int = 1;
      ...
      public function AvatarAssetDownloadLibrary(param1:String, param2:String, param3:String, param4:IAssetLibrary)
      {
         ...
         this.var_1405 = param3 + this.var_933 + ".swf";
         this.var_1405 = this.var_1405.replace("%revision%",this._revision);
      ...
      {
         this._state = var_1759;
         var _loc1_:URLRequest = new URLRequest(this.var_1405);
