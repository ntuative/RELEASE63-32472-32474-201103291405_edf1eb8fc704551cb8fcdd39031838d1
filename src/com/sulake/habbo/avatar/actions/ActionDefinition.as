package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_2163 = parseInt(param1.@precedence);
         this.var_2162 = String(param1.@activepartset);
         this.var_2160 = String(param1.@assetpartdefinition);
         this.var_2158 = String(param1.@lay);
         this.var_716 = String(param1.@geometrytype);
         this.var_2156 = Boolean(parseInt(param1.@main));
         this.var_2161 = Boolean(parseInt(param1.@RoomPropertyMessageParser));
         this.var_2157 = Boolean(parseInt(param1.@animation));
         ...
         for each(_loc3_ in param1.param)
         {
            ...
            if(_loc5_ == "RoomPropertyMessageParser")
            {
               this.var_2159 = _loc6_;
            }
            else
            {
      ...
      public function setOffsets(param1:String, param2:int, param3:Array) : void
      {
         ...
         {
            this.var_705.add(param1,new Map());
         }
         var _loc4_:Map = this.var_705.getValue(param1);
      ...
      public function getOffsets(param1:String, param2:int) : Array
      {
         ...
         var _loc3_:Map = this.var_705.getValue(param1) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      public function getParameterValue(param1:String) : String
      {
         ...
         if(_loc2_ == null)
         {
            _loc2_ = this.var_2159;
         }
         return _loc2_;
      }
      
      private function method_6(param1:String) : Array
      {
         if(param1 == "")
         {
            return [];
      ...
      {
         return this._prevents.concat(this.method_6(param1));
      }
