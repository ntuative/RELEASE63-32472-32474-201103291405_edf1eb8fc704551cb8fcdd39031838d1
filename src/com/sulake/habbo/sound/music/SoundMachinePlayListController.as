package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_238 = param2;
         this.var_702 = [];
         this.var_702.push(new PlayListMessageEvent(this.onPlayListMessage));
         this.var_702.push(new PlayListSongAddedMessageEvent(this.onPlayListSongAddedMessage));
         for each(_loc6_ in this.var_702)
         {
         ...
         this.var_80.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_873,this.onSoundMachinePlayEvent);
         this.var_80.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_682,this.onSoundMachineStopEvent);
      }
      ...
      {
         return HabboMusicPrioritiesEnum.const_203;
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this._events)
            {
               this._events.removeEventListener(SoundCompleteEvent.const_330,this.onSongFinishedPlayingEvent);
               this._events = null;
            }
            if(this.var_80)
            {
               this.var_80.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_873,this.onSoundMachinePlayEvent);
               this.var_80.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_682,this.onSoundMachineStopEvent);
               this.var_80 = null;
            }
            this._disposed = true;
         }
      ...
      public function checkSongPlayState(param1:int) : void
      {
         ...
         {
            this.playCurrentSongAndNotify(this.var_536);
      ...
      {
         this.var_238.stop(HabboMusicPrioritiesEnum.const_203);
         this.var_536 = -1;
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_238.playSong(param1,HabboMusicPrioritiesEnum.const_203,_loc3_))
         {
      ...
      private function onPlayListMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc8_ < _loc5_.length)
         {
            ...
            {
               this.var_536 = _loc6_.id;
               _loc6_.startPlayHeadPos = Number(_loc4_) / 1000;
            }
            _loc4_ -= _loc6_.length;
            _loc8_++;
         }
         this._events.dispatchEvent(new PlayListUpdatedEvent(PlayListUpdatedEvent.const_588));
