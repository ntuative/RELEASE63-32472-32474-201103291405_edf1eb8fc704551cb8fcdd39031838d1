package com.sulake.habbo.sound.music
{
   ...
   public class HabboMusicController implements IHabboMusicController, IDisposable
   {
      ...
      private var var_501:HabboSoundManagerFlash10;
      ...
      private var var_430:IPlayListController = null;
      ...
      public function HabboMusicController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_80.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_765,this.onJukeboxInit);
         this.var_80.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_872,this.onJukeboxDispose);
         this.var_80.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_715,this.onSoundMachineInit);
         this.var_80.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_867,this.onSoundMachineDispose);
         this.var_1155 = new Timer(1000);
         this.var_1155.start();
         this.var_1155.addEventListener(TimerEvent.TIMER,this.sendNextSongRequestMessage);
         this._events.addEventListener(SoundCompleteEvent.const_330,this.onSongFinishedPlayingEvent);
         var _loc5_:int = 0;
         while(_loc5_ < HabboMusicPrioritiesEnum.PRIORITY_COUNT)
         {
            this.var_1156[_loc5_] = -1;
            this.var_512[_loc5_] = null;
            _loc5_++;
         }
      }
      ...
      {
         if(this.getSongIdPlayingAtPriority(this.var_431) == param1.id)
         {
            this.resetSongIdPlayingAtPriority(this.var_431);
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            {
               _loc1_ = 0;
               while(_loc1_ < this.var_511.length)
               {
                  _loc2_ = this.var_511.getWithIndex(_loc1_) as SongDataEntry;
            ...
            if(this.var_80)
            {
               this.var_80.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_765,this.onJukeboxInit);
               this.var_80.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_872,this.onJukeboxDispose);
               this.var_80.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_715,this.onSoundMachineInit);
               this.var_80.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_867,this.onSoundMachineDispose);
            }
            this._disposed = true;
         }
      }
      ...
      private function processSongEntryForPlaying(param1:int, param2:Boolean = true) : Boolean
      {
         ...
         {
            _loc3_.soundObject = this.var_501.loadTraxSong(_loc3_.id,_loc3_.songData);
         }
      ...
      {
         var _loc2_:* = param1 == this.var_431;
         ...
         if(param1 > HabboMusicPrioritiesEnum.const_203)
         {
            this._events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_1600,param1,-1,-1));
         }
      }
      ...
      private function stopSongAtPriority(param1:int) : void
      {
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(param1 == this.var_431 && this.var_431 >= 0)
         {
      ...
      {
         return this.var_511.getValue(param1) as SongDataEntry;
      }
      ...
      private function resetSongIdPlayingAtPriority(param1:int) : void
      {
         if(param1 >= 0 && param1 < HabboMusicPrioritiesEnum.PRIORITY_COUNT)
         {
            this.var_1156[param1] = -1;
            this.var_512[param1] = null;
         }
      }
      ...
      private function getSongIdRequestedAtPriority(param1:int) : int
      {
         ...
         if(this.var_512[param1] == null)
         {
            return -1;
         }
         var _loc2_:SongStartRequestData = this.var_512[param1];
         return _loc2_.songId;
      }
      
      private function sendNextSongRequestMessage(param1:TimerEvent) : void
      {
         if(this.var_745.length < 1)
         {
            return;
         }
         if(this._connection == null)
         ...
         this._connection.send(new GetSongInfoMessageComposer(this.var_745));
         Logger.log("Requested song info\'s : " + this.var_745);
         this.var_745 = new Array();
      }
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc5_ < _loc4_.length)
         {
            ...
            if(_loc7_)
            {
               ...
               while(this.var_746.indexOf(_loc6_.id) != -1)
               {
                  this.var_746.splice(this.var_746.indexOf(_loc6_.id),1);
               }
               if(this.var_746.length == 0)
               {
                  this._events.dispatchEvent(new SongDiskInventoryReceivedEvent(SongDiskInventoryReceivedEvent.const_1238));
               }
      ...
      private function playSongObject(param1:int, param2:int) : Boolean
      {
         ...
         this.stopSongAtPriority(this.var_431);
         ...
         _loc4_.volume = this.var_501.volume;
         var _loc5_:* = Number(const_1236);
         var _loc6_:* = 0;
         ...
         _loc4_.play(_loc6_);
         this.var_431 = param1;
         this.var_1156[param1] = param2;
         this.notifySongPlaying(_loc3_);
         if(param1 > HabboMusicPrioritiesEnum.const_203)
         {
            this._events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_1664,param1,_loc3_.id,-1));
         }
      ...
      private function notifySongPlaying(param1:SongDataEntry) : void
      {
         ...
         if(param1.length >= 8000 && (this.var_2405 != param1.id || _loc3_ > this.var_2404 + 8000))
         {
            this.var_501.notifyPlayedSong(param1.name,param1.creator);
            this.var_2405 = param1.id;
      ...
      {
         var _loc1_:int = this.var_512.length - 1;
         while(_loc1_ >= 0)
         {
            if(this.var_512[_loc1_] != null)
            {
               return _loc1_;
            }
            _loc1_--;
      ...
      private function onSongDiskInventoryMessage(param1:IMessageEvent) : void
      {
         ...
         this.var_1760 = _loc3_.songDiskInventory;
         for each(_loc4_ in this.var_1760.getValues())
         {
            if(this.var_511.getKeys().indexOf(_loc4_) == -1)
            {
               this.var_746.push(_loc4_);
      ...
      {
         this.var_430 = new SoundMachinePlayListController(this.var_501,this,this._events,this.var_80,this._connection) as IPlayListController;
      }
      ...
      {
         this.var_430 = new JukeboxPlayListController(this.var_501,this,this._events,this.var_80,this._connection) as IPlayListController;
      }
