package com.sulake.habbo.sound.music
{
   ...
   public class JukeboxPlayListController extends GenericPlaylist implements IPlayListController
   {
      ...
      public function JukeboxPlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_80 = param4;
         this.var_702 = [];
         this.var_702.push(new NowPlayingMessageEvent(this.onNowPlayingMessage));
         this.var_702.push(new JukeboxSongDisksMessageEvent(this.onJukeboxSongDisksMessage));
         ...
         this.var_80.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_906,this.onFurnitureStateOnEvent);
         this.var_80.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_897,this.onFurnitureStateOffEvent);
      }
      ...
      override public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            ...
            if(this.var_80)
            {
               this.var_80.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_906,this.onFurnitureStateOnEvent);
               this.var_80.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_897,this.onFurnitureStateOffEvent);
               this.var_80 = null;
            }
            super.dispose();
            this.var_501 = null;
      ...
      {
         var_238.stop(HabboMusicPrioritiesEnum.const_203);
         this.var_536 = -1;
         _isPlaying = false;
      }
      ...
      private function onNowPlayingMessage(param1:IMessageEvent) : void
      {
         ...
         {
            var_238.playSong(_loc3_.currentSongId,HabboMusicPrioritiesEnum.const_203,_loc3_.syncCount / 1000);
            this.var_536 = _loc3_.currentSongId;
         }
         if(_loc3_.nextSongId >= 0)
         {
            var_238.addSongInfoRequest(_loc3_.nextSongId);
         }
         this.var_501.events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_744,HabboMusicPrioritiesEnum.const_203,_loc3_.currentSongId,_loc3_.currentPosition));
      }
      ...
      private function onJukeboxSongDisksMessage(param1:IMessageEvent) : void
      {
         ...
         {
            _events.dispatchEvent(new PlayListUpdatedEvent(PlayListUpdatedEvent.const_588));
         }
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         while(this.var_732.indexOf(param1.id) != -1)
         {
            this.var_732.splice(this.var_732.indexOf(param1.id),1);
         }
         if(this.var_732.length == 0)
         {
            _events.dispatchEvent(new PlayListUpdatedEvent(PlayListUpdatedEvent.const_588));
