package com.sulake.habbo.sound.music
{
   ...
   public class GenericPlaylist implements IPlayListController, IDisposable
   {
      ...
      {
         var _loc1_:SongDataEntry = this.var_89[this.var_690];
         return _loc1_.id;
      }
      ...
      {
         var _loc1_:SongDataEntry = this.getEntry(this.var_690) as SongDataEntry;
      ...
      {
         var _loc2_:SongDataEntry = this.getEntry(this.var_690) as SongDataEntry;
      ...
      protected function playNextItem() : void
      {
         ...
         this.var_238.playSong(_loc1_.id,this._priority);
         this.var_690 = this.getNextIndex();
      }
      
      protected function getNextIndex() : int
      {
         return this.var_690 + 1 >= this.var_89.length ? 0 : int(this.var_690 + 1);
      }
   }
}
