package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_943:uint = 11;
      ...
      private var var_1073:IHabboWindowManager;
      ...
      private var var_577:FramerateTracker = null;
      
      private var var_242:LatencyTracker = null;
      
      private var var_576:LagWarningLogger = null;
      
      private var var_578:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_577 = new FramerateTracker();
         this.var_242 = new LatencyTracker();
         this.var_576 = new LagWarningLogger();
         this.var_578 = new ToolbarClickTracker(this);
         this.var_1332 = new Array(const_943);
         var _loc4_:int = 0;
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1743,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1688,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_877,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1264,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1073)
            {
               this.var_1073.release(new IIDHabboWindowManager());
               this.var_1073 = null;
            }
            if(this.var_299)
            {
            ...
            if(this.var_196)
            {
               if(!this.var_196.disposed)
               {
                  ...
                  Component(this.var_196).events.removeEventListener(HabboFriendListTrackingEvent.const_407,this.onFriendlistTrackingEvent);
               }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_180)
         {
            if(this.var_242 != null)
            {
               this.var_242.configuration = this.var_180;
            }
            if(this.var_243 != null)
            {
               this.var_243.configuration = this.var_180;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_1727);
            if(this.var_180)
            {
               if(this.var_576 != null)
               {
                  this.var_576.configure(this.var_180);
               }
               if(this.var_577 != null)
               {
                  this.var_577.configure(this.var_180);
               }
               if(this.var_578 != null)
               {
                  this.var_578.configure(this.var_180);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_798,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_263,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_723,this.onHotelViewEvent);
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_242 != null)
            {
               this.var_242.communication = this._communication;
      ...
      private function onHotelViewEvent(param1:Event) : void
      {
         ...
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1678);
         }
         ...
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1626);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1670);
               break;
            case HabboCommunicationEvent.const_798:
               this.trackLoginStep(HabboLoginTrackingStep.const_1540,String(this._communication.port));
               break;
            case HabboCommunicationEvent.const_263:
               this.trackLoginStep(HabboLoginTrackingStep.const_263);
               break;
      ...
      {
         this.var_1073 = IHabboWindowManager(param2);
         if(this.var_1073)
         {
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_196).events.addEventListener(HabboFriendListTrackingEvent.const_407,this.onFriendlistTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1264,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_877,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_240,this.onRoomAdClick);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_299 = param2 as IAdManager;
         this.var_299.events.addEventListener(AdEvent.const_572,this.onRoomAdLoad);
      }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_578)
         {
            this.var_578.track(param1.iconName);
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_480 > -1 && _loc2_ < this.var_480)
         {
            ++this.var_1611;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1611);
         }
         if(this.var_480 > -1 && _loc2_ - this.var_480 > 15000)
         {
            ++this.var_1612;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1612);
         }
         this.var_480 = _loc2_;
         if(this.var_243 != null)
         {
            this.var_243.update(param1,this.var_480);
         }
         if(this.var_242 != null)
         {
            this.var_242.update(param1,this.var_480);
         }
         if(this.var_577 != null)
         {
            this.var_577.trackUpdate(param1,this,this.var_480);
         }
         if(this.var_576 != null)
         {
            this.var_576.update(this.var_480);
         }
      }
   }
}
