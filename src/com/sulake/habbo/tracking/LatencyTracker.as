package com.sulake.habbo.tracking
{
   ...
   public class LatencyTracker
   {
      ...
      public function init() : void
      {
         ...
         this.var_1706 = int(this.var_180.getKey("latencytest.interval"));
         this.var_1705 = int(this.var_180.getKey("latencytest.report.index"));
         this.var_2320 = int(this.var_180.getKey("latencytest.report.delta"));
      ...
      public function update(param1:uint, param2:int) : void
      {
         ...
         if(param2 - this.var_1708 > this.var_1706)
         {
            this.testLatency();
         }
      }
      ...
      {
         this.var_1708 = getTimer();
         this.var_601.add(this.var_1375,this.var_1708);
         this._connection.send(new LatencyPingRequestMessageComposer(this.var_1375));
         ++this.var_1375;
      }
      ...
      private function onPingResponse(param1:IMessageEvent) : void
      {
         ...
         var _loc10_:int = 0;
         var _loc11_:* = null;
         if(this.var_601 == null || this.var_218 == null)
         {
            return;
         }
         ...
         if(this.var_218.length == this.var_1705 && this.var_1705 > 0)
         {
            _loc5_ = 0;
            _loc6_ = 0;
            _loc7_ = 0;
            ...
            if(Math.abs(_loc9_ - this.var_1707) > this.var_2320 || this.var_1707 == 0)
            {
               this.var_1707 = _loc9_;
