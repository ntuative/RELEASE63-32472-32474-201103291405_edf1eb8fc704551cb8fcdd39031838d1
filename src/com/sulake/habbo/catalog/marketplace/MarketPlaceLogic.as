package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      public const const_1967:int = 1;
      
      public const const_1899:int = 2;
      
      public const const_2097:int = 3;
      ...
      private var var_2844:MarketplaceItemStats;
      ...
      public function dispose() : void
      {
         ...
         {
            this.disposeOffers(this.var_330);
            this.var_330 = null;
         }
         this._disposed = true;
      }
      ...
      {
         this.requestOffers(this.var_2843,this.var_2842,this.var_2505,this.var_2663);
      }
      ...
      public function buyOffer(param1:int) : void
      {
         ...
         this.showConfirmation(this.const_1967,_loc2_);
      }
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         for each(_loc4_ in _loc3_.offers)
         {
            ...
            _loc5_.timeLeftMinutes = _loc4_.timeLeftMinutes;
            this.var_330.add(_loc4_.offerId,_loc5_);
         }
         if(this._visualization != null)
         {
            this._visualization.listUpdatedNotify();
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         else if(parser.result == 3)
         {
            ...
            this.showConfirmation(this.const_1899,updateItem);
            if(this._visualization != null)
            {
               this._visualization.listUpdatedNotify();
            }
      ...
      public function onCancelResult(param1:IMessageEvent) : void
      {
         ...
         if(parser.result == 1)
         {
            item = this.var_330.remove(parser.offerId);
            if(item != null)
            {
               item.dispose();
            }
      ...
      {
         if(param1.furniCategoryId != this.var_2837 || param1.furniTypeId != this.var_2836)
         {
            return;
         }
