package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_1009:int = 0;
      ...
      {
         return this.var_658 != const_1009;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1970 != RecyclerStatusMessageEvent.const_1031;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_658 == const_429;
      }
      ...
      {
         this.var_658 = const_1008;
         this.var_124 = new Array(const_187);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         {
            case RecyclerStatusMessageEvent.const_1580:
               this.var_658 = const_429;
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_1031:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1647:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_124.length < const_187)
         {
            return false;
         }
         var _loc1_:int = 0;
