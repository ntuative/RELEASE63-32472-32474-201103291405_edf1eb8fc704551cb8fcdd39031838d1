package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1776:uint = 4.293848814E9;
      
      private const const_1777:uint = 4.294967295E9;
      
      private const const_2091:uint = 4.291613146E9;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1928 = _loc1_.stuffTypes;
            this.var_841 = _loc1_.boxTypes;
            this.var_840 = _loc1_.ribbonTypes;
            this.var_1293 = this.var_1928[0];
            this.var_394 = this.var_841[0];
            this.var_392 = this.var_840[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_392 < 0)
         {
            this.var_392 = this.var_840.length - 1;
         }
         if(this.var_392 > this.var_840.length - 1)
         {
            this.var_392 = 0;
         }
         if(this.var_394 < 0)
         {
            this.var_394 = this.var_841.length - 1;
         }
         if(this.var_394 > this.var_841.length - 1)
         {
            this.var_394 = 0;
         }
         var _loc1_:int = this.var_841[this.var_394] * 1000 + this.var_840[this.var_392];
         if(this._window == null)
         {
            return;
         }
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1928;
      ...
      private function giveGift() : void
      {
         ...
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_841[this.var_394]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_840[this.var_392]);
         this._catalog.purchaseProductAsGift(this.var_1562,this.var_91,this.var_1561,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this.var_1562,this.var_91.offerId,this.var_1561);
               this.dispose();
               break;
            case "cancel_button":
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_281 == null || this.var_679 == null)
         {
            return;
         }
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_2091;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1776) : uint(this.const_1777);
      }
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = this.var_281.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
