package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      override public function init() : Boolean
      {
         ...
         this.var_905 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1122 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_85 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1704 = new Point(this.var_85.x,this.var_85.y);
         this.var_494 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1371 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_1703 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_905.text = _loc4_;
         this.var_1122.text = _loc5_;
         this.var_905.height = this.var_905.textHeight + 5;
         this.var_1122.y = this.var_905.y + this.var_905.height;
         this.var_1122.height = Math.max(130,this.var_1122.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_440:
                  _loc6_ = this.var_1703.clone();
                  if(this.var_494 != null)
                  {
                     this.var_494.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_494,this.var_1371,this.var_1926);
                     this.var_494.scrollV = 0;
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_184:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_311,AvatarAction.const_515);
                              _loc16_.appendAction(AvatarAction.const_322,_loc8_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2316)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2316 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_85 != null && true)
         {
            ...
            this.var_85.x = this.var_1704.x;
            this.var_85.y = this.var_1704.y;
            if(param3 != null)
            {
