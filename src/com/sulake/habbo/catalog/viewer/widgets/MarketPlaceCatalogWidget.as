package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private const const_1773:int = 2;
      
      private const const_2087:int = 40;
      
      private const const_2086:int = 10;
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         switch(param1)
         {
            ...
            case "search_by_activity":
               _loc5_ = "marketplace_search_simple";
               this.var_806 = [3,4,5,6];
               break;
            case "search_advanced":
               _loc5_ = "marketplace_search_advanced";
               this.var_806 = [1,2,3,4,5,6];
               break;
            default:
               return;
         }
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(this.getSortKeys(this.var_806));
            _loc7_.selection = 0;
         }
      }
      ...
      private function updateList() : void
      {
         ...
         this.updateStatusDisplay(this.const_1773,_loc2_.length);
         if(!this.var_537)
         {
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(this.var_1241 >= this._offers.length)
            {
               return true;
            }
            this.addListItem(this._offers.getWithIndex(this.var_1241));
            ++this.var_1241;
            _loc1_++;
         }
         return false;
      ...
      {
         var _loc5_:* = null;
         this.updateStatusDisplay(this.const_1772);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < this.var_806.length)
         {
            _loc4_ = this.var_806[_loc6_.selection];
         }
         ...
         else if(param1.type == WindowEvent.const_103)
         {
            ...
            switch(_loc7_.name)
            {
               ...
               case "max_price_input":
                  _loc8_ = this.const_2086;
                  break;
               case "search_input":
                  _loc8_ = this.const_2087;
                  break;
               default:
                  return;
            }
