package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class NewPetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1433:int = 18;
      ...
      override public function init() : Boolean
      {
         ...
         events.addEventListener(WidgetEvent.const_662,this.onApproveNameResult);
      ...
      private function initializeBreedSelection() : void
      {
         ...
         if(this.var_199 != null)
         {
            _loc1_ = [];
            _loc2_ = 0;
            while(_loc2_ < const_1433 && _loc2_ < this.var_199.length)
            {
               _loc3_ = (page.viewer.catalog as HabboCatalog).roomEngine.getPetColor(this.var_551,this.var_199[_loc2_]);
               if(_loc3_ != null)
               {
      ...
      private function selectedBreed(param1:int) : void
      {
         if(this.var_199 != null && this.var_199.length > 0)
         {
            ...
            this.var_391 = this.var_199[param1];
            this.updateImage();
         }
      }
      ...
      private function getPetLocalization() : String
      {
         ...
         if(page != null && false)
         {
            ...
            {
               return _loc1_.localization.getKey(this.getRaceLocalizationKey(this.var_551,this.var_391),this.getRaceLocalizationKey(this.var_551,this.var_391));
            }
         }
         return this.getRaceLocalizationKey(this.var_551,this.var_391);
      }
      ...
      {
         if(param1.productCode == this.var_2219)
         {
