package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IPetDataListener, IPetImageListener
   {
      ...
      override public function init() : Boolean
      {
         ...
         this.var_2219 = _loc3_.localizationId;
         this.var_342 = [];
         if(page && false && page.viewer.catalog)
         {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         this.var_488 = param1.index;
         if(this.var_488 < 0 || this.var_488 > this.var_342.length)
         {
            this.var_488 = 0;
         }
         this.updateImage();
      ...
      private function updateImage() : void
      {
         ...
         if(this.var_199 == null || this.var_714 >= this.var_199.length)
         {
            return;
         }
         var _loc2_:* = 0;
         if(this.var_488 >= 0 && this.var_488 < this.var_342.length)
         {
            _loc7_ = this.var_342[this.var_488] as IPetColor;
            if(_loc7_ != null)
            {
               _loc2_ = uint(_loc7_.rgb);
            }
         }
         var _loc3_:int = this.var_199[this.var_714] as int;
         ...
         _loc4_.appendAction(AvatarAction.const_311,AvatarAction.const_869);
      ...
      private function getPurchaseParameters() : String
      {
         ...
         if(this.var_488 >= this.var_342.length)
         {
            return "";
         }
         var petColor:IPetColor = this.var_342[this.var_488] as IPetColor;
         var color:uint = petColor.rgb;
         var breed:int = this.var_199[this.var_714] as int;
