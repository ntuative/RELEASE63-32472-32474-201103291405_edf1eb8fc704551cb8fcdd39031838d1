package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1013:IButtonWindow;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1013.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_1013 = null;
         }
         if(this.var_1012 != null)
         {
            this.var_1012.removeEventListener(WindowKeyboardEvent.const_192,this.windowKeyEventProcessor);
            this.var_1012 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1013 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_1013 != null)
         {
            this.var_1013.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_1012 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_1012 != null)
         {
            this.var_1012.addEventListener(WindowKeyboardEvent.const_192,this.windowKeyEventProcessor);
         }
         return true;
      }
