package com.sulake.habbo.messenger.domain
{
   ...
   public class Conversations
   {
      ...
      public function addConversation(param1:int) : Conversation
      {
         ...
         if(_loc2_)
         {
            _loc3_.addMessage(new Message(Message.const_793,0,this.var_413.getText("messenger.moderationinfo"),""));
         }
         return _loc3_;
      }
      ...
      {
         this._startIndex = Math.min(this._startIndex,this.var_132.length - this.var_413.getTabCount());
