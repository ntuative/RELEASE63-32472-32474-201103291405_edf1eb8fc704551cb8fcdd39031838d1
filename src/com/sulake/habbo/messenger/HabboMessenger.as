package com.sulake.habbo.messenger
{
   ...
   public class HabboMessenger extends Component implements IHabboMessenger, IAvatarImageListener
   {
      ...
      public function playSendSound() : void
      {
         ...
         {
            this.var_501.playSound(HabboSoundTypesEnum.const_1197);
         }
      }
      ...
      public function setHabboToolbarIcon(param1:Boolean, param2:Boolean) : void
      {
         if(!param1)
         {
            this.var_181.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_127,HabboToolbarIconEnum.MESSENGER));
            return;
         }
         this.var_181.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_156,HabboToolbarIconEnum.MESSENGER));
      ...
      private function addMsg(param1:Message) : void
      {
         ...
         if(!this.var_254.isMessengerOpen())
         {
            if(this.var_501 != null)
            {
               this.var_501.playSound(HabboSoundTypesEnum.const_1141);
            }
      ...
      private function onInstantMessageError(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_1246,_loc2_.userId,this.getInstantMessageErrorText(_loc2_.errorCode),Util.getFormattedNow());
