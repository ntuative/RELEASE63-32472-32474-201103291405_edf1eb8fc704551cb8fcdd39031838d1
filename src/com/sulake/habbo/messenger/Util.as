package com.sulake.habbo.messenger
{
   ...
   public class Util
   {
      ...
      public static function method_9(param1:IHabboWindowManager, param2:String, param3:int, param4:int, param5:Boolean) : IWindowContainer
      {
         return param1.createWindow(param2,param2,HabboWindowType.const_67,HabboWindowStyle.const_32,0 | (!!param5 ? HabboWindowParam.const_61 : 0),new Rectangle(param3,param4,600,600),null) as IWindowContainer;
      }
   }
}
