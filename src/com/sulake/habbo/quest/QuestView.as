package com.sulake.habbo.quest
{
   ...
   public class QuestView implements IGetImageListener, IDisposable
   {
      ...
      private var var_63:Quest;
      
      private var _view:IWindow;
      
      private var var_618:int;
      
      private var var_2457:IScrollableListWindow;
      ...
      private function createView() : void
      {
         switch(this.var_63.type)
         {
            ...
            case QuestTypeEnum.SWITCH_ITEM_STATE:
               ...
               this.var_2457 = this.find("quest.content.itemlist") as IScrollableListWindow;
               if(!this._view)
               {
                  throw new Error("[QuestView] Could not create view for quest type: " + this.var_63.type + " !");
               }
               this._view.addEventListener(WindowEvent.const_48,this.onResized);
               return;
               break;
            default:
               throw new Error("[QuestView] View not defined for quest type: " + this.var_63.type + " !");
         }
      }
      ...
      public function onActivateQuest(param1:WindowEvent, param2:IWindow = null) : void
      {
         if(this.var_63)
         {
            this.var_64.controller.activateQuest(this.var_63);
         }
      }
      ...
      private function localize() : void
      {
         ...
         var _loc38_:* = null;
         var _loc39_:* = null;
         var _loc1_:String = ["quest",this.var_64.code,this.var_63.localizationCode].join("_");
         var _loc2_:String = ["quest_" + this.var_64.code,"type_" + this.var_63.type.toLowerCase()].join(".");
         ...
         if(this.var_63.type == QuestTypeEnum.FIND_STUFF)
         {
            _loc34_ = this.var_63.roomItemTypeName.split("*");
         ...
         else if(this.var_63.type == QuestTypeEnum.FIND_HIDDEN_STUFF)
         {
            this.var_64.controller.questEngine.setImageFromAsset(_loc15_,"icon_quest_hidden",this.onPreviewImageReady);
         }
         else if(this.var_63.type == QuestTypeEnum.GIVE_BADGE)
         {
            this.var_64.controller.questEngine.setImageFromAsset(_loc15_,this.var_63.questBadgeAchievementTypeId,this.onPreviewImageReady);
         }
         else if(this.var_63.type == QuestTypeEnum.PLACE_ITEM)
         {
            this.var_618 = -1;
            QuestUtils.setElementImage(this.find("quest.image") as IBitmapWrapperWindow,new BitmapData(1,1,true));
         }
         else if(this.var_63.type == QuestTypeEnum.PICKUP_ITEM)
         {
            this.var_618 = -1;
            QuestUtils.setElementImage(this.find("quest.image") as IBitmapWrapperWindow,new BitmapData(1,1,true));
         }
         else if(this.var_63.type == QuestTypeEnum.ROTATE_ITEM)
         {
            this.var_618 = -1;
            QuestUtils.setElementImage(this.find("quest.image") as IBitmapWrapperWindow,new BitmapData(1,1,true));
         }
         else if(this.var_63.type == QuestTypeEnum.MOVE_ITEM)
         {
            this.var_618 = -1;
            QuestUtils.setElementImage(this.find("quest.image") as IBitmapWrapperWindow,new BitmapData(1,1,true));
         }
         else if(this.var_63.type == QuestTypeEnum.SWITCH_ITEM_STATE)
         {
            this.var_618 = -1;
            QuestUtils.setElementImage(this.find("quest.image") as IBitmapWrapperWindow,new BitmapData(1,1,true));
         }
         ...
         switch(this.var_63.status)
         {
            ...
            case QuestStatusEnum.const_175:
               ...
               _loc19_ = 4290822336;
               break;
            case QuestStatusEnum.const_845:
         ...
         this.var_64.controller.questEngine.localization.registerParameter(_loc14_,"amount",this.var_63.rewardCurrencyAmount.toString());
         this.setText("quest.reward.title",_loc13_);
         this.setText("quest.reward.desc",_loc14_,true,true);
         var _loc20_:int = this.var_63.endDate.date;
         var _loc21_:int = this.var_63.endDate.month + 1;
         var _loc22_:int = this.var_63.endDate.fullYear;
         var _loc23_:int = this.var_63.endDate.minutes;
         var _loc24_:int = this.var_63.endDate.hours;
         ...
         var _loc32_:String = "icon_" + this.var_64.code + "_reward_" + this.var_63.rewardCurrencyAmount;
         ...
         if(_loc33_)
         {
            this.var_619 = new Timer(20,1);
            this.var_619.addEventListener(TimerEvent.TIMER,this.onShowReward);
            this.var_619.start();
      ...
      private function setText(param1:String, param2:String, param3:Boolean = true, param4:Boolean = false) : void
      {
         ...
         if(_loc5_)
         {
            ...
            if(param4 && _loc5_ is IHTMLTextWindow)
            {
               ...
               (_loc5_ as IHTMLTextWindow).linkTarget = LinkTarget.const_687;
            }
         }
      }
