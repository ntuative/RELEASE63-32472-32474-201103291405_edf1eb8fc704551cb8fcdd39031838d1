package com.sulake.habbo.quest
{
   ...
   public class Quest implements IDisposable
   {
      ...
      private var var_1406:uint = 7645971;
      
      private var var_1763:uint = 6710886;
      ...
      public function update(param1:QuestMessageData) : void
      {
         ...
         this.var_1901 = param1.rewardCurrencyAmount;
         this.var_1764 = new Date();
         this.var_1764.setTime(param1.endDateTimeStamp);
         this.var_797 = param1.localizationCode;
         this.var_2419 = param1.questBadgeAchievementTypeId;
         this.updateView();
      }
      ...
      private function createView() : void
      {
         ...
         this.var_197.color = this.var_1406;
      }
      ...
      private function updateView() : void
      {
         ...
         var _loc3_:String = ["quest",this.var_64.code,this.var_797].join("_");
      ...
      private function itemGridEventProc(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            if(!this._selected)
            {
               this.var_197.color = this.var_1763;
            }
         }
