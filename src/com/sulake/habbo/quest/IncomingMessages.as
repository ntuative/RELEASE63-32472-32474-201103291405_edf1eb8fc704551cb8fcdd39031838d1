package com.sulake.habbo.quest
{
   ...
   public class IncomingMessages implements IDisposable
   {
      ...
      private var var_1946:IAlertDialog;
      ...
      private function setQuestingEnabled(param1:Boolean) : void
      {
         ...
         if(this.var_57.toolbar != null)
         {
            ...
            {
               this.var_57.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_127,HabboToolbarIconEnum.QUESTS));
            }
         }
      }
