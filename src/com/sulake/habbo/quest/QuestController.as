package com.sulake.habbo.quest
{
   ...
   public class QuestController implements IDisposable
   {
      ...
      public function questAccepted(param1:String, param2:QuestMessageData) : void
      {
         ...
         if(this.var_144 != null && this.var_144.quest.id == param2.id)
         {
      ...
      public function questCompleted(param1:String, param2:QuestMessageData) : void
      {
         ...
         if(this.var_144 != null && this.var_144.quest.id == param2.id && this.var_100 != null)
         {
      ...
      public function openCampaign(param1:String, param2:int, param3:Array, param4:Boolean) : void
      {
         ...
         if(this.var_586 != MODE_TABS)
         {
            this.var_586 = MODE_NO_TABS;
         }
         this.detachCampaign();
         _loc5_ = this.var_108[param1];
         if(!_loc5_)
      ...
      private function attachCampaign() : void
      {
         ...
         this._selectedCampaign.attachTo(this.var_1247);
      ...
      private function prepareWindow(param1:Boolean) : void
      {
         ...
         this._window.center();
         this.var_1247 = this._window.findChildByName("content") as IWindowContainer;
      }
      ...
      public function initializeReminderTimer() : void
      {
         ...
         this.var_701 = new Timer(_loc1_ * 1000);
         this.var_701.addEventListener(TimerEvent.TIMER,this.onReminderTimer);
      ...
      private function showQuestReminder(param1:QuestCampaign, param2:Quest) : void
      {
         ...
         if(this.var_100 != null)
         {
            _loc3_ = this.var_100.rectangle;
            this.var_100.dispose();
            this.var_100 = null;
         }
         this.var_100 = IWindowContainer(this.var_57.getXmlWindow("QuestReminder"));
         this.var_100.findChildByTag("close").procedure = this.onReminderWindowClose;
         if(_loc3_ != null)
         {
            this.var_100.x = _loc3_.x;
            this.var_100.y = _loc3_.y;
         }
         else
         {
            this.var_100.center();
         }
         var _loc4_:IWindowContainer = IWindowContainer(this.var_100.findChildByName("quest.container"));
         ...
         this.var_144 = new QuestView(param1,param2,true);
         _loc4_.addChild(this.var_144.view);
         this.var_144.init();
         this.var_100.height = param2.type == "FIND_STUFF" ? 453 : 390;
      ...
      {
         if(this.var_144 != null && this.var_100 != null && this.var_144.quest != null && this.var_144.quest.status != QuestStatusEnum.const_46)
         {
            this.var_100.visible = false;
         }
      }
      ...
      private function onReminderWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            this.var_100.visible = false;
            this.var_1510 = true;
            _loc3_ = this.var_144.quest.campaign.code + "." + this.var_144.quest.localizationCode;
      ...
      private function refreshTabs() : void
      {
         ...
         for each(_loc4_ in this.var_108.getKeys())
         {
            ...
            if(!_loc2_)
            {
               ...
               _loc2_ = this.var_57.windowManager.createWindow("tab_" + _loc4_,"${" + _loc6_ + "}",WindowType.const_446) as ITabButtonWindow;
               if(_loc3_.expired)
               {
