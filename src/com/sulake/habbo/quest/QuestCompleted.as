package com.sulake.habbo.quest
{
   ...
   public class QuestCompleted implements IDisposable
   {
      ...
      private var var_194:IFrameWindow;
      
      private var var_752:Boolean = false;
      
      private const const_1907:String = "achievement_bg_001";
      ...
      {
         this.var_194 = IFrameWindow(this.var_64.controller.questEngine.getXmlWindow("QuestCompletedDialog"));
         this.var_194.findChildByTag("close").procedure = this.onCompletedDialogClose;
         var _loc2_:IWindow = this.var_194.findChildByName("close_button");
         ...
         this.var_194.findChildByName("description_txt").caption = this.var_64.controller.questEngine.localization.getKey(_loc5_);
         ...
         this.var_194.findChildByName("reward_txt").caption = this.var_64.controller.questEngine.localization.getKey(_loc6_);
         var _loc7_:IWindow = this.var_194.findChildByName("reward_info_txt");
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_194.findChildByName("quest.reward.icon"));
         ...
         var _loc10_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_194.findChildByName("background_image"));
      ...
      private function onRewardImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(!this.var_752 && this.var_194 && _loc2_)
         {
            _loc3_ = IBitmapWrapperWindow(this.var_194.findChildByName("quest.reward.icon"));
      ...
      private function onBackgroundImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(!this.var_752 && this.var_194 && _loc2_)
         {
            _loc3_ = IBitmapWrapperWindow(this.var_194.findChildByName("background_image"));
            this.var_64.controller.questEngine.setImageFromAsset(_loc3_,_loc2_.assetName,this.onRewardImageReady);
         }
      }
