package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_2268:FriendListLookAndFeel;
      
      private var var_432:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1663:OpenedToWebPopup;
      ...
      {
         this.var_2268 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_101 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1662 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_591.stop();
            this.var_591.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_591 = null;
         }
         ...
         if(this.var_1103)
         {
            this.var_1103.release(new IIDAvatarRenderManager());
            this.var_1103 = null;
         }
         ...
         if(this.var_720)
         {
            this.var_720.release(new IIDSessionDataManager());
            this.var_720 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1663 = new OpenedToWebPopup(this);
         }
         this.var_1663.show(x,y);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_293,HabboWindowStyle.const_43,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1103.createAvatarImage(param1,AvatarScaleType.const_87,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_101.addCategory(new FriendCategory(FriendCategory.const_1206,this.getText("friendlist.friends")));
         this.var_101.addCategory(new FriendCategory(FriendCategory.const_406,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_101.addFriend(new Friend(_loc4_));
         }
         this.var_432 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_591)
         {
            this.var_591 = new Timer(120000);
            this.var_591.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_591.start();
         }
         this.getBuddyRequests();
         this.registerListeners();
         this.var_181.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_156,HabboToolbarIconEnum.FRIENDLIST));
         ...
         {
            _loc5_ = this.var_101.findCategory(FriendCategory.const_406);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            this._view.openFriendList();
            _loc1_ = this.var_432.findSelectedTab();
            if(_loc1_ == null)
            {
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_432.findTab(FriendListTab.const_96).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_432.findTab(FriendListTab.const_96);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1662.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_432.findTab(FriendListTab.const_96);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_720 || !this.var_348)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_720.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_47))
         {
            _loc2_ = this.var_348.vipLimit;
         }
         else if(this.var_720.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_44))
         {
