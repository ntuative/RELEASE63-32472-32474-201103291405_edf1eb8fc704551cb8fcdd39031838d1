package com.sulake.habbo.friendlist
{
   ...
   public class AvatarPopupCtrl extends PopupCtrl
   {
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         if(this.var_1620 != "")
         {
            friendList.refreshText(param1,"name_text_online",this.var_707,this.var_1620);
         }
         else
         {
            friendList.refreshText(param1,"name_text_online",this.var_707,this.var_1618);
         }
         friendList.refreshText(param1,"name_text_offline",!this.var_707,this.var_1618);
         friendList.refreshText(param1,"motto_text",this.var_707,this.var_2183);
         friendList.refreshButton(param1,"offline",!this.var_707,null,0);
         if(this.var_707)
         {
            this.refreshFigure(param1,this.var_2182);
