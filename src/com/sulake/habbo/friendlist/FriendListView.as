package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1775:String = "messageinput";
      ...
      private function prepare() : void
      {
         ...
         this.var_978 = IWindowContainer(this.var_16.content.findChildByName("main_content"));
         this.var_280 = IWindowContainer(this.var_16.content.findChildByName("footer"));
         this.var_1407.prepare(this.var_978);
         this.var_16.procedure = this.onWindow;
         this.var_16.content.setParamFlag(HabboWindowParam.const_1077,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_1152,true);
         this.var_16.header.setParamFlag(HabboWindowParam.const_757,false);
         this.var_16.header.setParamFlag(HabboWindowParam.const_661,true);
         this.var_16.content.setParamFlag(HabboWindowParam.const_757,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_661,true);
         this.var_16.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1408 = ITextWindow(this.var_16.findChildByName("info_text"));
         this.var_1408.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1770 == -1 ? 0 : int(this.var_16.height - this.var_1770);
         var _loc4_:int = this.var_1771 == -1 ? 0 : int(this.var_16.width - this.var_1771);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1133,this._friendList.tabs.findSelectedTab() != null);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_757,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1077,false);
         ...
         this.var_1770 = this.var_16.height;
         this.var_1771 = this.var_16.width;
