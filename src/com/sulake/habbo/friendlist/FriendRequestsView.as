package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private var var_1954:IContainerButtonWindow;
      
      private var var_1955:IContainerButtonWindow;
      ...
      {
         this.var_1954 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1955 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1955.procedure = this.onDismissAllButtonClick;
         this.var_1954.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_1222)
         {
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_357 && _loc4_.state != FriendRequest.const_417)
            {
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1954,_loc1_);
         this.setEnabled(this.var_1955,_loc1_);
      }
