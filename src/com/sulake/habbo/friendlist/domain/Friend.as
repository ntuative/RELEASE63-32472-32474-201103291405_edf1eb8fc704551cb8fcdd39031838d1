package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1847:int = "F".charCodeAt(0);
      
      public static const const_1846:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_995 = param1.gender;
         this.var_707 = param1.online;
         this.var_1871 = param1.followingAllowed && param1.online;
         this.var_643 = param1.figure;
         this.var_1870 = param1.motto;
