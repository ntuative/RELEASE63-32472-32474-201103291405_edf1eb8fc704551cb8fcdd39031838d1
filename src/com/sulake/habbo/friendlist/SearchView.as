package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      private var var_808:ITextFieldWindow;
      ...
      {
         this.var_808 = ITextFieldWindow(param1.findChildByName("search_str"));
         this.var_808.procedure = this.onSearchInput;
         this.var_808.addEventListener(WindowKeyboardEvent.const_192,this.onSearchStrInput);
      ...
      private function refreshShading() : void
      {
         ...
         {
            this.var_60.getListItemAt(_loc1_).color = this._friendList.laf.getRowShadingColor(FriendListTab.const_352,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
      ...
      private function onSearchEntry(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_653.setData(_loc3_.isAvatarOnline,_loc3_.avatarName,_loc3_.avatarMotto,_loc3_.avatarFigure,_loc3_.lastOnlineDate,_loc3_.realName);
            this.var_653.showPopup(this._friendList.view.mainWindow,IWindowContainer(param2));
         }
      ...
      private function onSearchStrInput(param1:Event) : void
      {
         ...
         {
            _loc5_ = 25;
            _loc6_ = this.var_808.text;
            if(_loc6_.length > _loc5_)
            {
               this.var_808.text = _loc6_.substring(0,_loc5_);
            }
         }
      }
