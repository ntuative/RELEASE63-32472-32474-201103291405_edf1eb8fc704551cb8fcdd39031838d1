package com.sulake.habbo.room
{
   ...
   public class RoomObjectFactory extends Component implements IRoomObjectFactory
   {
      ...
      {
         var _loc2_:* = null;
         if(this.var_997.indexOf(param1) < 0)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc3_:int = this.var_997.indexOf(param1);
         if(_loc3_ >= 0)
         {
            this.var_997.splice(_loc3_,1);
            if(param1 != null)
            {
               for each(_loc2_ in this.var_1226.getKeys())
               {
      ...
      public function createRoomObjectLogic(param1:String) : IRoomObjectEventHandler
      {
         ...
         if(_loc3_ is IRoomObjectEventHandler)
         {
            ...
            if(this.var_1888.getValue(param1) == null)
            {
               this.var_1888.add(param1,true);
