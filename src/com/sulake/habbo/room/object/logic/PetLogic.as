   ...
   public class PetLogic extends MovingObjectLogic
   {
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(!this.var_2145)
         {
            ...
            if(param1 is RoomObjectAvatarUpdateMessage)
            {
               ...
               _loc2_.setNumber(RoomObjectVariableEnum.const_202,_loc4_.dirHead);
               return;
            }
         ...
         if(param1 is RoomObjectAvatarExperienceUpdateMessage)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_647,Number(_loc9_.gainedExperience));
            return;
         }
         if(param1 is RoomObjectAvatarFigureUpdateMessage)
         {
            ...
            _loc2_.setString(RoomObjectVariableEnum.const_1640,_loc10_.race);
      ...
      private function debugMouseEvent(param1:RoomSpriteMouseEvent) : void
      {
         ...
         if(!param1.altKey && !param1.ctrlKey)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_202,_loc3_ + this.var_864);
         }
         else if(param1.altKey && !param1.ctrlKey)
         {
            ++this.var_1587;
            _loc2_.setNumber(RoomObjectVariableEnum.const_220,this.var_1587);
            _loc2_.setNumber(RoomObjectVariableEnum.const_147,NaN);
         }
         else if(param1.ctrlKey && !param1.altKey)
         {
            ++this.var_1588;
            _loc2_.setNumber(RoomObjectVariableEnum.const_147,this.var_1588);
         }
         else
         {
            this.var_864 += 45;
