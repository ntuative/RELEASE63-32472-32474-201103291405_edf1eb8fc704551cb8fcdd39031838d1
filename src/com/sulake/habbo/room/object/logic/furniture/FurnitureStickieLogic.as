package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureStickieLogic extends FurnitureLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectWidgetRequestEvent.const_133,RoomObjectFurnitureActionEvent.const_538];
      ...
      private function setColorIndexFromItemData() : void
      {
         ...
         if(object != null)
         {
            ...
            object.getModelController().setNumber(RoomObjectVariableEnum.const_253,_loc3_ + 1);
         }
      }
