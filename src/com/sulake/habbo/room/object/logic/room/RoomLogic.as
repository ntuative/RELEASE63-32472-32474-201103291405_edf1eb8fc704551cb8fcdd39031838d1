package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1873:int = 255;
      
      private var var_1217:int = 0;
      
      private var var_1872:int = 1500;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_553,RoomObjectMouseEvent.const_137];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_840,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_746,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_724,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_640,1);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1217)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1748;
            if(_loc2_ - this.var_1217 >= this.var_1872)
            {
               _loc3_ = this.var_1216;
               _loc4_ = this.var_1873;
               this.var_1217 = 0;
            }
            else
            {
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_840,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_834:
               param2.setString(RoomObjectVariableEnum.const_685,param1.value);
               break;
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_523:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_258)
               {
                  _loc5_ = "null";
               }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1250:
            ...
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1102:
               ...
               param2.setNumber(RoomObjectVariableEnum.const_640,_loc3_);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1120,int(param1.bgOnly));
         this.var_1465 = this._color;
         this.var_1874 = this.var_1748;
         this.var_1216 = _loc3_;
         this.var_1873 = _loc4_;
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1472,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1505,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1649,_loc21_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_162 || _loc12_ == RoomPlaneData.const_332)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
