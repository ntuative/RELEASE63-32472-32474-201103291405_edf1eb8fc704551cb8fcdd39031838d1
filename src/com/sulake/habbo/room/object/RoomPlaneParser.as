package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      private var var_988:Number = 0.0;
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         var _loc8_:int = 0;
         if(param1 >= 0 && param1 < this.var_268 && param2 >= 0 && param2 < this._height)
         {
            ...
            else
            {
               ...
               if(param2 == this.var_473 || param2 == this.var_475)
               {
                  _loc7_ = false;
                  _loc8_ = this.var_474;
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         ...
         this.var_988 = getFloorHeight(this.var_151);
         if(!param1)
         {
      ...
      private function addWall(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Boolean, param6:Boolean, param7:Boolean) : void
      {
         ...
         this.addPlane(RoomPlaneData.const_332,param1,param2,param3,[param4]);
         ...
         if(param5)
         {
            this.addPlane(RoomPlaneData.const_162,Vector3d.sum(Vector3d.sum(param1,param2),param3),Vector3d.product(param3,-(param3.length + this.var_128) / param3.length),_loc10_,[_loc9_,param4]);
         }
         if(param6)
         {
            this.addPlane(RoomPlaneData.const_162,Vector3d.sum(param1,Vector3d.product(param3,-this.var_128 / param3.length)),Vector3d.product(param3,(param3.length + this.var_128) / param3.length),_loc10_,[_loc9_,param4]);
            if(param7)
            {
      ...
      {
         var _loc12_:RoomPlaneData = this.addPlane(RoomPlaneData.const_194,param1,param2,param3);
         ...
         if(_loc12_)
         {
            ...
            if(param6)
            {
               ...
               _loc14_ = this.addPlane(RoomPlaneData.const_194,_loc13_,new Vector3d(0,0,-this.var_128),param2);
               if(_loc14_ != null)
               {
                  if(param8 > 0)
                  {
            ...
            if(param7)
            {
               ...
               _loc14_ = this.addPlane(RoomPlaneData.const_194,_loc13_,new Vector3d(0,0,-this.var_128),Vector3d.product(param2,-1));
               if(_loc14_ != null)
               {
                  if(param9 > 0)
                  {
            ...
            if(param4)
            {
               ...
               _loc15_ = this.addPlane(RoomPlaneData.const_194,_loc13_,new Vector3d(0,0,-this.var_128),Vector3d.product(param3,-1));
               if(_loc15_ != null)
               {
                  if(param11 > 0)
                  {
            ...
            if(param5)
            {
               ...
               _loc15_ = this.addPlane(RoomPlaneData.const_194,_loc13_,new Vector3d(0,0,-this.var_128),param3);
               if(_loc15_ != null)
               {
                  if(param10 > 0)
                  {
      ...
      public function getPlaneType(param1:int) : int
      {
         if(param1 < 0 || param1 >= this.planeCount)
         {
            return RoomPlaneData.const_1252;
         }
         var _loc2_:RoomPlaneData = this.var_127[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
