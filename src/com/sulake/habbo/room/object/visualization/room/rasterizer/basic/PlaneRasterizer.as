package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneRasterizer implements IPlaneRasterizer
   {
      ...
      protected static const const_600:String = "RoomPropertyMessageParser";
      ...
      public function dispose() : void
      {
         ...
         if(this.var_573 != null)
         {
            ...
            {
               _loc3_ = this.var_573.getWithIndex(_loc1_);
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      private function resetTextures() : void
      {
         ...
         {
            _loc2_ = this.var_206.getWithIndex(_loc1_) as PlaneTexture;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      {
         return this.var_206.getValue(param1) as PlaneTexture;
      }
      ...
      protected function getGeometry(param1:int, param2:Number, param3:Number) : IRoomGeometry
      {
         ...
         var _loc5_:IRoomGeometry = this.var_573.getValue(_loc4_);
         if(_loc5_ == null)
         {
