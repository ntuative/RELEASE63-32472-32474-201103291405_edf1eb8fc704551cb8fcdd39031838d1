package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1869:int = 16777216;
      ...
      private var var_1774:int = 16777216;
      
      private var var_2889:int = 69069;
      
      private var var_2888:int = 5;
      ...
      {
         var _loc1_:int = this.var_2889 * this.var_1775 + this.var_2888;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_1774;
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_1774 * param2);
      }
   }
}
