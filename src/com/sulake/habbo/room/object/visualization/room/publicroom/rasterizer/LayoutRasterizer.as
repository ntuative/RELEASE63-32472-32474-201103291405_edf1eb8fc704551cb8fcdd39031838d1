package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_1101:Point = null;
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != this.var_895)
         {
            ...
            this._adBgIndex = -1;
            this._adImgIndex = -1;
            this.var_1352 = this.var_44.getValue(this.var_895);
         }
      }
      ...
      public function initialize(param1:XML) : void
      {
         ...
         this.var_2247 = new Vector3d(-0.5,0.5,0);
         this.var_894 = false;
      }
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(this.var_2247);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
         _loc3_.x = Math.round(_loc3_.x);
         _loc3_.y = Math.round(_loc3_.y);
         this.var_1101.x = _loc3_.x;
         this.var_1101.y = _loc3_.y;
      }
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc3_:LayoutRasterizerData = this.var_44.getValue(this.var_895);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              this.var_1650 = RoomObjectVariableEnum.const_1062;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              this.var_1650 = RoomObjectVariableEnum.const_1182;
                           }
                           if(param2 != null)
                           {
      ...
      {
         var _loc1_:LayoutRasterizerData = this.var_44.getValue(this.var_895);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      {
         if(param2 == this.var_2248 && param3 == this.var_2249)
         {
            return;
         }
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         param2.offsetX = int(_loc8_.@x) + _loc9_.offsetX + this.var_1101.x;
         param2.offsetY = int(_loc8_.@y) + _loc9_.offsetY + this.var_1101.y;
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(this.var_416.indexOf(_loc10_) >= 0 && this.var_894)
            {
               param1 = this.var_416.indexOf(_loc10_);
               if(this.var_590[param1] != "")
               {
                  _loc9_ = this.var_809.getAsset(this.var_590[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
               ...
               if(this.var_589[param1] != -1)
               {
                  param2.alpha = this.var_589[param1];
               }
               this.var_416.splice(param1,1);
               this.var_590.splice(param1,1);
               this.var_589.splice(param1,1);
      ...
      {
         this.var_894 = true;
         var _loc3_:int = this.var_416.indexOf(param1);
         if(_loc3_ < 0)
         {
            this.var_416.push(param1);
            this.var_590.push(param2);
            this.var_589.push(-1);
         }
         else
         {
            this.var_590[_loc3_] = param2;
         }
      }
