package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1587:int = 16777215;
      
      public static const const_1708:int = 13421772;
      
      private static const const_994:int = 16777215;
      ...
      public static const const_1513:int = 13421772;
      
      public static const const_1527:int = 10066329;
      ...
      private var var_2667:int = 255;
      
      private var var_1905:Boolean = true;
      
      private var var_1791:int = 0;
      
      private var var_1610:int = -1000;
      
      private const const_2085:int = 250;
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1181);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_162)
            {
               ...
               if(this._data != null)
               {
                  _loc13_.rasterizer = this._data.method_7;
               }
            }
            else if(_loc12_ == RoomPlaneData.const_332)
            {
            ...
            else if(_loc12_ == RoomPlaneData.const_1700)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_118,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_332)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         _loc9_ = param2;
         if(_loc9_ < this.var_1610 + this.const_2085 && !_loc6_ && !_loc8_)
         {
            return;
         }
         ...
         {
            _loc10_ = 0;
            while(_loc10_ < this.var_385.length)
            {
               _loc11_ = this.var_648[_loc10_];
               _loc12_ = getSprite(_loc11_);
               _loc13_ = this.var_385[_loc10_] as RoomPlane;
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_1905)
                  {
                     _loc14_ = uint(_loc13_.color);
                     _loc15_ = uint((_loc14_ & 255) * this.var_2667 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2669 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2668 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_2011)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1551 || _loc3_.y != this.var_2665 || _loc3_.z != this.var_2666 || param1.scale != this.var_2664))
            {
               this.var_1551 = _loc3_.x;
               this.var_2665 = _loc3_.y;
               this.var_2666 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_176 != param1.getUpdateID())
         {
            ...
            if(_loc3_ != this.var_2670)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2670 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_840));
            if(_loc4_ != this.var_1231)
            {
               this.var_1231 = _loc4_;
               this.var_2667 = this.var_1231 & 255;
               this.var_2669 = this.var_1231 >> 8 & 255;
               this.var_2668 = this.var_1231 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1120));
            if(_loc5_ != this.var_1905)
            {
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_176 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_844);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_685);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_671);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_746));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_724));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_640));
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_385;
         if(this.var_385.length == 0)
         {
            _loc6_ = this.var_127;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_385.length > 0;
         var _loc9_:int = 0;
            ...
            if(_loc11_ != null)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc11_.visible)
                  {
                     if(!_loc8_)
                     {
                        this.var_385.push(_loc12_);
                        this.var_648.push(_loc9_);
                     }
                  }
               }
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1791;
      }
                     ...
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_118 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_258)
                              {
