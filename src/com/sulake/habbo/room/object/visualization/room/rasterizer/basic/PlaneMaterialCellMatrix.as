package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_644:int = 6;
      
      public static const const_1461:int = const_379;
      ...
      public static const ALIGN_DEFAULT:int = const_115;
      ...
      private var var_2323:Number = 1.0;
         ...
         if(this.isStatic)
         {
            if(this.var_30 != null)
            {
               if(this.var_30.width == param2 && this.var_30.height == param3 && Vector3d.isEqual(this._cachedBitmapNormal,param4))
               {
                  if(param1 != null)
                  {
                     this.copyCachedBitmapOnCanvas(param1,this.var_614,param6,param7);
                     return param1;
                  }
                  return this.var_30;
               }
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(this._align == const_115)
         {
            _loc5_ = new Rectangle(0,0,this.var_30.width,this.var_614);
         }
         else
         {
            _loc5_ = new Rectangle(0,this.var_30.height - this.var_614,this.var_30.width,this.var_614);
         }
