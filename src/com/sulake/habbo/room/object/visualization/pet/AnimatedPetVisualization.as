package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1388:String = "head";
      
      private static const const_623:int = 1;
      
      private static const const_995:int = 1000;
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != this.var_2684)
            {
               this.var_2684 = _loc3_;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_220);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_147);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.const_220);
            if(!isNaN(_loc6_))
            {
            ...
            this.var_1996 = _loc3_.getNumber(RoomObjectVariableEnum.const_392) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_202);
            if(!isNaN(_loc8_))
            {
            ...
            this.var_1483 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2422 = _loc3_.getNumber(RoomObjectVariableEnum.const_647);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_900);
            if(_loc9_ != this.var_1919)
            {
               this.var_1919 = _loc9_;
               this.var_2683 = this.var_1919.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_387 != null)
         {
            ...
            if(this.var_1483 > 0)
            {
               ...
               if(_loc2_ < const_995)
               {
                  this.var_387.alpha = int(Math.sin(_loc2_ / const_995 * 0) * 255);
      ...
      private function validateActions(param1:String, param2:String) : void
      {
         ...
         if(param1 != this.var_278)
         {
            ...
            this.setAnimationForIndex(const_1389,_loc3_);
         }
         if(param2 != this.var_1532)
         {
            this.var_1532 = param2;
            _loc3_ = this._animationData.getAnimationForGesture(var_102,param2);
            this.setAnimationForIndex(const_1390,_loc3_);
         }
      }
      ...
      {
         return super.getAdditionalSpriteCount() + const_623;
      }
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            _loc2_ = assetCollection.getAssetWithPalette(param1,this.var_2683);
            if(_loc2_ == null)
            {
            }
            return _loc2_;
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_623)
         {
            _loc4_ = getSize(param1);
            if(param2 < _loc3_ - (1 + const_623))
            {
               if(param2 >= FurnitureVisualizationData.const_522.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_522[param2];
               if(_loc4_ == 1)
               {
      ...
      private function isHeadSprite(param1:int) : Boolean
      {
         ...
         {
            if(this._animationData.getTag(var_102,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1388)
            {
               this.var_1010[param1] = true;
            }
            else
            {
               this.var_1010[param1] = false;
            }
         }
         return this.var_1010[param1];
      }
   }
}
