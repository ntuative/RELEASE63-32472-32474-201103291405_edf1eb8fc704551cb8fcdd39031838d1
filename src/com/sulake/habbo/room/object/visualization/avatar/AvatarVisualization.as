package com.sulake.habbo.room.object.visualization.avatar
{
   ...
   public class AvatarVisualization extends RoomObjectSpriteVisualization implements IAvatarImageListener
   {
      ...
      private static const const_1013:String = "avatar";
      
      private static const const_629:Number = -0.01;
      
      private static const const_630:Number = -0.409;
      ...
      private var var_671:AvatarVisualizationData = null;
      ...
      private var var_1033:BitmapDataAsset;
      ...
      {
         this.var_671 = param1 as AvatarVisualizationData;
      ...
      private function updateModel(param1:IRoomObjectModel, param2:Number, param3:Boolean) : Boolean
      {
         ...
         if(param1.getUpdateID() != var_176)
         {
            ...
            if(_loc5_ != this.var_2002)
            {
               this.var_2002 = _loc5_;
               _loc4_ = true;
            }
            ...
            if(_loc5_ != this.var_1534)
            {
               this.var_1534 = _loc5_;
               _loc4_ = true;
            }
            ...
            if(_loc6_ != this.var_1532)
            {
               this.var_1532 = _loc6_;
               _loc4_ = true;
            }
            _loc7_ = param1.getString(RoomObjectVariableEnum.const_220);
            if(_loc7_ != this.var_278)
            {
               this.var_278 = _loc7_;
               _loc4_ = true;
            }
            _loc7_ = param1.getString(RoomObjectVariableEnum.const_709);
            if(_loc7_ != this._postureParameter)
            {
               this._postureParameter = _loc7_;
               _loc4_ = true;
            }
            _loc6_ = param1.getNumber(RoomObjectVariableEnum.const_1058);
            if(_loc6_ != this.var_1533)
            {
               this.var_1533 = _loc6_;
               _loc4_ = true;
            }
            ...
            _loc6_ = param1.getNumber(RoomObjectVariableEnum.const_467);
            ...
            if(_loc6_ != this.var_672)
            {
               this.var_672 = _loc6_;
               _loc4_ = true;
            }
            _loc6_ = param1.getNumber(RoomObjectVariableEnum.const_202);
            if(_loc6_ != this.var_1994)
            {
               this.var_1994 = _loc6_;
               _loc4_ = true;
            }
            if(this.var_825 > 0 && param1.getNumber(RoomObjectVariableEnum.const_351) > 0)
            {
               if(this.var_672 != this.var_825)
               {
                  this.var_672 = this.var_825;
                  _loc4_ = true;
               }
            }
            else if(this.var_672 != 0)
            {
               this.var_672 = 0;
               _loc4_ = true;
            }
            _loc6_ = param1.getNumber(RoomObjectVariableEnum.const_881);
            if(_loc6_ != this.var_1270)
            {
               this.var_1270 = _loc6_;
               _loc4_ = true;
               this.updateNumberBubble(param2);
            }
            this.validateActions(param2);
            _loc7_ = param1.getString(RoomObjectVariableEnum.const_1088);
            if(_loc7_ != this.var_995)
            {
               this.var_995 = _loc7_;
               _loc4_ = true;
            }
      ...
      private function getAvatarImage(param1:Number, param2:int) : IAvatarImage
      {
         ...
         if(_loc3_ == null)
         {
            _loc3_ = this.var_671.getAvatar(this.var_643,param1,this.var_995,this);
            if(_loc3_ != null)
            {
               if(param2 == 0)
               {
               ...
               {
                  if(this.var_545.length >= const_1421)
                  {
                     this.var_545.remove(this.var_545.getKeys().shift());
                  }
      ...
      private function updateObject(param1:IRoomObject, param2:IRoomGeometry, param3:Boolean, param4:Boolean = false) : Boolean
      {
         ...
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         if(param4 || var_469 != param1.getUpdateID() || this.var_2011 != param2.updateId)
         {
            _loc5_ = param3;
            ...
            if(_loc7_ != this.var_1998 || param4)
            {
               ...
               if(this.var_1998 != this.var_1997)
               {
                  _loc7_ -= 112.5;
      ...
      private function updateShadow(param1:Number) : void
      {
         ...
         {
            _loc2_.visible = true;
            if(this.var_673 == null || param1 != var_102)
            {
               _loc3_ = 0;
               _loc4_ = 0;
               if(param1 < 48)
      ...
      private function updateTypingBubble(param1:Number) : void
      {
         ...
         var _loc5_:int = 0;
         this.var_1033 = null;
         var _loc2_:IRoomObjectSprite = getSprite(this.const_1806);
         if(this.var_580)
         {
            _loc2_.visible = true;
            _loc5_ = 64;
            if(param1 < 48)
            {
               this.var_1033 = this.var_671.getAvatarRendererAsset("user_typing_small_png") as BitmapDataAsset;
               _loc3_ = 3;
               _loc4_ = -42;
               _loc5_ = 32;
            }
            ...
            {
               this.var_1033 = this.var_671.getAvatarRendererAsset("user_typing_png") as BitmapDataAsset;
               _loc3_ = 14;
               _loc4_ = -83;
            }
            if(this.var_278 == "sit")
            ...
            {
               _loc2_.asset = this.var_1033.content as BitmapData;
               _loc2_.offsetX = _loc3_;
               _loc2_.offsetY = _loc4_;
      ...
      private function updateNumberBubble(param1:Number) : void
      {
         ...
         var _loc6_:int = 0;
         var _loc2_:* = null;
         var _loc3_:IRoomObjectSprite = getSprite(this.const_1807);
         if(this.var_1270 > 0)
         {
            _loc6_ = 64;
            if(param1 < 48)
            {
               _loc2_ = this.var_671.getAvatarRendererAsset("number_" + this.var_1270 + "_small_png") as BitmapDataAsset;
               _loc4_ = -6;
               _loc5_ = -52;
               _loc6_ = 32;
            }
            ...
            {
               _loc2_ = this.var_671.getAvatarRendererAsset("number_" + this.var_1270 + "_png") as BitmapDataAsset;
               _loc4_ = -8;
               _loc5_ = -105;
            }
            if(this.var_278 == "sit")
      ...
      {
         var _loc5_:int = 0;
         var _loc2_:IRoomObjectSprite = getSprite(this.const_1807);
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc13_ || _loc7_ != var_102 || this.var_61 == null)
         {
            if(_loc7_ != var_102)
            {
               _loc9_ = true;
            ...
            if(_loc11_ != this.var_824)
            {
               _loc12_ = true;
            }
            if(_loc9_ || this.var_61 == null || _loc12_)
            {
               this.var_61 = this.getAvatarImage(_loc7_,this.var_824);
               if(this.var_61 == null)
               {
                  return;
               }
         ...
         var _loc15_:Boolean = (this.var_979 || this.var_1268 > 0) && param3;
         if(_loc14_)
         {
            this.var_1268 = const_1011;
         }
         if(_loc14_ || _loc15_)
         {
            increaseUpdateId();
            --this.var_1268;
            --this.var_1269;
            if(!(this.var_1269 <= 0 || _loc9_ || _loc13_ || _loc8_))
            {
               return;
            }
            ...
            if(_loc17_ != null)
            {
               ...
               if(this.var_1272)
               {
                  ...
                  {
                     _loc17_.relativeDepth = const_630 + _loc18_[2];
                  }
               }
               else
               {
                  _loc17_.relativeDepth = const_629 + _loc18_[2];
               }
            }
            _loc17_ = getSprite(this.const_1806);
            if(_loc17_ != null && _loc17_.visible)
            {
               if(!this.var_1272)
               {
                  _loc17_.relativeDepth = const_629 - 0.01 + _loc18_[2];
               }
               else
               {
                  _loc17_.relativeDepth = const_630 - 0.01 + _loc18_[2];
               }
            }
            ...
            for each(_loc20_ in this.var_61.getSprites())
            {
               ...
               else
               {
                  ...
                  if(_loc17_ != null)
                  {
                     ...
                     if(this.var_1272)
                     {
                        _loc17_.relativeDepth = const_630 - 0.001 * spriteCount * _loc29_;
                     }
                     else
                     {
                        _loc17_.relativeDepth = const_629 - 0.001 * spriteCount * _loc29_;
                     }
                     if(_loc20_.ink == 33)
                     {
      ...
      private function updateActions(param1:IAvatarImage) : void
      {
         ...
         if(this.var_1532 > 0)
         {
            param1.appendAction(AvatarAction.const_311,AvatarAction.const_1532[this.var_1532]);
         }
         if(this.var_1533 > 0)
         {
            param1.appendAction(AvatarAction.const_858,this.var_1533);
         }
         if(this.var_2613 > 0)
         {
            param1.appendAction(AvatarAction.const_799,this.var_2613);
         }
         if(this.var_825 > 0)
         {
            param1.appendAction(AvatarAction.const_699,this.var_825);
         }
         if(this.var_672 > 0)
         {
            param1.appendAction(AvatarAction.const_936,this.var_672);
         }
         if(this.var_2002)
         {
         ...
         if(this.var_2000)
         {
            param1.appendAction(AvatarAction.const_241);
         }
         if(this.var_824 > 0)
         {
            param1.appendAction(AvatarAction.const_322,this.var_824);
         }
         param1.endActionAppends();
         this.var_979 = param1.isAnimating();
         var _loc2_:int = this.const_1419;
         for each(_loc3_ in this.var_61.getSprites())
         {
            if(_loc3_.id != const_1013)
            {
               _loc2_++;
            }
         }
