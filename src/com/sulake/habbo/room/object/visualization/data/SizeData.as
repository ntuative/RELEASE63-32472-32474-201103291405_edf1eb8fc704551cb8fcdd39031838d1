package com.sulake.habbo.room.object.visualization.data
{
   ...
   public class SizeData
   {
      ...
      public static const const_411:int = 1000;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_255 != null)
         {
            ...
            {
               _loc2_ = this.var_255.getWithIndex(_loc1_) as DirectionData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function defineDirections(param1:XML) : Boolean
      {
         ...
         while(_loc5_ < _loc4_.length())
         {
            ...
            _loc8_ = _loc6_.layer;
            if(this.var_255.getValue(String(_loc7_)) != null)
            {
               return false;
            }
            ...
            this.var_255.add(String(_loc7_),_loc3_);
            this.var_1724 = -1;
            this.var_1126 = null;
            _loc5_++;
         }
      ...
      private function defineDirection(param1:DirectionData, param2:XMLList) : Boolean
      {
         ...
         while(_loc4_ < param2.length())
         {
            ...
            {
               case "ADD":
                  param1.setInk(_loc6_,LayerData.const_1039);
                  break;
               case "SUBTRACT":
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + this.var_1382 / 2) % 360 / this.var_1382;
         if(this.var_255.getValue(String(_loc2_)) != null)
         {
            return _loc2_;
         }
         ...
         {
            _loc6_ = int(this.var_255.getKey(_loc5_)) * this.var_1382;
         ...
         if(_loc4_ >= 0)
         {
            return int(this.var_255.getKey(_loc4_));
         }
         return const_1641;
      }
      ...
      private function getDirectionData(param1:int) : DirectionData
      {
         ...
         var _loc2_:* = null;
         _loc2_ = this.var_255.getValue(String(param1)) as DirectionData;
         if(_loc2_ == null)
         {
            _loc2_ = this.var_731;
         }
