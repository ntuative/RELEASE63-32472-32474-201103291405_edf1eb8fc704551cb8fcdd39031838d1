package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      {
         if(this.var_2494 == param1 && this.var_2495 == direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(param1,direction,_loc2_) == const_1351)
            {
               this.var_1795 = _loc2_;
               this.var_2494 = param1;
               this.var_2495 = direction;
               return this.var_1795;
            }
            _loc2_--;
         }
      ...
      private function updateTopBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc8_ < _loc3_ - 1)
         {
            if(_loc4_[_loc8_] == false)
            {
               ...
               this.var_623[param2] = ShoreMaskCreatorUtility.getBorderType(_loc6_,_loc7_);
            }
            param2++;
            _loc8_++;
         }
      ...
      private function updateRightBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc10_ < _loc4_ - 1)
         {
            ...
            if(_loc7_[_loc3_ - 1] == false)
            {
               ...
               this.var_623[param2] = ShoreMaskCreatorUtility.getBorderType(_loc5_,_loc6_);
            }
            param2++;
            _loc10_++;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_519 == 0 || this.var_624 == 0)
         {
            ...
            this.var_519 = _loc2_.getNumber(RoomObjectVariableEnum.const_320);
            this.var_624 = _loc2_.getNumber(RoomObjectVariableEnum.const_383);
         }
         this.var_436 = [];
         this.var_623 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_519 * 2 + this.var_624 * 2)
         {
            this.var_436.push(false);
            this.var_623.push(ShoreMaskCreatorUtility.const_75);
            _loc1_++;
         }
      }
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_70,getSize(param3),this.var_436,this.var_623,assetCollection);
      }
