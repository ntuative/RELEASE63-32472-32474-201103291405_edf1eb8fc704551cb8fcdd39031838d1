package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1636:String = "cone";
      
      public static const const_1595:String = "plane";
      
      public static const const_1483:String = "sphere";
      ...
      private var var_887:Number = 0.1;
      ...
      public function reset() : void
      {
         ...
         this.var_886 = 0;
         this.var_893 = false;
         this.init(0,0,0,this._direction,this.var_2214,this.var_887,this.var_2218,true);
      }
      ...
      private function releaseParticles(param1:FurnitureParticleSystemParticle, param2:Vector3D = null) : void
      {
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.var_2215)
         {
            switch(this.var_2213)
            {
               case const_1636:
            ...
            _loc4_.init(param1.x,param1.y,param1.z,_loc3_,this._energy,this.var_887,_loc6_,_loc7_,_loc9_,_loc8_);
            this.var_341.push(_loc4_);
            ++this.var_886;
            _loc10_++;
         }
      }
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_886 < this.var_1343)
         {
            if(this.age % this.var_2217 == 0)
            {
               this.releaseParticles(this,this.direction);
            }
         }
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_886 < this.var_1343)
         {
            ...
            this.y = (2 - this.var_249) * this.y - (1 - this.var_249) * this.lastY + this.var_1638 * this.var_887 * this.var_887;
         ...
         for each(_loc2_ in this.var_341)
         {
            ...
            _loc2_.y = (2 - this.var_249) * _loc2_.y - (1 - this.var_249) * _loc2_.lastY + this.var_1638 * this.var_887 * this.var_887;
         ...
         for each(_loc2_ in _loc1_)
         {
            ...
            this.var_341.splice(this.var_341.indexOf(_loc2_),1);
            _loc2_.dispose();
         }
      }
