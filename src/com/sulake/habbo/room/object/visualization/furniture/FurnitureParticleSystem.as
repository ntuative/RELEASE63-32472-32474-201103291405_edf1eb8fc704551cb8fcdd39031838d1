package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystem
   {
      ...
      private var var_251:IRoomObjectSprite;
      ...
      private var var_718:ColorTransform;
      
      private var var_1348:ColorTransform;
      
      private var var_1644:Matrix;
      ...
      public function FurnitureParticleSystem(param1:AnimatedFurnitureVisualization)
      {
         ...
         this.var_718 = new ColorTransform();
         this.var_718.alphaMultiplier = 1;
         this.var_1348 = new ColorTransform();
         this.var_1644 = new Matrix();
      ...
      public function setAnimation(param1:int) : void
      {
         ...
         this.var_96 = this.var_1094[param1];
         this.var_893 = false;
         this.updateCanvas();
      }
      ...
      private function updateCanvas() : void
      {
         ...
         if(this.var_1645 >= 0)
         {
            this.var_251 = this._visualization.getSprite(this.var_1645);
            if(this.var_251 && this.var_251.asset)
            {
               if(this.var_251.width <= 1 || this.var_251.height <= 1)
               {
                  return;
               }
               if(this.var_84 == null)
               {
                  this.var_84 = this.var_251.asset.clone();
                  if(this.var_718.alphaMultiplier != 1)
                  {
                     this.var_587 = new BitmapData(this.var_84.width,this.var_84.height,true,4278190080);
                  }
               }
               this.var_2229 = -this.var_251.offsetX;
               this.var_2228 = -this.var_251.offsetY;
               this.var_251.asset = this.var_84;
            }
            if(this.var_84)
            {
      ...
      public function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         {
            return this.var_96.y * this.var_1093;
         }
         return 0;
      }
      ...
      {
         if(!this.var_96 || !this.var_251)
         {
            return;
         }
         if(this.var_84 && this.var_251.asset != this.var_84)
         {
            this.var_251.asset = this.var_84;
         }
         if(this.var_893)
      ...
      public function updateAnimation() : void
      {
         ...
         var _loc2_:* = 0;
         var _loc8_:int = 0;
         if(!this.var_893 && this.var_96.hasIgnited)
         {
            this.var_893 = true;
         }
         _loc8_ = this.var_1206 * this.var_1093;
         this.var_96.update();
         if(this.var_893)
         {
            if(this.var_96.roomObjectSpriteId >= 0)
            ...
            {
               this.var_84.draw(this.var_587,this.var_1644,this.var_718,BlendMode.NORMAL,null,false);
            }
            for each(_loc11_ in this.var_96.particles)
            {
               _loc2_ = Number(_loc11_.y);
               _loc3_ = this.var_2229 + (_loc11_.x - _loc11_.z) * 10 / 10 * this.var_1093;
               _loc4_ = this.var_2228 - _loc8_ + (_loc2_ + (_loc11_.x + _loc11_.z) / 2) * 10 / 10 * this.var_1093;
               ...
               if(_loc6_)
               {
                  ...
                  if(_loc11_.fade && _loc11_.alphaMultiplier < 1)
                  {
                     ...
                     this.var_1348.alphaMultiplier = _loc11_.alphaMultiplier;
                     this.var_84.draw(_loc7_,this._translationMatrix,this.var_1348,BlendMode.NORMAL,null,false);
                  }
                  else
                  {
