package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualizationPlanetObject
   {
      ...
      private static const const_1418:Number = 30;
      ...
      public function FurniturePlanetSystemVisualizationPlanetObject(param1:String, param2:int, param3:Number, param4:Number, param5:Number, param6:Number)
      {
         ...
         this.var_2759 = param4 * 0 * 2 / 360;
         this.var_1982 = param5 * 0 * 2 / 360;
         this._height = param6;
         this.var_690 = 0;
      }
      ...
      {
         var _loc4_:* = null;
         this.var_690 += this.var_2759 / const_1418;
      ...
      {
         var _loc3_:Number = this.var_1350 * Math.cos(this.var_690 + this.var_1982);
         var _loc4_:Number = this.var_1350 * Math.sin(this.var_690 + this.var_1982);
