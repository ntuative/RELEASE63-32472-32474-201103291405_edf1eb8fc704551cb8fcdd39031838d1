package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_610:String = "temporary_room";
      ...
      private static const const_1331:String = "tile_cursor";
      
      private static const const_963:int = -3;
      
      private static const const_1332:String = "selection_arrow";
      
      private static const OVERLAY_SPRITE:String = "overlay";
      
      private static const const_340:String = "object_icon_sprite";
      
      private static const const_423:int = 15;
      
      private static const const_964:int = 40;
      ...
      private var var_923:IRoomRendererFactory = null;
      
      private var var_738:IRoomObjectFactory = null;
      
      private var var_516:IRoomObjectVisualizationFactory = null;
      
      private var var_299:IAdManager = null;
      
      private var var_295:ISessionDataManager = null;
      ...
      private var var_737:NumberBank;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_737 = new NumberBank(1000);
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_738.release(new IIDRoomObjectFactory());
            this.var_738 = null;
         }
         if(this.var_516 != null)
         {
            this.var_516.release(new IIDRoomObjectVisualizationFactory());
            this.var_516 = null;
         }
         if(this.var_48 != null)
         {
            this.var_48.release(new IIDRoomManager());
            this.var_48 = null;
         }
         if(this.var_923 != null)
         {
            this.var_923.release(new IIDRoomRendererFactory());
            this.var_923 = null;
         }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_48 != null)
         {
            ...
            this.var_48.update(param1);
            _loc2_ = this.var_48.getRoom(this.getRoomIdentifier(this.var_98,this.var_97));
      ...
      private function createRoomFurniture() : void
      {
         ...
         do
         {
            for each(_loc4_ in _loc8_)
            {
               ...
               while(!this.var_924 && (_loc6_ = _loc4_.getWallItemData()) != null)
               {
         ...
         if(_loc8_ != null && _loc9_ != null && _loc10_ != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc9_.screenWd != _loc14_ || _loc9_.screenHt != _loc15_ || _loc9_.scale != _loc8_.scale || _loc9_.geometryUpdateId != _loc8_.updateId || !Vector3d.isEqual(param4,_loc9_.targetObjectLoc))
               {
                  ...
                  _loc17_ = _loc10_.getNumber(RoomVariableEnum.const_864) - 0.5;
                  _loc18_ = _loc10_.getNumber(RoomVariableEnum.const_926) - 0.5;
                  _loc19_ = _loc10_.getNumber(RoomVariableEnum.const_890) + 0.5;
                  _loc20_ = _loc10_.getNumber(RoomVariableEnum.const_823) + 0.5;
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_516 = param2 as IRoomObjectVisualizationFactory;
         if(this.var_13 != null)
         {
            this.var_13.visualizationFactory = this.var_516;
         }
         this.initializeRoomManager();
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_48 = param2 as IRoomManager;
         if(this.var_48 != null)
         {
            this.var_48.addObjectUpdateCategory(RoomObjectCategoryEnum.const_28);
            this.var_48.addObjectUpdateCategory(RoomObjectCategoryEnum.const_26);
            this.var_48.addObjectUpdateCategory(RoomObjectCategoryEnum.const_34);
            this.var_48.addObjectUpdateCategory(RoomObjectCategoryEnum.const_294);
            this.var_48.addObjectUpdateCategory(RoomObjectCategoryEnum.const_78);
            this.var_48.setContentLoader(this.var_13);
         }
         this.initializeRoomManager();
      }
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_923 = param2 as IRoomRendererFactory;
         this.initializeRoomManager();
      }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_13 != null)
         {
            events.addEventListener(RoomContentLoader.const_677,this.onContentLoaderReady);
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_677)
         {
            this.var_2363 = true;
            this.initializeRoomManager();
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_299.events.addEventListener(AdEvent.const_572,this.showRoomAd);
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_13.sessionDataManager = this.var_295;
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(this.var_738 != null)
         {
            this.var_738.addObjectEventListener(this.roomObjectEventHandler);
         }
      }
      
      private function initializeRoomManager() : void
      {
         if(this.var_738 == null || this.var_516 == null || this.var_48 == null || this.var_923 == null || this._communication == null || this.var_164 == null || !this.var_2363)
         {
            return;
         }
         this.var_48.initialize(<nothing/>,this);
      }
      ...
      public function setIsPlayingGame(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         {
            _loc5_ = !!param3 ? 1 : 0;
            _loc4_.setNumber(RoomVariableEnum.const_1193,_loc5_);
            if(_loc5_ == 0)
            {
            ...
            {
               events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_444,param1,param2));
            }
         }
      }
      ...
      public function getIsPlayingGame(param1:int, param2:int) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            _loc4_ = _loc3_.getNumber(RoomVariableEnum.const_1193);
            if(_loc4_ > 0)
            {
               return true;
            }
      ...
      public function getRoom(param1:int, param2:int) : IRoomInstance
      {
         ...
         var _loc3_:String = this.getRoomIdentifier(param1,param2);
         return this.var_48.getRoom(_loc3_);
      }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_795,param1,param2));
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         var _loc7_:IRoomInstance = this.var_48.createRoom(param1,param2);
         if(_loc7_ == null)
         {
            return null;
         }
         ...
         if(this.isPublicRoomWorldType(param6))
         {
            ...
            _loc9_ = _loc7_.createRoomObject(const_339,_loc11_,_loc8_) as IRoomObjectController;
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_1202,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_878,1,true);
            _loc12_ = parseInt(this.var_164.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_1262,_loc12_,true);
            if(this.var_13 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_339,const_611,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_878,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_859,_loc10_,true);
         if(param2 != null)
         {
            _loc13_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_864,_loc15_);
               _loc7_.setNumber(RoomVariableEnum.const_890,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_926,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_823,_loc18_);
               _loc13_ += _loc15_ * 423 + _loc16_ * 671 + _loc17_ * 913 + _loc18_ * 7509;
               if(_loc9_ != null && _loc9_.getModelController() != null)
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1181,_loc13_,true);
               }
            }
         }
         if(_loc9_ != null && _loc9_.getEventHandler() != null)
         {
            ...
            if(param3 != null)
            {
               _loc19_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_834,param3);
               ...
               if(param2.doors.door.length() > 0)
               {
                  ...
                  while(_loc23_ < _loc20_.length())
                  {
                     ...
                     if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                     {
                        ...
                        _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_523,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_258);
                        ...
                        if(_loc28_ == 90 || _loc28_ == 180)
                        {
                           ...
                           _loc7_.setNumber(RoomObjectVariableEnum.const_1146,_loc27_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_1149,_loc28_,true);
                        }
                     }
                     _loc23_++;
                  }
         ...
         _loc7_.createRoomObject(const_965,const_1331,RoomObjectCategoryEnum.const_294);
         if(this.var_164.getKey("avatar.widget.enabled","0") == "0")
         {
            _loc7_.createRoomObject(const_963,const_1332,RoomObjectCategoryEnum.const_294);
         }
         return _loc7_;
      }
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_339,RoomObjectCategoryEnum.const_78);
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(_loc6_ == null)
         {
            ...
            _loc9_ = this.var_358.getValue(_loc8_);
            if(_loc9_ == null)
            {
               _loc9_ = new RoomData(param1,param2,null);
               this.var_358.add(_loc8_,_loc9_);
            }
            if(param3 != null)
            {
         ...
         if(param3 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_834,param3);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param4 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_846,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param5 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_837,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         return true;
      }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1476,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      public function updateObjectRoomVisibilities(param1:int, param2:int, param3:Boolean, param4:Boolean = true) : Boolean
      {
         ...
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1250,param4);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         return true;
      }
      ...
      {
         var _loc3_:String = this.getRoomIdentifier(param1,param2);
         this.var_48.disposeRoom(_loc3_);
         var _loc4_:RoomInstanceData = this.var_296.remove(_loc3_);
         if(_loc4_ != null)
         {
            _loc4_.dispose();
         }
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_865,param1,param2));
      }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         var _loc8_:IRoomInstance = this.var_48.getRoom(_loc7_);
         if(_loc8_ == null)
         {
            return null;
         }
         ...
         if(_loc9_ == null)
         {
            _loc9_ = this.var_923.createRenderer();
         }
         if(_loc9_ == null)
         {
            return null;
         }
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_1191;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_859);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_758);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_924);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1146);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1149);
      ...
      {
         var _loc4_:String = this.getRoomIdentifier(param1,param2);
         var _loc5_:IRoomInstance = this.var_48.getRoom(_loc4_);
         if(_loc5_ == null)
         {
            return null;
         }
      ...
      private function handleRoomDragging(param1:IRoomRenderingCanvas, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         var _loc10_:* = null;
         var _loc11_:* = null;
         var _loc8_:int = param2 - this.var_1389;
         var _loc9_:int = param3 - this.var_1391;
         if(param4 == MouseEvent.MOUSE_DOWN)
         {
            if(!param5 && !param6 && !param7)
            {
               this.var_1132 = true;
               this.var_922 = false;
               this.var_2362 = this.var_1389;
               this.var_2364 = this.var_1391;
            }
         }
         else if(param4 == MouseEvent.MOUSE_UP)
         {
            ...
            {
               this.var_1132 = false;
               _loc10_ = this.getRoomInstanceData(this.var_98,this.var_97);
               if(_loc10_ != null)
               {
         ...
         else if(param4 == MouseEvent.MOUSE_MOVE)
         {
            if(this.var_1132)
            {
               if(!this.var_922)
               {
                  _loc8_ = param2 - this.var_2362;
                  _loc9_ = param3 - this.var_2364;
                  if(_loc8_ <= -const_423 || _loc8_ >= const_423 || _loc9_ <= -const_423 || _loc9_ >= const_423)
                  {
                     this.var_922 = true;
                  }
                  _loc8_ = 0;
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         if(_loc9_ != null)
         {
            ...
            _loc11_ = this.getOverlayIconSprite(_loc10_,const_340);
            if(_loc11_ != null)
            {
            ...
            if(!this.handleRoomDragging(_loc9_,param2,param3,param4,param5,param6,param7))
            {
               if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
               {
                  ...
                  if(param4 == MouseEvent.CLICK)
                  {
                     if(events != null)
                     {
                        events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_481,this.var_98,this.var_97,-1,RoomObjectCategoryEnum.const_160));
                     }
                     _loc13_ = "null";
                  }
                  else if(param4 == MouseEvent.MOUSE_MOVE)
                  ...
                  if(this.var_75 != null)
                  {
                     _loc14_ = new RoomObjectMouseEvent(_loc13_,null,const_339,const_611);
                     this.var_75.handleRoomObjectEvent(_loc14_,this.var_98,this.var_97);
                  }
               }
            }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         var _loc6_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_98,this.var_97,this.var_1390);
         if(_loc6_ != null)
         {
            _loc9_ = this.getOverlaySprite(_loc6_);
            this.removeOverlayIconSprite(_loc9_,const_340);
            _loc10_ = this.addOverlayIconSprite(_loc9_,const_340,_loc5_.data);
            if(_loc10_ != null)
            {
               _loc10_.x = this.var_1389 - _loc5_.data.width / 2;
               _loc10_.y = this.var_1391 - _loc5_.data.height / 2;
            }
         }
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_98,this.var_97,this.var_1390);
         if(_loc2_ != null)
         {
            _loc3_ = this.getOverlaySprite(_loc2_);
            _loc4_ = this.getOverlayIconSprite(_loc3_,const_340);
            if(_loc4_ != null)
            {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_98,this.var_97,this.var_1390);
         if(_loc1_ != null)
         {
            _loc2_ = this.getOverlaySprite(_loc1_);
            this.removeOverlayIconSprite(_loc2_,const_340);
         }
      }
      ...
      public function getRoomObjectWithIndex(param1:int, param2:int, param3:int, param4:int) : IRoomObject
      {
         ...
         var _loc5_:String = this.getRoomIdentifier(param1,param2);
         var _loc6_:IRoomInstance = this.var_48.getRoom(_loc5_);
         if(_loc6_ == null)
         {
            return null;
         }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_75 != null)
         {
            return this.var_75.modifyRoomObject(this.var_98,this.var_97,param1,param2,param3);
         }
         return false;
      }
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_75 != null)
         {
            ...
            {
               return this.var_75.modifyWallItemData(this.var_98,this.var_97,param1,param3);
            }
         }
         return false;
      }
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(this.var_75 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_26)
            {
               return this.var_75.deleteWallItem(this.var_98,this.var_97,param1);
            }
         }
         return false;
      }
      ...
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         ...
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_878) != 0)
         {
            return false;
         }
         if(this.var_75 != null)
         {
            return this.var_75.initializeRoomObjectInsert(this.var_98,this.var_97,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(this.var_75 != null)
         {
            this.var_75.cancelRoomObjectInsert(this.var_98,this.var_97);
         }
      }
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_963,RoomObjectCategoryEnum.const_294);
      }
      
      public function getTileCursor(param1:int, param2:int) : IRoomObjectController
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_965,RoomObjectCategoryEnum.const_294);
      }
      ...
      private function addObjectFurnitureFromData(param1:int, param2:int, param3:int, param4:FurnitureData) : Boolean
      {
         ...
         {
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_253,_loc7_,true);
            ...
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_917,1,true);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1066,param4.expiryTime);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1132,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_382,param1,param2,param3,RoomObjectCategoryEnum.const_28));
         }
      ...
      private function addObjectWallItemFromData(param1:int, param2:int, param3:int, param4:FurnitureData) : Boolean
      {
         ...
         {
            _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_253,_loc6_,false);
            ...
            _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_1191,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_382,param1,param2,param3,RoomObjectCategoryEnum.const_26));
         }
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            if(_loc7_.getModel() != null)
            {
               ...
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_1059);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_523,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_382,param1,param2,param3,RoomObjectCategoryEnum.const_34));
         }
         return true;
      }
      ...
      public function updateObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:IVector3d = null, param7:Number = NaN) : Boolean
      {
         ...
         if(isNaN(param7))
         {
            param7 = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_202);
         }
      ...
      {
         var _loc5_:IRoomInstance = this.var_48.getRoom(param1);
         if(_loc5_ == null)
         {
            return null;
         }
      ...
      {
         var _loc4_:IRoomInstance = this.var_48.getRoom(param1);
         if(_loc4_ == null)
         {
            return null;
         }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_719,this.var_98,this.var_97,param2,param3));
            }
         }
      }
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(this.var_75 != null)
         {
            this.var_75.handleRoomObjectEvent(param1,this.var_98,this.var_97);
         }
      }
      ...
      public function getRoomObjectImage(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:int, param7:IGetImageListener, param8:uint = 0) : ImageResult
      {
         ...
         var _loc13_:IRoomInstance = this.var_48.getRoom(_loc12_);
         if(_loc13_ != null)
         {
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_26:
                     _loc10_ = String(_loc14_.getModel().getNumber(RoomObjectVariableEnum.const_253));
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_292);
                     break;
      ...
      private function initializeRoomForGettingImage(param1:IRoomObjectController, param2:String) : void
      {
         ...
         if(param2 != null)
         {
            ...
            if(_loc3_.length >= 3)
            {
               ...
               _loc8_.addPlane(RoomPlaneData.const_194,new Vector3d(0,0,0),new Vector3d(10,0,0),new Vector3d(0,10,0));
               ...
               _loc8_.addPlane(RoomPlaneData.const_332,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
               _loc9_ = _loc8_.getXML();
               param1.getEventHandler().initialize(_loc9_);
               param1.getModelController().setString(RoomObjectVariableEnum.const_685,_loc4_);
               param1.getModelController().setString(RoomObjectVariableEnum.const_844,_loc5_);
               param1.getModelController().setString(RoomObjectVariableEnum.const_671,_loc6_);
               if(_loc7_ != null)
               {
                  _loc10_ = null;
                  _loc11_ = "undefined_1";
                  _loc10_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_523,_loc11_,_loc7_,new Vector3d(2,0,1.75));
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:uint = 0, param7:String = null, param8:int = -1, param9:int = -1) : ImageResult
      {
         ...
         var _loc11_:IRoomInstance = this.var_48.getRoom(const_610);
         if(_loc11_ == null)
         {
            _loc11_ = this.var_48.createRoom(const_610,null);
            if(_loc11_ == null)
            {
               return _loc10_;
            }
         }
         var _loc12_:int = this.var_737.reserveNumber();
         ...
         switch(_loc13_)
         {
            case RoomObjectCategoryEnum.const_28:
            case RoomObjectCategoryEnum.const_26:
               _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_253,int(param2));
               _loc14_.getModelController().setString(RoomObjectVariableEnum.const_292,param7);
               break;
            case RoomObjectCategoryEnum.const_34:
         ...
         {
            this.var_1133.add(String(_loc12_),param5);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1224,param4,true);
         }
         else
         {
            _loc11_.disposeObject(_loc12_,_loc13_);
            this.var_737.freeNumber(_loc12_ - 1);
            _loc10_.id = 0;
         }
         _loc16_.dispose();
         return _loc10_;
      ...
      {
         return this.getRoomObjectBoundingRectangle(this.var_98,this.var_97,const_339,RoomObjectCategoryEnum.const_78,param1);
      }
      
      public function isRoomObjectContentAvailable(param1:String) : Boolean
      {
         return this.var_48.isContentAvailable(param1);
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = this.var_48.getRoom(const_610);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1224);
               ...
               this.var_737.freeNumber(_loc10_ - 1);
               _loc13_ = this.var_1133.remove(String(_loc10_)) as IGetImageListener;
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(this.var_13 != null)
         {
            ...
            this.var_13.addGraphicAsset(this.var_13.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1062,param1.adWarningL,true);
            this.var_13.addGraphicAsset(this.var_13.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1182,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1072,RoomObjectVariableEnum.const_403,param1.clickUrl);
