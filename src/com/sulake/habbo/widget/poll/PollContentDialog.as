package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++this.var_1162;
         if(this.var_1162 < this.var_934.length)
         {
            _loc1_ = this.var_934[this.var_1162] as Dictionary;
            if(!_loc1_)
            {
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!this.var_433)
         {
            ...
            this.var_433 = this._widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            this.var_433.center();
            this.var_433.procedure = this.cancelConfirmEventProc;
         }
      }
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = this.var_934[this.var_1162] as Dictionary;
