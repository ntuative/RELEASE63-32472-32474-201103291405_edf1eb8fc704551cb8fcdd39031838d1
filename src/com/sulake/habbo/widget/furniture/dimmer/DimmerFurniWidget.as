package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1297:Array = new Array(7665141,21495,15161822,15353138,15923281,8581961,0);
      
      private static const const_1296:Array = new Array(int(76.5),int(76.5));
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetDimmerUpdateEvent.const_914,this.onPresets);
         param1.addEventListener(RoomWidgetDimmerUpdateEvent.const_684,this.onHide);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetDimmerUpdateEvent.const_914,this.onPresets);
         param1.removeEventListener(RoomWidgetDimmerUpdateEvent.const_684,this.onHide);
      ...
      private function onDimmerState(param1:RoomWidgetDimmerStateUpdateEvent) : void
      {
         ...
         this.var_2361 = param1.presetId;
         this.var_1098 = param1.effectId;
         this._color = param1.color;
         this.var_1096 = param1.brightness;
         if(this._view != null)
         {
            this._view.update();
         }
         if(!this.validateBrightness(this.var_1096,this.var_1098))
         {
            return;
         }
         _loc2_ = new RoomWidgetDimmerPreviewMessage(this._color,this.var_1096,this.var_1098 == 2);
      ...
      public function removePreview() : void
      {
         ...
         _loc1_ = new RoomWidgetDimmerPreviewMessage(this._color,this.var_1096,this.var_1098 == 2);
         messageListener.processWidgetMessage(_loc1_);
      }
