package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_67,HabboWindowStyle.const_32,0 | 0,new Rectangle(const_1301,WINDOW_INITIAL_Y,2,2),null,0) as IWindowContainer;
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1544 = _loc2_.light;
         if(this.var_458 != null)
         {
            this.var_458.setValue(this.var_1544);
         }
         this.var_488 = this.colors.indexOf(_loc2_.color);
         if(this.var_675 != null)
         {
            this.var_675.setSelectedColorIndex(this.var_488);
         }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1543 = XML(_loc1_.content);
         return this.var_1543;
      }
