package com.sulake.habbo.widget.furniture.petpackage
{
   ...
   public class PetPackageFurniWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPetPackageUpdateEvent.const_471,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPetPackageUpdateEvent.const_471,this.onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPetPackageUpdateEvent) : void
      {
         ...
         switch(event.type)
         {
            case RoomWidgetPetPackageUpdateEvent.const_582:
               this.hideInterface();
               this.var_346 = event.objectId;
               this.var_661 = event.image;
               this.showInterface();
               this.showPetImage();
               break;
            case RoomWidgetPetPackageUpdateEvent.const_471:
               if(!this.var_1253)
               {
                  return;
               }
            ...
            case RoomWidgetPetPackageUpdateEvent.const_393:
               if(event.objectId != this.var_346)
               {
                  return;
               }
               this.var_661 = event.image;
      ...
      {
         var _loc2_:* = null;
         if(this.var_661 == null || this._window == null)
         {
            return;
         }
         ...
         if(_loc1_ != null)
         {
            ...
            _loc2_ = new Point((_loc1_.width - this.var_661.width) / 2,(_loc1_.height - this.var_661.height) / 2);
            _loc1_.bitmap.copyPixels(this.var_661,this.var_661.rect,_loc2_);
         }
      }
      ...
      private function sendOpenPetPackage() : void
      {
         ...
         if(this.var_1253 || this.var_346 == -1)
         {
            return;
         }
         ...
         {
            this.var_1253 = true;
            message = new RoomWidgetOpenPetPackageMessage(RoomWidgetOpenPetPackageMessage.const_848,this.var_346,name);
