package com.sulake.habbo.widget.furniture.clothingchange
{
   ...
   public class ClothingChangeFurnitureWidget extends RoomWidgetBase
   {
      ...
      private static const const_1000:String = "Boy";
      
      private static const const_999:String = "Girl";
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetClothingChangeUpdateEvent.const_1170,this.onUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetClothingChangeUpdateEvent.const_1170,this.onUpdate);
      ...
      private function showGenderSelectionInterface(param1:RoomWidgetClothingChangeUpdateEvent) : void
      {
         ...
         this._window = windowManager.createWindow("clothing change gender selection","",HabboWindowType.const_67,HabboWindowStyle.const_43,0 | 0 | 0 | 0,new Rectangle(100,100,200,200),null,0) as IWindowContainer;
         ...
         _loc4_ = this._window.findChildByName(const_1000);
         if(_loc4_ != null)
         {
      ...
      private function hideEditorInterface() : void
      {
         ...
         {
            _loc1_ = this.var_801 as IFrameWindow;
            if(_loc1_ != null)
            {
      ...
      private function requestEditor(param1:String) : void
      {
         ...
         _loc5_.setParamFlag(HabboWindowParam.const_163,true);
         this.var_801 = _loc4_;
         this.var_801.offset(100,100);
         var _loc6_:IWindow = this.var_801.findChildByTag("close");
         if(_loc6_ != null)
         {
            _loc6_.procedure = this.onEditorWindowClose;
         }
         var _loc7_:* = null;
         _loc7_ = new RoomWidgetClothingChangeMessage(RoomWidgetClothingChangeMessage.const_365,param1,this.var_346,this.var_2226,this._roomId,this._roomCategory,_loc5_);
