package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private const const_2084:int = 1000;
      ...
      {
         super();
         this.var_209 = new Timer(this.const_2084);
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_189.isActive)
         {
            ...
            this.var_999.width = _loc2_ * this.var_312;
         }
         else
         {
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_795 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_795 == null)
            {
               return;
            }
         ...
         if(!this.var_189.isActive)
         {
            this.var_795.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         this.var_795.caption = "${widgets.memenu.effects.active.timeleft}";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            this.var_998 = this._window.findChildByName("effect_hilite");
            this.var_998.visible = false;
         }
         this.setTimeLeft();
         this.var_999 = this._window.findChildByName("loader_bar");
         if(this.var_999 != null)
         {
            this.var_312 = this.var_999.width;
            this.var_209.start();
            this.onUpdate();
         }
