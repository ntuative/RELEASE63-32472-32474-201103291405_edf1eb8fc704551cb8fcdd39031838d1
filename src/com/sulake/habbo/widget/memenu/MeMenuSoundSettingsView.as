package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      private var var_865:MeMenuSoundSettingsSlider;
      ...
      {
         this.var_510 = param1.volume;
         if(this.var_865 != null)
         {
            this.var_865.setValue(this.var_510);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            this.var_1607 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_off_white") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1604 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_on_color") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1605 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_on_white") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1606 = (_loc5_.content as BitmapData).clone();
         }
         this.var_865 = new MeMenuSoundSettingsSlider(this,this._window.findChildByName("volume_container") as IWindowContainer,this._widget.assets,0,1);
         this.setSoundsOffIcon();
         this.setSoundsOnIcon();
         ...
         this._widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_887));
      }
      ...
      private function setSoundsOffIcon(param1:BitmapData = null) : void
      {
         ...
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1607);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1604);
         }
      }
      ...
      private function setSoundsOnIcon(param1:BitmapData = null) : void
      {
         ...
         else if(this.var_510 == 1)
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1605);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1606);
         }
      }
