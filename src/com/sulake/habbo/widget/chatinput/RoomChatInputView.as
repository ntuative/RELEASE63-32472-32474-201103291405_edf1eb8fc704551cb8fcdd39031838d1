package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1280:int = 11;
      
      private static const const_603:int = 18;
      
      private static const const_944:int = 16;
      
      private static const const_1281:int = 20;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         this.var_2197 = this._localization.getKey("widgets.chatinput.mode.speak",":speak");
      ...
      private function createWindow() : void
      {
         ...
         _loc6_.addEventListener(WindowKeyboardEvent.const_192,this.windowKeyEventProcessor);
         _loc6_.addEventListener(WindowEvent.const_103,this.onInputChanged);
         this._window.addEventListener(WindowEvent.const_350,this.onWindowMoved);
         this.var_1625 = true;
         this.var_482 = "";
         this.refreshView();
      }
      ...
      private function refreshView() : void
      {
         ...
         this._window.width = _loc1_.width + const_603 + const_944;
         _loc1_.x = const_603;
         _loc1_.y = const_1280;
      }
      ...
      {
         this.var_312 = param1 - (const_603 + const_944);
      ...
      private function onWindowMoved(param1:WindowEvent) : void
      {
         ...
         this.setMaxWidth(this._window.context.getDesktopWindow().width - this._window.x - const_1281);
      }
