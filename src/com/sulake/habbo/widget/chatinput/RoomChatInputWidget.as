package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputWidget extends RoomWidgetBase
   {
      ...
      private static const const_1274:int = 5000;
      ...
      private var var_407:Timer = null;
      ...
      {
         return getTimer() - this.var_2184 > const_1274;
      }
      
      public function setLastPasteTime() : void
      {
         this.var_2184 = getTimer();
      }
      ...
      public function sendChat(param1:String, param2:int, param3:String = "") : void
      {
         ...
         var _loc4_:RoomWidgetChatMessage = new RoomWidgetChatMessage(RoomWidgetChatMessage.const_838,param1,param2,param3);
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_157,this.onRoomObjectDeselected);
         param1.addEventListener(RoomWidgetRoomViewUpdateEvent.const_310,this.onRoomViewUpdate);
         param1.addEventListener(RoomWidgetChatInputContentUpdateEvent.const_659,this.onChatInputUpdate);
         param1.addEventListener(RoomWidgetUserInfoUpdateEvent.const_138,this.onUserInfo);
         param1.addEventListener(RoomWidgetFloodControlEvent.const_737,this.onFloodControl);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_157,this.onRoomObjectDeselected);
         param1.removeEventListener(RoomWidgetRoomViewUpdateEvent.const_310,this.onRoomViewUpdate);
         param1.removeEventListener(RoomWidgetChatInputContentUpdateEvent.const_659,this.onChatInputUpdate);
         param1.removeEventListener(RoomWidgetUserInfoUpdateEvent.const_138,this.onUserInfo);
         param1.removeEventListener(RoomWidgetFloodControlEvent.const_737,this.onFloodControl);
      }
      ...
      private function onChatInputUpdate(param1:RoomWidgetChatInputContentUpdateEvent) : void
      {
         ...
         {
            case RoomWidgetChatInputContentUpdateEvent.const_1216:
               _loc2_ = localizations.getKey("widgets.chatinput.mode.whisper",":tell");
               this._visualization.displaySpecialChatMessage(_loc2_,param1.userName);
               break;
            case RoomWidgetChatInputContentUpdateEvent.const_1583:
         }
      }
      ...
      private function refreshWindowPosition() : void
      {
         ...
         var _loc1_:RoomWidgetChatInputWidgetMessage = new RoomWidgetChatInputWidgetMessage(RoomWidgetChatInputWidgetMessage.const_764,this._visualization.window);
         if(messageListener != null)
         {
      ...
      private function onReleaseTimerTick(param1:TimerEvent) : void
      {
         if(this._visualization != null)
         {
            this.var_708 = this.var_708 - 1;
            this._visualization.showFloodBlocking(this.var_708);
         }
      }
      ...
      {
         this.var_1333 = true;
         this.var_708 = param1.seconds;
         Logger.log("Enabling flood blocking for " + this.var_708 + " seconds");
         if(this.var_407)
         {
            this.var_407.reset();
         }
         ...
         {
            this.var_407 = new Timer(1000,this.var_708);
            this.var_407.addEventListener(TimerEvent.TIMER,this.onReleaseTimerTick);
            this.var_407.addEventListener(TimerEvent.TIMER_COMPLETE,this.onReleaseTimerComplete);
         }
         this.var_407.start();
         if(this._visualization != null)
         {
