package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private const const_969:int = 5;
      
      private const const_1780:int = 39;
      
      private const const_1781:int = 7829367;
      
      private const const_1779:int = 16777215;
      
      private const const_2066:int = 2000;
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_969;
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            if(param1 == "")
            {
               ...
               _loc3_.textColor = this.const_1781;
            }
            else
            {
               _loc3_.textColor = this.const_1779;
            }
            _loc3_.enable();
         }
         else
         ...
         _loc3_.text = param1;
         _loc3_.height = _loc3_.textHeight + this.const_969;
         if(param2)
         {
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.const_1226:
               _loc2_ = "${infostand.button.trade.tooltip.shutdown}";
               break;
            case RoomWidgetUserInfoUpdateEvent.const_1043:
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc5_ = getTimer();
            if(_loc5_ - this.var_2488 > this.const_2066 && _loc3_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2488 = _loc5_;
            }
         }
         else
         {
            _loc2_.textColor = this.const_1781;
            if(_loc3_.length >= this.const_1780)
            {
               _loc2_.text = _loc3_.substring(0,this.const_1780 - 1);
            }
         }
      }
      ...
      private function badgesEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            if(param2.name == "button.give")
            {
               ...
               if(_loc4_)
               {
                  _loc3_ = _loc4_.getGridItemIndex(this.var_622);
               }
               if(_loc3_ <= -1)
               {
                  return;
