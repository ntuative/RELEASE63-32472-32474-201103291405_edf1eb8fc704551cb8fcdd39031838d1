package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_2051:int = 152;
      
      private const const_2055:int = 16;
      
      private const const_1288:int = 4;
      
      private const const_2046:uint = 14342874;
      
      private const const_2054:uint = 3815994;
      
      private const const_2052:uint = 2085362;
      
      private const const_2056:uint = 39616;
      
      private const const_2049:uint = 10513106;
      
      private const const_2053:uint = 8734654;
      
      private const const_2047:uint = 9094430;
      
      private const const_2045:uint = 6200576;
      
      private const const_2050:String = "happiness";
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_2050,param1.nutrition,param1.nutritionMax,this.const_2056,this.const_2052);
         this.updateStateElement(this.const_2057,param1.experience,param1.experienceMax,this.const_2053,this.const_2049);
         this.updateStateElement(this.const_2048,param1.energy,param1.energyMax,this.const_2045,this.const_2047);
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(this.const_2051,this.const_2055,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),this.const_2046);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,this.const_2054);
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_198 && this.var_198.getPetId() == this.var_518)
               {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_535,this._widget.petData.ownerId);
