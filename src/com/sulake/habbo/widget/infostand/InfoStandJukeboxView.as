package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandJukeboxView
   {
      ...
      public function InfoStandJukeboxView(param1:InfostandWidget, param2:String, param3:IHabboCatalog, param4:IHabboSoundManager)
      {
         ...
         this.var_501 = param4;
         this.var_501.events.addEventListener(NowPlayingEvent.const_744,this.onNowPlayingChanged);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_501)
         {
            this.var_501.events.removeEventListener(NowPlayingEvent.const_744,this.onNowPlayingChanged);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this.var_989 = this.var_197.findChildByTag("catalog");
         if(this.var_989 != null)
         {
            this.var_989.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onCatalogButtonClicked);
         }
      }
      ...
      public function update(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         var _loc2_:IPlayListController = this.var_501.musicController.getRoomItemPlaylist();
         if(_loc2_ == null)
         {
         ...
         else
         {
            ...
            if(_loc6_ != -1)
            {
               _loc7_ = this.var_501.musicController.getSongInfo(_loc6_);
               if(_loc7_ != null)
               {
      ...
      private function showCatalogButton(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            {
               this.var_53.addListItem(this.var_989);
            }
            this.var_989.visible = param1;
         }
         else
         {
            this.var_53.removeListItem(this.var_989);
         }
      }
      ...
      private function onNowPlayingChanged(param1:NowPlayingEvent) : void
      {
         ...
         if(this._widget.mainContainer.visible && this._window.visible)
         {
            if(param1.id != -1)
            {
               _loc2_ = this.var_501.musicController.getSongInfo(param1.id);
               if(_loc2_ != null)
               {
