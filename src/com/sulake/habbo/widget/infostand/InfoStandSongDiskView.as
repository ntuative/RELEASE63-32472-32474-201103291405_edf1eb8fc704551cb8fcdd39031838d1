package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandSongDiskView extends InfoStandFurniView
   {
      ...
      public function InfoStandSongDiskView(param1:InfostandWidget, param2:String, param3:IHabboCatalog, param4:IHabboSoundManager)
      {
         ...
         this.var_501 = param4;
         this.var_501.events.addEventListener(SongInfoReceivedEvent.TRAX_SONG_INFO_RECEIVED,this.onSongInfoReceived);
      }
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_501)
         {
            this.var_501.events.removeEventListener(SongInfoReceivedEvent.TRAX_SONG_INFO_RECEIVED,this.onSongInfoReceived);
            this.var_501 = null;
         }
      }
      ...
      private function getSongInfoForExtraParam() : ISongInfo
      {
         ...
         var _loc2_:String = _loc1_.substr(RoomWidgetEnum.const_752.length,_loc1_.length);
         return this.var_501.musicController.getSongInfo(int(_loc2_));
      }
