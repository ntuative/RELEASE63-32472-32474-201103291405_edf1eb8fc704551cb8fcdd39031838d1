package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      private static const const_1300:int = 25;
      
      private static const const_979:int = 4000;
      
      private static const const_1370:int = 6000;
      ...
      private static const const_426:int = 0;
      
      private static const const_978:int = (const_617 + const_426) * const_111 + const_111;
      
      private static const const_425:int = 9;
      ...
      private var var_780:Number = 1;
      
      private var var_2602:String;
      
      private var var_981:Number = 1;
      
      private var var_1852:Number = 0;
      
      private var var_781:Point;
      ...
      private var var_2600:int = 150;
      
      private var var_226:int = 171.0;
      
      private var var_980:int = 18;
      ...
      public function RoomChatWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:int, param6:Component)
      {
         ...
         this.var_781 = new Point();
         super(param1,param2,param3);
         this.var_2601 = param5;
         this.var_41 = param1.createWindow("chat_container","",HabboWindowType.const_67,HabboWindowStyle.const_32,HabboWindowParam.const_43,new Rectangle(0,0,200,this.var_226 + RoomChatHistoryPulldown.const_86),null,0) as IWindowContainer;
         this.var_41.background = true;
         this.var_41.color = 33554431;
         this.var_41.tags.push("room_widget_chat");
         this.var_377 = param1.createWindow("chat_contentlist","",HabboWindowType.const_1128,HabboWindowStyle.const_43,0 | 0,new Rectangle(0,0,200,this.var_226),null,0) as IItemListWindow;
         this.var_41.addChild(this.var_377);
         this._activeContentWindow = param1.createWindow("chat_active_content","",HabboWindowType.const_67,HabboWindowStyle.const_43,HabboWindowParam.const_61,new Rectangle(0,0,200,this.var_226),null,0) as IWindowContainer;
         ...
         this.var_2602 = param4.getKey("site.url");
         this.var_2600 = int(param4.getKey("chat.history.item.max.count","150"));
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_979)
         {
            _loc2_ = param1 / const_1300 * const_1369;
            if(_loc2_ + this.var_982 > this.var_980)
            {
               _loc2_ = this.var_980 - this.var_982;
            }
            if(_loc2_ > 0)
            {
            ...
            if(this.var_982 >= this.var_980)
            {
               this.var_980 = const_111;
               this.var_982 = 0;
               this.animationStop();
               this.processBuffer();
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomViewUpdateEvent.const_787,this.onRoomViewUpdate);
         param1.addEventListener(RoomWidgetRoomViewUpdateEvent.const_781,this.onRoomViewUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomViewUpdateEvent.const_787,this.onRoomViewUpdate);
         param1.removeEventListener(RoomWidgetRoomViewUpdateEvent.const_781,this.onRoomViewUpdate);
      }
      
      private function onChatMessage(param1:RoomWidgetChatUpdateEvent) : void
      {
         var _loc2_:RoomChatItem = new RoomChatItem(this,windowManager,assets,this.getFreeItemId(),localizations,this.var_2602);
         _loc2_.define(param1);
         if(this.var_981 != 1)
         {
            _loc2_.senderX /= this.var_981;
         }
         _loc2_.senderX -= this.var_781.x;
      ...
      private function onRoomViewUpdate(param1:RoomWidgetRoomViewUpdateEvent) : void
      {
         ...
         if(param1.scale > 0)
         {
            if(this.var_1852 == 0)
            {
               this.var_1852 = param1.scale;
            }
            else
            {
               this.var_981 = param1.scale / this.var_1852;
            }
         }
         if(param1.positionDelta != null)
         {
            this.var_781.x += param1.positionDelta.x / this.var_981;
            this.var_781.y += param1.positionDelta.y / this.var_981;
         }
         if(param1.rect != null)
         {
            if(this.var_27 == null)
            ...
            this.var_41.height = this.var_226 + this.var_27.pulldownBarHeight;
            this.var_377.width = this.var_41.width - this.var_27.scrollbarWidth;
            this.var_377.height = this.var_226;
      ...
      private function processBuffer() : void
      {
         ...
         while(this.var_71.length > const_1372 || this.historyViewerActive() && this.var_71.length > 0)
         {
         ...
         else
         {
            ...
            {
               this.var_980 = this.getItemSpacing(this._itemList[this._itemList.length - 1],this.var_71[0]);
            }
            else
            {
               this.var_980 = const_111;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(this._itemList.length > 1)
               {
                  ...
                  {
                     _loc1_.screenLevel = _loc3_ + Math.max(this.var_780,1);
                  }
               }
               else
               {
               ...
               _loc1_.aboveLevels = this.var_780;
               if(_loc1_.aboveLevels > const_617 + const_426 + 2)
               {
                  _loc1_.aboveLevels = const_617 + const_426 + 2;
               }
               this.var_780 = 0;
      ...
      private function selectItemsToMove() : void
      {
         ...
         while(_loc3_ >= 0)
         {
            ...
            if(_loc4_.view != null)
            {
               if(_loc4_.screenLevel > const_426 || _loc4_.screenLevel == _loc2_ - 1 || _loc1_ - _loc4_.timeStamp >= const_1370)
               {
      ...
      private function setChatItemLocHorizontal(param1:RoomChatItem) : void
      {
         ...
         var _loc2_:Number = (param1.senderX + this.var_781.x) * this.var_981;
         var _loc3_:Number = _loc2_ - param1.width / 2;
         var _loc4_:Number = _loc3_ + param1.width;
         var _loc5_:Number = -this.var_41.width / 2 - const_980;
         var _loc6_:Number = this.var_41.width / 2 + const_980 - this.var_27.scrollbarWidth;
      ...
      private function setChatItemLocVertical(param1:RoomChatItem) : void
      {
         ...
         if(param1 != null)
         {
            ...
            _loc3_ = !!this.historyViewerActive() ? 0 : Number(this.var_780);
            if(_loc2_ == this._itemList.length - 1)
            {
               param1.y = this.getAreaBottom() - (_loc3_ + 1) * const_111 - const_425;
            }
            else
            {
      ...
      private function purgeItems() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc3_:int = 0;
         while(this._itemList.length > this.var_2600)
         {
      ...
      {
         return "chat_" + this.var_2601.toString() + "_item_" + (this.var_2599++).toString();
      }
      ...
      public function onItemMouseClick(param1:int, param2:String, param3:int, param4:int, param5:int, param6:WindowMouseEvent) : void
      {
         ...
         var _loc7_:RoomWidgetRoomObjectMessage = new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_404,param1,param3);
         messageListener.processWidgetMessage(_loc7_);
         var _loc8_:RoomWidgetChatSelectAvatarMessage = new RoomWidgetChatSelectAvatarMessage(RoomWidgetChatSelectAvatarMessage.const_642,param1,param2,param4,param5);
      ...
      public function stretchAreaBottomTo(param1:Number) : void
      {
         ...
         this.var_41.height = this.var_226 + RoomChatHistoryPulldown.const_86;
         if(this.var_27 != null)
         {
            this.var_27.containerResized(this.var_41.rectangle);
         }
      ...
      public function resetArea() : void
      {
         ...
         this.animationStop();
         this.var_226 = const_978 + const_425;
         this.var_41.height = this.var_226 + this.var_27.pulldownBarHeight;
         this.var_377.width = this.var_41.width - this.var_27.scrollbarWidth;
         this.var_377.height = this.var_226;
         this._activeContentWindow.width = this.var_41.width - this.var_27.scrollbarWidth;
         if(this.historyViewerActive())
         {
            this._activeContentWindow.height = this.getTotalContentHeight() + const_425;
         }
         else
         {
            this._activeContentWindow.height = this.var_226;
      ...
      public function mouseUp() : void
      {
         ...
         if(this.var_1851 && !this.historyViewerActive())
         {
            this.resetArea();
            this.var_1851 = false;
         }
