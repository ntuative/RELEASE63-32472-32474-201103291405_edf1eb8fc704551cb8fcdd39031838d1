package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private static const const_1368:int = 18;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_187.state = RoomChatHistoryPulldown.const_252;
         ...
         this.var_49 = param2.createWindow("chatscroller","",HabboWindowType.const_1231,HabboWindowStyle.const_43,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         this.var_187.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_252);
      }
      ...
      public function get visible() : Boolean
      {
         ...
         return this.var_187.state == RoomChatHistoryPulldown.const_364 || this.var_187.state == RoomChatHistoryPulldown.const_547;
      }
      ...
      {
         if(!this.var_444 && !this.var_1713)
         {
            this.var_444 = true;
            this.setHistoryViewerScrollbar(true);
            this.var_187.state = RoomChatHistoryPulldown.const_364;
            if(this._widget != null)
            {
      ...
      public function containerResized(param1:Rectangle, param2:Boolean = false) : void
      {
         if(this.var_49 != null)
         {
            ...
            if(param2)
            {
               this.var_49.scrollV = this.var_638;
            }
         }
         if(this.var_187 != null)
         {
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_443 > 0 && param2)
         {
            if(this.var_1833)
            {
               if(Math.abs(param1 - this.var_443) <= const_1148)
               {
                  return;
               }
               this.var_1833 = false;
            ...
            if(this.var_444)
            {
               ...
               _loc5_ = (param1 - this.var_443) / this.var_49.height;
               _loc3_ = this.var_638 - _loc5_ / _loc4_;
               _loc3_ = Math.max(0,_loc3_);
               _loc3_ = Math.min(1,_loc3_);
               _loc6_ = param1 - this.var_443;
               _loc7_ = true;
               _loc8_ = true;
               if(this.var_49.scrollV < 1 - const_1368 / this.var_49.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
      ...
      public function beginDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_49 != null)
         {
            this.var_638 = this.var_49.scrollV;
         }
         if(this.var_49 != null)
         {
      ...
      private function moveHistoryScroll() : void
      {
         ...
         var _loc1_:Number = this.var_638 - this.var_49.scrollV;
         if(_loc1_ == 0)
         {
            return;
         }
