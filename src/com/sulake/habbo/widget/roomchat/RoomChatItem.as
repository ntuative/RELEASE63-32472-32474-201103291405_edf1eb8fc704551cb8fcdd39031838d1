package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_973:Number = 18;
      
      private static const const_615:int = 6;
      
      private static const const_1358:int = 6;
      
      private static const const_972:int = 35;
      
      private static const const_431:String = "name";
      
      private static const const_971:String = "message";
      
      private static const const_1359:String = "pointer";
      
      private static const const_4:String = "background";
      
      private static var var_373:IRegionWindow;
      
      private static var var_442:IRegionWindow;
      
      private static var var_223:IRegionWindow;
      
      private static var var_441:IRegionWindow;
      ...
      public function RoomChatItem(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:String, param5:IHabboLocalizationManager, param6:String)
      {
         ...
         if(!var_442)
         {
            var_442 = this._windowManager.buildFromXML(this._assetLibrary.getAssetByName("bubble_shout").content as XML,1) as IRegionWindow;
            var_442.tags.push("roomchat_bubble");
            var_442.x = 0;
            var_442.y = 0;
            var_442.width = 0;
            var_442.background = true;
            var_442.mouseThreshold = 0;
            var_223.setParamFlag(WindowParam.WINDOW_PARAM_FORCE_CLIPPING,true);
         }
         if(!var_441)
         {
            var_441 = this._windowManager.buildFromXML(this._assetLibrary.getAssetByName("bubble_whisper").content as XML,1) as IRegionWindow;
            var_441.tags.push("roomchat_bubble");
            var_441.x = 0;
            var_441.y = 0;
            var_441.width = 0;
            var_441.background = true;
            var_441.mouseThreshold = 0;
            var_223.setParamFlag(WindowParam.WINDOW_PARAM_FORCE_CLIPPING,true);
         }
         if(!var_373)
         {
            var_373 = this._windowManager.buildFromXML(this._assetLibrary.getAssetByName("bubble_whisper").content as XML,1) as IRegionWindow;
            var_373.tags.push("roomchat_bubble");
            var_373.x = 0;
            var_373.y = 0;
            var_373.width = 0;
            var_373.background = true;
            var_373.mouseThreshold = 0;
            var_223.setParamFlag(WindowParam.WINDOW_PARAM_FORCE_CLIPPING,true);
         }
      }
      ...
      public function define(param1:RoomWidgetChatUpdateEvent) : void
      {
         ...
         this.var_1195 = param1.userId;
         this.var_968 = param1.userName;
         this.var_1194 = param1.userCategory;
         this._message = param1.text;
         this.var_374 = param1.links;
         this.var_1822 = param1.userX;
         this.var_267 = param1.userImage;
         this.var_2563 = param1.userColor;
      ...
      {
         var _loc5_:Rectangle = new Rectangle(this._x,this.var_171,this.width,const_973);
      ...
      public function renderView() : void
      {
         ...
         switch(this.var_1448)
         {
            ...
            case RoomWidgetChatUpdateEvent.const_146:
               this._window = var_441.clone() as IRegionWindow;
               break;
            case RoomWidgetChatUpdateEvent.const_116:
               this._window = var_442.clone() as IRegionWindow;
               break;
            case RoomWidgetChatUpdateEvent.const_300:
               this._window = var_373.clone() as IRegionWindow;
               isRespect = true;
               break;
         ...
         var nameWindow:ILabelWindow = this._window.findChildByName(const_431) as ILabelWindow;
         var textWindow:ITextWindow = this._window.findChildByName(const_971) as ITextWindow;
         var pointerWindow:IBitmapWrapperWindow = this._window.findChildByName(const_1359) as IBitmapWrapperWindow;
         ...
         if(this.var_267 && !isRespect)
         {
            ...
            if(userIconWindow)
            {
               ...
               userIconWindow.x = x1;
               userIconWindow.y = y1;
               this.var_772 = Math.max(0,(this.var_267.height - background.height) / 2);
               this.var_268 += userIconWindow.x + this.var_267.width;
            }
         }
         if(nameWindow != null)
         {
            ...
            this.var_268 += nameWindow.width;
         }
         if(this.var_1448 == RoomWidgetChatUpdateEvent.const_300)
         {
            textWindow.text = this.var_69.registerParameter("widgets.chatbubble.respect","username",this.var_968);
            this.var_268 = const_972;
         }
         else if(this.var_1448 == RoomWidgetChatUpdateEvent.const_284)
         {
            textWindow.text = this.var_69.registerParameter("widget.chatbubble.petrespect","petname",this.var_968);
            this.var_268 = const_972;
         }
         ...
         if(textWindow.visible)
         {
            ...
            this.var_268 += textWindow.width;
         }
         if(pointerWindow != null && pointerWindow.visible)
         {
            pointerWindow.bitmap = pointerBitmapData;
            pointerWindow.disposesBitmap = false;
            pointerWindow.x = this.var_268 / 2;
            pointerWindow.y += this.var_772;
         }
         var bitmap:BitmapData = this.buildBubbleImage(nameWindow.width + textWindow.width,background.height,this.var_2563,isRespect);
         this._window.width = bitmap.width;
         this._window.y -= this.var_772;
         this.var_268 = this._window.width;
      ...
      {
         var _loc5_:int = 0;
         var _loc3_:ITextWindow = this._window.getChildByName(const_971) as ITextWindow;
         ...
         if(_loc4_ > -1)
         {
            ...
            while(_loc5_ < this.var_771.length)
            {
               if(_loc4_ >= this.var_771[_loc5_][0] && _loc4_ <= this.var_771[_loc5_][1])
               {
                  ...
                  {
                     HabboWebTools.openWebPage(this.var_1820 + this.var_374[_loc5_][0],"habboMain");
                  }
                  else
                  {
                     HabboWebTools.openWebPage(this.var_1820 + this.var_374[_loc5_][0]);
                  }
                  return true;
               }
               _loc5_++;
      ...
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         ...
         this._widget.onItemMouseClick(this.var_1195,this.var_968,this.var_1194,this._roomId,this._roomCategory,param1);
      }
      
      private function onBubbleMouseDown(param1:WindowMouseEvent) : void
      {
         this._widget.onItemMouseDown(this.var_1195,this.var_1194,this._roomId,this._roomCategory,param1);
      }
      
      private function onBubbleMouseOver(param1:WindowMouseEvent) : void
      {
         this._widget.onItemMouseOver(this.var_1195,this.var_1194,this._roomId,this._roomCategory,param1);
      }
      
      private function onBubbleMouseOut(param1:WindowMouseEvent) : void
      {
         this._widget.onItemMouseOut(this.var_1195,this.var_1194,this._roomId,this._roomCategory,param1);
      }
