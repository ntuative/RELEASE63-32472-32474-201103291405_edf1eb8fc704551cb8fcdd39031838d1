package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_967:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1339:String = "sendAccessTokenToServer";
      
      private static const const_1338:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1339,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1338,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_967);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_967);
         }
      }
