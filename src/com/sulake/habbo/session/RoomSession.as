package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private const const_2059:int = 2500;
      ...
      public function RoomSession(param1:int, param2:int, param3:IHabboTracking, param4:String = "", param5:String = "")
      {
         ...
         this.var_1114 = new UserDataManager();
      }
      ...
      public function set connection(param1:IConnection) : void
      {
         ...
         {
            this.var_1114.connection = param1;
         }
      }
      ...
      {
         this._connection.send(new ChatMessageComposer(param1,this.var_1367));
         this.var_1366.add(this.var_1367,getTimer());
         ++this.var_1367;
      }
      ...
      public function receivedChatWithTrackingId(param1:int) : void
      {
         ...
         {
            _loc3_ = getTimer();
            if(_loc3_ - int(_loc2_) > this.const_2059)
            {
      ...
      {
         return this.var_1114 as IUserDataManager;
      }
