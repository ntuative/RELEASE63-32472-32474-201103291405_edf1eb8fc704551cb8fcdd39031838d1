package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private var var_1836:IIssueBrowserView;
      
      private var var_1837:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_376.view.width = this.var_270.container.width;
         this.var_376.view.height = this.var_270.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2070:
               ...
               {
                  this.var_1835 = new MyIssuesView(this.issueManager,this,this.var_270.container);
               }
               return this.var_1835;
            case this.const_2071:
               if(this.var_1836 == null)
               {
                  this.var_1836 = new OpenIssuesView(this.issueManager,this,this.var_270.container);
               }
               return this.var_1836;
            case this.const_2069:
               if(this.var_1837 == null)
               {
                  this.var_1837 = new PickedIssuesView(this.issueManager,this,this.var_270.container);
               }
