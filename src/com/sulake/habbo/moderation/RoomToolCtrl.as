package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1242:IDropMenuWindow;
      
      private var var_472:ITextFieldWindow;
      
      private var var_652:Boolean = true;
      
      private var var_1039:ICheckBoxWindow;
      
      private var var_1555:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_34.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_389));
         Logger.log("BEGINNING TO SHOW: " + this.var_389);
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + this.var_389);
         if(param1.flatId != this.var_389)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + this.var_389);
            return;
         }
         this._data = param1;
         this.populate();
      ...
      public function populate() : void
      {
         ...
         this.var_472 = ITextFieldWindow(this._frame.findChildByName("message_input"));
         this.var_472.procedure = this.onInputClick;
         this.var_1242 = IDropMenuWindow(this._frame.findChildByName("msgTemplatesSelect"));
         this.prepareMsgSelect(this.var_1242);
         this.var_1242.procedure = this.onSelectTemplate;
         this.var_1039 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1555 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_34,WindowTracker.const_678,this._data.flatId),this._frame,false,false,true);
      }
      ...
      {
         if(this.var_652 || this.var_472.text == "")
         {
            this.var_34.windowManager.alert("Alert","You must input a message to the user",0,this.onAlertClose);
            return;
         }
         var _loc2_:int = this.determineAction(param1,this.var_1039.isSelected);
         this.var_34.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1611,_loc2_,this.var_472.text,"",""));
         if(this.var_1555.isSelected || this.var_1554.isSelected || this.var_1039.isSelected)
         {
            this.var_34.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1555.isSelected,this.var_1554.isSelected,this.var_1039.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1543);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1500);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_34.initMsg.roomMessageTemplates[this.var_1242.selection];
         if(_loc3_ != null)
         {
            this.var_652 = false;
            this.var_472.text = _loc3_;
         }
      }
   }
}
