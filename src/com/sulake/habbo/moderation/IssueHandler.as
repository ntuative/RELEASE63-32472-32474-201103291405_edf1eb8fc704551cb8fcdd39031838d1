package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_490:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         this.var_490 = new UserInfoCtrl(this._window,this.var_66,_loc3_.message);
         this.var_1104 = new UserInfoCtrl(this._window,this.var_66,_loc3_.message);
         this.var_490.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc3_.reporterUserId);
         ...
         {
            this.var_1104.load(_loc4_,this.var_155.reportedUserId);
         }
         else
         {
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         this.var_66.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_66,WindowTracker.const_1260,_loc2_),this._window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            this.var_490 = new UserInfoCtrl(this._window,this.var_66,_loc3_.message);
            this.var_490.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc2_);
         }
      }
