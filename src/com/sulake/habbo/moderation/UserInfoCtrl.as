package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_987:int = 60;
      
      private static const const_989:int = 3600;
      
      private static const const_986:int = 86400;
      
      private static const const_988:int = 31536000;
      ...
      {
         if(param1 < 2 * const_987)
         {
            return param1 + " secs ago";
         }
         if(param1 < 2 * const_989)
         {
            return Math.round(param1 / const_987) + " mins ago";
         }
         if(param1 < 2 * const_986)
         {
            return Math.round(param1 / const_989) + " hours ago";
         }
         if(param1 < 2 * const_988)
         {
            return Math.round(param1 / const_986) + " days ago";
         }
         return Math.round(param1 / const_988) + " years ago";
      }
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_1228.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(this.var_34.getXmlWindow("user_info"));
            this.var_1228.addChild(_loc1_);
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_34,WindowTracker.const_1065,this._data.userId),this._callerFrame,this.var_1227,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new RoomVisitsCtrl(this.var_34,this._data.userId),this._callerFrame,this.var_1227,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new SendMsgsCtrl(this.var_34,this._data.userId,this._data.userName,this.var_1320),this._callerFrame,this.var_1227,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new ModActionCtrl(this.var_34,this._data.userId,this._data.userName,this.var_1320),this._callerFrame,this.var_1227,false,true);
      }
