package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2130 = param2.pickerUserId;
         this.var_2526 = param2.pickerUserName;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         if(this.var_762 == null || param1.timeStamp < this.var_762.timeStamp)
         {
            this.var_762 = param1;
         }
         if(this.var_763 == null || param1.priority > this.var_763.timeStamp)
         {
            this.var_763 = param1;
         }
      }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_763;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_762;
         if(_loc2_ == null)
         {
