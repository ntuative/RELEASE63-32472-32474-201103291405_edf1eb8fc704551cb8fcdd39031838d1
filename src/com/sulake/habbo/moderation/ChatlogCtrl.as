package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1971:int = 1000;
      
      private static var var_1023:Array = [];
      
      private static var var_1973:int = 200;
      ...
      private var var_1709:IMessageComposer;
      ...
      {
         this.var_811 = IWindowContainer(this.var_34.getXmlWindow("chatlog_roomheader"));
         this.var_812 = IWindowContainer(this.var_34.getXmlWindow("chatlog_chatline"));
         this.var_515 = new Timer(1000,1);
         ...
         this.var_34.connection.send(this.var_1709);
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_1972[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
