package com.sulake.habbo.help.cfh.data
{
   ...
   public class UserRegistry
   {
      ...
      private static const const_1282:int = 80;
      ...
      public function registerUser(param1:int, param2:String, param3:Boolean = true) : void
      {
         ...
         if(param3)
         {
            _loc4_ = new UserRegistryItem(param1,param2,this.var_884);
         }
         else
         {
            _loc4_ = new UserRegistryItem(param1,param2);
         }
         if(param3 && this.var_884 == "")
         {
      ...
      {
         var _loc1_:int = 0;
         while(this.var_485.length > const_1282)
         {
      ...
      private function addRoomNameForMissing() : void
      {
         ...
         {
            _loc1_ = this.var_485.getValue(this.var_1340.shift());
            if(_loc1_ != null)
            {
               _loc1_.roomName = this.var_884;
            }
         }
      }
   }
