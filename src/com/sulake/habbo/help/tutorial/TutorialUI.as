package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_303:String = "TUI_NAME_VIEW";
      
      public static const const_386:String = "TUI_CLOTHES_VIEW";
      ...
      private var var_368:NameChangeView;
      ...
      public function TutorialUI(param1:HabboHelp, param2:Boolean = true)
      {
         ...
         this.var_34.events.addEventListener(HabboHelpTutorialEvent.const_482,this.onTaskDoneEvent);
         this.var_34.events.addEventListener(HabboHelpTutorialEvent.const_491,this.onTaskDoneEvent);
         this.var_34.events.addEventListener(HabboHelpTutorialEvent.const_518,this.onTaskDoneEvent);
         if(this.var_34.sessionDataManager != null)
         {
            this.var_34.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_317,this.onFigureUpdate);
         }
      }
      ...
      {
         return this.var_1182 && this.var_1183 && this.var_1431;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_34)
         {
            this.var_34.events.removeEventListener(HabboHelpTutorialEvent.const_482,this.onTaskDoneEvent);
            this.var_34.events.removeEventListener(HabboHelpTutorialEvent.const_491,this.onTaskDoneEvent);
            this.var_34.events.removeEventListener(HabboHelpTutorialEvent.const_518,this.onTaskDoneEvent);
            if(this.var_34.sessionDataManager != null)
            {
               this.var_34.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_317,this.onFigureUpdate);
            }
            this.var_34 = null;
         }
      }
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_482:
               this.var_1431 = true;
               if(this.var_43 != null && this.var_43.id == const_459)
               {
                  this.showView(const_89);
               }
               break;
            case HabboHelpTutorialEvent.const_491:
               if(this.var_43 != null && this.var_43.id == const_386)
               {
                  this.var_1810 = true;
                  this.disposeWindow();
               }
      ...
      public function showView(param1:String) : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_2536 = this._window.width - _loc2_.width;
         ...
         switch(param1)
         {
            ...
            case const_303:
               ...
               if(this.var_368 == null)
               {
                  this.var_368 = new NameChangeView(this);
               }
               this.var_368.showMainView();
               this.prepareForTutorial();
               break;
            case const_386:
         ...
         this._window.height = _loc2_.height + this.var_2535;
         this._window.width = _loc2_.width + this.var_2536;
         if(_loc3_)
         {
            if(this._window == null)
            {
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(this.var_43 != null && (this.var_43.id == const_303 || this.var_43.id == const_89))
         {
            this.showView(const_89);
         }
      }
      ...
      {
         this.var_1182 = true;
         if(this.var_43 != null && (this.var_43.id == const_386 || this.var_43.id == const_89))
         {
            this.showView(const_89);
         }
      }
      ...
      public function onChangeUserNameResult(param1:ChangeUserNameResultMessageEvent) : void
      {
         ...
         if(_loc2_.resultCode == ChangeUserNameResultMessageEvent.var_556)
         {
            this.var_1183 = true;
         ...
         {
            this.var_368.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
         }
      }
      ...
      public function onCheckUserNameResult(param1:CheckUserNameResultMessageEvent) : void
      {
         ...
         if(_loc2_.resultCode == ChangeUserNameResultMessageEvent.var_556)
         {
            this.var_368.checkedName = _loc2_.name;
         }
         else
         {
            this.var_368.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
