package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1595:uint = 11129827;
      ...
      private var var_1068:NameSuggestionListRenderer;
      ...
      {
         return TutorialUI.const_303;
      }
      
      public function set checkedName(param1:String) : void
      {
         this.var_478 = param1;
         if(this.var_1596 == this.var_478)
         {
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1594 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_703)
         {
            this.var_703 = this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_703)
            {
               return;
            }
            this._window.content.addChild(this.var_703);
         }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_704)
         {
            this.var_704 = this._controller.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_704)
            {
               return;
            }
            this._window.content.addChild(this.var_704);
         }
         this._window.caption = this._controller.localization.getKey("tutorial.name_change.title.confirm");
         var _loc1_:ITextWindow = this.var_704.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_478;
         }
         this.showView(this.var_704);
      }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this._controller.localization.registerParameter("help.tutorial.name.available","name",this.var_478);
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1043 || param1 == ChangeUserNameResultMessageEvent.var_1046)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1068 = new NameSuggestionListRenderer(this._controller);
         var _loc6_:int = this.var_1068.render(param3,_loc5_);
         var _loc7_:int = 0;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_478 = this._controller.myName;
               this.showConfirmationView();
               break;
            ...
            case "confirm_name_button":
               this._controller.changeName(this.var_478);
               break;
