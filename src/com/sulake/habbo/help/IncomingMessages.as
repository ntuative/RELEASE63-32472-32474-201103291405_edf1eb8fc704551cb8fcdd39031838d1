package com.sulake.habbo.help
{
   ...
   public class IncomingMessages
   {
      ...
      {
         this.var_22.showUI(HabboHelpViewEnum.const_410);
      }
      ...
      private function onFaqClientFaqs(param1:IMessageEvent) : void
      {
         ...
         this.var_22.tellUI(HabboHelpViewEnum.const_180);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         this.var_22.showUI(HabboHelpViewEnum.const_595);
      }
      ...
      private function onFaqCategory(param1:IMessageEvent) : void
      {
         ...
         this.var_22.tellUI(HabboHelpViewEnum.const_304,_loc6_);
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         this.var_22.showUI(HabboHelpViewEnum.const_1218);
         this.var_22.tellUI(HabboHelpViewEnum.const_1218,_loc5_);
      }
