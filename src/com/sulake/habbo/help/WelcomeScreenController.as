package com.sulake.habbo.help
{
   ...
   public class WelcomeScreenController implements IUpdateReceiver
   {
      ...
      {
         return this._notifications[this.var_1324];
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_129)
         {
            ...
            this.var_129.toolbar.events.removeEventListener(HabboToolbarEvent.const_776,this.onToolbarResized);
            this.var_129 = null;
         }
         ...
         {
            this.var_701.stop();
            this.var_701.removeEventListener(TimerEvent.TIMER,this.onReminderTimer);
            this.var_701 = null;
         }
      ...
      public function showWelcomeScreen(param1:Boolean) : void
      {
         ...
         this.var_129.toolbar.events.addEventListener(HabboToolbarEvent.const_776,this.onToolbarResized);
         var _loc4_:int = parseInt(this._config.getKey("welcome.screen.delay","5000"));
         this.var_701 = new Timer(_loc4_);
      ...
      public function onReminderTimer(param1:TimerEvent) : void
      {
         ...
         this.var_347.y = this.var_129.toolbar.getIconLocation(this.current.targetIconId) - this._window.height / 2;
         this._window.y = this.var_347.y;
      ...
      private function closeWindow() : void
      {
         ...
         if(this.var_1324 < this._notifications.length - 1)
         {
            ++this.var_1324;
         }
         else
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:Number = Point.distance(this._window.rectangle.topLeft,this.var_347);
         if(_loc2_ > 5)
         {
            _loc3_ = Point.interpolate(this._window.rectangle.topLeft,this.var_347,0.5);
            this._window.x = _loc3_.x;
            this._window.y = _loc3_.y;
         }
         else
         {
            this._window.x = this.var_347.x;
            this._window.y = this.var_347.y;
            this.var_129.removeUpdateReceiver(this);
         }
      }
