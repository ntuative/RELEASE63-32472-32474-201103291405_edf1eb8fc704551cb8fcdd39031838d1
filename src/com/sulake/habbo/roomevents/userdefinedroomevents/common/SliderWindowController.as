package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      private function updateSliderPosition() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.x = this.getSliderPosition(this.var_898);
         }
      ...
      {
         return int(this.var_1691 * (Number(param1 - this._minValue) / (this.var_1109 - this._minValue)));
      }
      
      private function getValueAtPosition(param1:Number) : Number
      {
         return param1 / this.var_1691 * (this.var_1109 - this._minValue) + this._minValue;
      }
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_899)
         {
            if(param1.type == WindowMouseEvent.const_58 || param1.type == WindowMouseEvent.const_198)
            {
               this.var_899 = false;
            }
         }
         if(!this.var_899 || param1.type != WindowEvent.const_350)
         {
            return;
         }
         if(this.var_593 != 0)
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_593 != 0)
            {
               _loc3_ = this.var_898 + this.var_593;
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc2_ != null && this.var_721 != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_721.width,this.var_721.height,true,16777215);
            _loc2_.bitmap.copyPixels(this.var_721,this.var_721.rect,new Point(0,0),null,null,true);
         }
         _loc1_ = this._sliderContainer.findChildByName("slider_movement_area") as IWindowContainer;
         if(_loc1_ != null)
         {
            _loc2_ = _loc1_.findChildByName("slider_button") as IBitmapWrapperWindow;
            if(_loc2_ != null && this.var_722 != null)
            {
               _loc2_.bitmap = new BitmapData(this.var_722.width,this.var_722.height,true,16777215);
               _loc2_.bitmap.copyPixels(this.var_722,this.var_722.rect,new Point(0,0),null,null,true);
               _loc2_.procedure = this.sliderProcedure;
               this.var_1691 = _loc1_.width - _loc2_.width;
            }
         }
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_721 = BitmapData(_loc2_.content);
         _loc2_ = BitmapDataAsset(param1.getAssetByName("slider_obj_png"));
         this.var_722 = BitmapData(_loc2_.content);
      }
   }
}
