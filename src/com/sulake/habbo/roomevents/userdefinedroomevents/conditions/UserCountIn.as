package com.sulake.habbo.roomevents.userdefinedroomevents.conditions
{
   ...
   public class UserCountIn implements ConditionType
   {
      ...
      {
         this.var_80 = param2;
         this.var_1076 = new SliderWindowController(param2,this.getMinInput(param1),param2.assets,1,50,1);
         this.var_1076.addEventListener(Event.CHANGE,this.onMinSliderChange);
         this.var_1076.setValue(1);
         this.var_1075 = new SliderWindowController(param2,this.getMaxInput(param1),param2.assets,1,50,1);
         this.var_1075.addEventListener(Event.CHANGE,this.onMaxSliderChange);
         this.var_1075.setValue(50);
      }
      ...
      public function onEditStart(param1:IWindowContainer, param2:Triggerable) : void
      {
         ...
         this.var_1076.setValue(_loc3_);
         this.var_1075.setValue(_loc4_);
      }
