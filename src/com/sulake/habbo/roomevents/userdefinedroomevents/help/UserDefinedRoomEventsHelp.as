package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private var var_1953:IWindowContainer;
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1953 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1246 = this.var_1953.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1246)
         {
            this.var_1246.procedure = this.onButtonClick;
         }
         this.var_1245 = this.var_1953.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1245)
         {
      ...
      {
         if(this.var_274 >= this.var_69.length - 1)
         {
      ...
      {
         ++this.var_274;
         this.var_274 = Math.min(this.var_274,this.var_69.length - 1);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this.var_69[this.var_274][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this.var_69[this.var_274][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this.var_69[this.var_274][1]).value;
