package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private static var var_1330:int = 2;
      ...
      private var var_1600:TriggerConfs;
      
      private var var_1598:ActionTypes;
      
      private var var_1599:ConditionTypes;
      ...
      private var var_1069:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_1600 = new TriggerConfs();
         this.var_1598 = new ActionTypes();
         this.var_1599 = new ConditionTypes();
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1069 = new SliderWindowController(this.var_80,IWindowContainer(this.find(this.var_50,"delay_slider_container")),this.var_80.assets,0,20,1);
         this.var_1069.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1069.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_706.hideAll(this.var_241);
         }
      }
      ...
      public function prepareForUpdate(param1:Triggerable) : void
      {
         ...
         this.var_706.showAll(this.var_241);
         if(this.var_36 as ActionDefinition != null)
         {
            _loc5_ = ActionDefinition(this.var_36);
            _loc6_ = _loc5_.delayInPulses;
            this.var_1069.setValue(_loc6_);
         }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1069.getValue()) : 0;
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.stuffTypeSelectionCode = this.var_36.stuffTypeSelectionCode < 1 ? int(var_1330) : int(this.var_36.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.stuffTypeSelectionCode = (this.var_36.stuffTypeSelectionCode + 1) % (var_1330 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1600);
         this.refreshConfigureElement(this.var_1598);
         this.refreshConfigureElement(this.var_1599);
