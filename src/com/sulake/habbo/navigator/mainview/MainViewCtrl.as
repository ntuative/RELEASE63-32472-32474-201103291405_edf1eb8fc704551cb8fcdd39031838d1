package com.sulake.habbo.navigator.mainview
{
   ...
   public class MainViewCtrl implements IUpdateReceiver, IDisposable
   {
      ...
      private static const const_632:int = 2;
      
      private static const const_1018:int = 3;
      
      private static const const_1432:int = 4;
      ...
      private var var_1036:PopularTagsListCtrl;
      
      private var var_1037:GuestRoomListCtrl;
      ...
      public function MainViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_1036 = new PopularTagsListCtrl(this._navigator);
         this.var_1037 = new GuestRoomListCtrl(this._navigator);
         this.var_1278 = new OfficialRoomListCtrl(this._navigator);
         this.var_515 = new Timer(300,1);
         this.var_515.addEventListener(TimerEvent.TIMER,this.onResizeTimer);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_515)
            {
               this.var_515.removeEventListener(TimerEvent.TIMER,this.onResizeTimer);
               this.var_515.reset();
               this.var_515 = null;
            }
            if(this.var_1036)
      ...
      private function prepare() : void
      {
         ...
         this.var_1546 = this.var_16.findChildByName("loading_text");
         var _loc1_:IWindow = this.var_16.findChildByTag("close");
         _loc1_.procedure = this.onWindowClose;
         this.var_1279 = IRegionWindow(this.var_16.findChildByName("to_hotel_view"));
         if(!this.var_1279)
         {
            ErrorReportStorage.addDebugData("MainViewCtrl","prepare: _toHotelView is null!");
         }
         this.var_1279.procedure = this.onHotelView;
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_919,false);
      ...
      public function refresh() : void
      {
         ...
         Util.moveChildrenToColumn(this.var_193,["custom_content","list_content"],this.var_235.y,8);
         this.var_211.height = this.var_211.height + _loc1_ - this.var_211.y - this.var_280.height + this.var_2805;
         Util.moveChildrenToColumn(this.var_193,["list_content","custom_footer"],this.var_211.y,0);
         this.var_2805 = this.var_280.height;
      ...
      {
         this.refreshList(param1,param2,this.var_1037,"guest_rooms");
      }
      
      private function refreshPopularTags(param1:Boolean, param2:Boolean) : void
      {
         this.refreshList(param1,param2,this.var_1036,"popular_tags");
      }
      ...
      private function getSearchMsg(param1:int, param2:String) : IMessageComposer
      {
         ...
         if(param1 == Tabs.const_780)
         {
            return new RoomsWhereMyFriendsAreSearchMessageComposer();
         }
         if(param1 == Tabs.const_920)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_676 == const_1017)
         {
            _loc3_ = Math.min(1,Math.max(0,this.var_211.blend - _loc2_));
            this.var_211.blend = _loc3_;
            this.var_235.blend = !!this.var_1277 ? Number(_loc3_) : Number(1);
            this.var_280.blend = !!this.var_1277 ? Number(_loc3_) : Number(1);
            if(_loc3_ == 0)
            {
               this.var_676 = const_632;
            }
         }
         else if(this.var_676 == const_632)
         {
            if(this.var_1545 % 10 == 1)
            {
               this.var_1546.visible = !this.var_1546.visible;
            }
            ++this.var_1545;
            if(!this._navigator.data.isLoading())
            {
               this.var_676 = const_1018;
            }
         }
         else if(this.var_676 == const_1018)
         {
            this.refresh();
            this.var_676 = const_1432;
         }
         else
         {
      ...
      {
         this.refreshScrollbar(this.var_1036);
      ...
      {
         this._navigator.refreshButton(this.var_1279,"icon_hotelview",!param1,null,0);
         this._navigator.refreshButton(this.var_1279,"icon_hotelview_reactive",param1,null,0);
      }
