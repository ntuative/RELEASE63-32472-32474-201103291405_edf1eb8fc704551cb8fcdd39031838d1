package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1255:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_663 = new Timer(100);
         this.var_663.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
      ...
      public function dispose() : void
      {
         if(this.var_663)
         {
            this.var_663.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_663.reset();
            this.var_663 = null;
         }
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1255.view.findChildByName("select_arrow"));
      ...
      private function prepare() : void
      {
         ...
         this.var_1256 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_193.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_67,HabboWindowStyle.const_32,HabboWindowParam.const_61,new Rectangle(0,0,100,300)));
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent) : void
      {
         ...
         var _loc3_:String = "model_" + this.var_1255.name;
