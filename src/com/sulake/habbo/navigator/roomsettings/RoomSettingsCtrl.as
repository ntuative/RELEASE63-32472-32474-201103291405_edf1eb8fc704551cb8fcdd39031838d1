package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_1265:TextFieldManager;
      ...
      private var var_1262:TextFieldManager;
      
      private var var_1259:ICheckBoxWindow;
      ...
      private var var_1985:IWindowContainer;
      ...
      private var var_2762:ITextWindow;
      ...
      {
         this.var_389 = param1;
         this._navigator.send(new GetRoomSettingsMessageComposer(this.var_389));
         if(this.var_1260 != null)
         {
            this.var_1260.visible = false;
         }
      }
      ...
      {
         if(param1 != this.var_389 || this.var_1258 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1258 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1629)
         {
            this.var_821.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1737)
         {
         ...
         {
            this.var_1265.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1633)
         {
            this.setTagError(this.var_1004,param3,"${navigator.roomsettings.unacceptablewords}");
            this.setTagError(this.var_1003,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1521)
         {
            this.setTagError(this.var_1004,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            this.setTagError(this.var_1003,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1579)
         {
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_591,this.onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_749,this.onDoorModePasswordUnselect);
         ...
         this.var_821 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         this.var_1265 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_1004 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_1003 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_1030 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1262 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1259 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1263 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1266 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_666 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_1983 = IWindowContainer(this._window.findChildByName("header_container"));
         this.var_1524 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1264 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1261 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1985 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1525 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_277 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1260 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_2762 = ITextWindow(this._window.findChildByName("basic_caption"));
         this.var_2763 = ITextWindow(this._window.findChildByName("advanced_caption"));
         this.var_1526 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1526.mouseThreshold = 0;
         this.var_1526.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSwitchView);
         this.var_1260.visible = false;
         if(!this._inRoom)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1983.visible = this._inRoom;
         this.var_1985.visible = this._inRoom;
         this.var_2763.visible = this.var_543;
         this.var_2762.visible = !this.var_543;
         if(this.var_543)
         {
            this.var_1261.visible = true;
            this.var_1525.visible = false;
            this.refreshFlatControllers();
            this.var_1261.height = Util.getLowestPoint(this.var_1261) + 4;
         }
         else
         {
            this.populateForm();
            ...
            this._navigator.thumbRenderer.refreshThumbnail(IWindowContainer(this.var_1524.findChildByName("picframe")),this._navigator.data.enteredGuestRoom.thumbnail,false);
            this.var_1264.height = Util.getLowestPoint(this.var_1264) + 4;
         }
         this.var_1526.text = !!this.var_543 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1983.name,this.var_1524.name,this.var_1264.name,this.var_1261.name,this.var_1525.name,this.var_1985.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_821.setText(_loc1_.name);
         this.var_1265.setText(_loc1_.description);
         this.var_1030.setText("");
         this.var_1262.setText("");
         ...
         this.setTag(this.var_1004,_loc1_.tags[0]);
         this.setTag(this.var_1003,_loc1_.tags[1]);
         if(this.var_1259)
         {
            if(_loc1_.allowPets)
            {
               this.var_1259.select();
            }
            else
            {
               this.var_1259.unselect();
            }
         }
         if(this.var_1263)
         {
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = this.var_821.getText();
         _loc2_.description = this.var_1265.getText();
         ...
         {
            _loc8_ = this.var_1030.getText();
            _loc9_ = this.var_1262.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_1030.clearErrors();
               this.var_1262.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = this.var_1259.isSelected;
         _loc2_.allowFoodConsume = this.var_1263.isSelected;
         _loc2_.allowWalkThrough = this.var_1266.isSelected;
         _loc2_.hideWalls = this.var_666.isSelected;
         _loc2_.tags = new Array();
         this.addTag(this.var_1004,_loc2_.tags);
         this.addTag(this.var_1003,_loc2_.tags);
         this.clearErrors();
         this.var_1258 = _loc2_.roomId;
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + this.var_389);
         this._navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",this.var_78.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(this._navigator.getXmlWindow("ros_room_delete_confirm")),this,this.onConfirmRoomDelete,[this.var_389]);
         _loc2_.show();
      }
      ...
      {
         var _loc10_:* = null;
         var _loc1_:IWindowContainer = IWindowContainer(this.var_277.findChildByName("flat_controller_list"));
         var _loc2_:IButtonWindow = IButtonWindow(this.var_277.findChildByName("remove_flat_ctrl"));
         var _loc3_:IButtonWindow = IButtonWindow(this.var_277.findChildByName("remove_all_flat_ctrls"));
         var _loc4_:IWindow = this.var_277.findChildByName("flat_ctrls_caption_txt");
         var _loc5_:IWindow = this.var_277.findChildByName("flat_ctrls_info_txt");
         var _loc6_:IWindow = this.var_277.findChildByName("flat_ctrls_limit_txt");
         var _loc7_:IWindowContainer = IWindowContainer(this.var_277.findChildByName("flat_controllers_footer"));
         Util.hideChildren(this.var_277);
         this.var_277.findChildByName("ruler").visible = true;
         ...
         if(this.var_78.controllers.length > 0)
         {
            ...
            Util.moveChildrenToColumn(this.var_277,["flat_ctrls_caption_txt","flat_ctrls_limit_txt","flat_controller_list","flat_ctrls_info_txt","flat_controllers_footer"],_loc4_.y,5);
         }
         else
         {
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_67,HabboWindowStyle.const_32,HabboWindowParam.const_61,new Rectangle(0,0,100,20)));
      }
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent) : void
      {
         ...
         this._navigator.send(new RemoveAllRightsMessageComposer(this.var_389));
      }
