package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         this.var_2528 = new RoomThumbnailRenderer(param1);
      ...
      private function refreshExtraCont() : void
      {
         ...
         this.var_1134.refreshTags(_loc1_,this.var_123.tags);
         ...
         this.var_2528.refreshThumbnail(_loc1_,this.var_123.thumbnail,false);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_270,Tabs.const_249,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
