package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_2528:RoomThumbnailRenderer;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_630 = new RoomInfoViewCtrl(this);
         this.var_1180 = new RoomCreateViewCtrl(this);
         this.var_2528 = new RoomThumbnailRenderer(this);
         this.var_1030 = new GuestRoomPasswordInput(this);
         this.var_297 = new GuestRoomDoorbell(this);
         this.var_432 = new Tabs(this);
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_293,HabboWindowStyle.const_43,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_630.registerToolbarEvents();
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         ...
         {
            this.var_181.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_156,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               this.var_181.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_156,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_181.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_55,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_307.startSearch(Tabs.const_270,Tabs.const_369,param1);
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_307.startSearch(Tabs.const_334,Tabs.const_260);
         this.var_432.getTab(Tabs.const_334).tabPageDecorator.tabSelected();
      }
