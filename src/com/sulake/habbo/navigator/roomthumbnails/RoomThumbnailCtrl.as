package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_1656 = IButtonWindow(this.find("bg_tab"));
         this.var_1657 = IButtonWindow(this.find("top_tab"));
         this.var_1658 = IButtonWindow(this.find("obj_tab"));
         this.var_2260 = IWindowContainer(this.find("tile_grid"));
         this.var_2261 = IWindowContainer(this.find("now_editing_container"));
         Util.setProcDirectly(this.find("save"),this.onSaveButton);
         Util.setProcDirectly(this.find("cancel"),this.onCancelButton);
         Util.setProcDirectly(this.var_1656,this.onBgTabButton);
         Util.setProcDirectly(this.var_1657,this.onTopTabButton);
         Util.setProcDirectly(this.var_1658,this.onObjTabButton);
      }
      ...
      {
         this.setEnabled(this.var_1656,this.var_68.mode != ThumbnailEditorModel.const_37);
         this.setEnabled(this.var_1657,this.var_68.mode != ThumbnailEditorModel.const_60);
         this.setEnabled(this.var_1658,this.var_68.mode != ThumbnailEditorModel.const_35);
      }
      
      private function refreshEditArea() : void
      {
         var _loc1_:IWindowContainer = this.var_2261;
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = this.var_2260;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_469)
            {
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(this._navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_67,HabboWindowStyle.const_32,HabboWindowParam.const_61,new Rectangle(0,0,param1.width,66)));
               param1.addListItem(_loc7_);
            }
            _loc10_ = _loc6_[_loc8_];
            _loc11_ = IRegionWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",WindowType.const_434,HabboWindowStyle.const_43,0 | 0,new Rectangle(_loc9_ * 66,0,66,66),this.onImgSel,_loc10_.id));
            _loc11_.mouseThreshold = 0;
            _loc12_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",HabboWindowType.const_293,HabboWindowStyle.const_43,HabboWindowParam.const_61,new Rectangle(0,0,66,66),this.onImgSel,_loc10_.id));
