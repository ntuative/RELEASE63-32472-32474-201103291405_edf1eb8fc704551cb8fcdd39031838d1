package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class ThumbnailImageConfiguration
   {
      ...
      public function getImg() : BitmapData
      {
         ...
         {
            this.var_1911 = this._navigator.getButtonImage(this.var_1910);
         }
      ...
      private function refreshListImg() : void
      {
         ...
         if(this.var_1913 == null)
         {
            ...
            this.var_1913 = new Rectangle(this.var_1481,this.var_1481,_loc1_.width - 2 * this.var_1481,_loc1_.height - 2 * this.var_1481);
         }
         this.var_650.bitmap.fillRect(this.var_650.bitmap.rect,4281545523);
         this.var_650.bitmap.fillRect(this.var_1913,4284900966);
         this.copyTo(this.var_650.bitmap);
         if(this._selected)
         {
            this.var_650.bitmap.copyPixels(this.var_1912,this.var_1912.rect,new Point(0,0),null,null,true);
         }
