package com.sulake.habbo.navigator
{
   ...
   public class TextFieldManager
   {
      ...
      public function TextFieldManager(param1:HabboNavigator, param2:ITextFieldWindow, param3:int = 1000, param4:Function = null, param5:String = null)
      {
         ...
         this.var_77.addEventListener(WindowKeyboardEvent.const_192,this.checkEnterPress);
         this.var_77.addEventListener(WindowEvent.const_103,this.checkMaxLen);
         this.var_2680 = this.var_77.textBackground;
         this._orgTextBackgroundColor = this.var_77.textBackgroundColor;
         this.var_2681 = this.var_77.textColor;
      }
      ...
      {
         this.var_77.textBackground = this.var_2680;
         this.var_77.textBackgroundColor = this._orgTextBackgroundColor;
         this.var_77.textColor = this.var_2681;
      }
      ...
      public function displayError(param1:String) : void
      {
         ...
         if(this.var_143 == null)
         {
            ...
            IWindowContainer(this.var_77.parent).addChild(this.var_143);
         }
         ...
         this.var_143.x += (this.var_77.width - this.var_143.width) / 2;
      ...
      public function goBackToInitialState() : void
      {
         ...
         {
            this.var_77.text = this.var_1408;
            this.var_652 = true;
         }
         else
         {
      ...
      {
         return !this.var_652 && Util.trim(this.getText()).length > 2;
      }
      ...
      private function onInputClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_77.text = this.var_2682;
         this.var_652 = false;
         this.restoreBackground();
      }
      ...
      private function checkMaxLen(param1:Event) : void
      {
         ...
         if(_loc2_.length > this.var_1915)
         {
            this.var_77.text = _loc2_.substring(0,this.var_1915);
         }
      }
   }
}
