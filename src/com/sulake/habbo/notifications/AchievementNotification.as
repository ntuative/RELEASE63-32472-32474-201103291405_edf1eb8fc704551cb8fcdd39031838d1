package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      private const const_2058:String = "achievement_bg_001_png";
      ...
      public function AchievementNotification(param1:String, param2:int, param3:int, param4:int, param5:int, param6:int, param7:int, param8:IAssetLibrary, param9:IHabboWindowManager, param10:IHabboLocalizationManager, param11:IHabboConfigurationManager, param12:IHabboCommunicationManager, param13:ISessionDataManager)
      {
         ...
         this.var_1521 = param7;
         this.var_2380 = param5;
         this.var_1978 = param6;
         this.var_69 = param10;
         this._assets = param8;
         this.var_295 = param13;
         ...
         this._window.center();
         this.var_2753 = this.var_69.getBadgeName(this.var_325);
         this.var_2756 = this.var_69.getBadgeDesc(this.var_325);
         this.var_2752 = this.var_69.getAchievementNameForFacebook(this.var_325,this.var_295.userName,this.var_295.realName,this.var_1522);
         this.var_2757 = this.var_69.getAchievementDescForFacebook(this.var_325,this.var_295.userName,this.var_295.realName,this.var_1522);
         this._desc = this.registerTextParameters("notifications.text.achievement");
         this.var_2755 = this.registerTextParameters("notifications.text.achievement_facebook");
         this._feedTitleFb = this.registerTextParameters("notifications.text.achievement_facebook_title");
         this.var_69.registerParameter("notifications.text.achievement.achievement_points","achievement_points",this.var_1688.toString());
         this.var_69.registerParameter("notifications.achievement.bonus.value","bonus_points",this.var_1521.toString());
         this.var_69.registerParameter("notifications.achievement.no_facebook","bonus_points",this.var_1521.toString());
         var _loc15_:IWindow = this._window.findChildByName("level_reward_points");
         var _loc16_:String = "notifications.text.achievement.reward." + this.var_1978;
         var _loc17_:String = this.var_1978 == 0 ? "pixels" : "activitypoints";
         this.var_69.registerParameter(_loc16_,_loc17_,"" + this.var_2380);
         _loc15_.caption = this.var_69.getKey(_loc16_);
         this.setBadge(param13.getBadgeImage(param1),this.const_1803);
         var _loc18_:BitmapData = (param8.getAssetByName(this.const_2058) as BitmapDataAsset).content as BitmapData;
      ...
      {
         this.var_69.registerParameter(param1,"badge_name",this.var_2753);
         this.var_69.registerParameter(param1,"badge_desc",this.var_2756);
         this.var_69.registerParameter(param1,"badge_name_fb",this.var_2752);
         this.var_69.registerParameter(param1,"badge_desc_fb",this.var_2757);
         this.var_69.registerParameter(param1,"level",this.var_1522.toString());
         this.var_69.registerParameter(param1,"name",this.var_295.userName);
         return this.var_69.registerParameter(param1,"realname",this.var_295.realName);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_295.events.removeEventListener(BadgeImageReadyEvent.const_152,this.onBadgeImageReady);
            this.var_295 = null;
         }
         if(this._window != null)
         {
      ...
      {
         HabboWebTools.facebookAchievementPost(this.var_325,this._feedTitleFb,this.var_2755,param1);
      }
