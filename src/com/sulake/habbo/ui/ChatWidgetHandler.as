   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener, IGetImageListener
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_428 != null)
         {
            ...
            {
               _loc2_ = this.var_428.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return [RoomWidgetChatMessage.const_838,RoomWidgetChatSelectAvatarMessage.const_642];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_838:
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_642:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           {
                              _loc13_ = this.var_428.getValue(_loc16_) as BitmapData;
                           }
                           _loc12_ = uint(this.var_608.getValue(_loc16_));
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                    ...
                                    default:
                                       ...
                                       if(_loc17_ != null)
                                       {
                                          ...
                                          if(_loc18_ != null)
                                          {
                                             ...
                                             this.var_608.add(_loc16_,_loc12_);
                                          }
                                       }
                                 }
                                 if(_loc13_ != null)
                                 {
                                    ...
                                    {
                                       this.var_428.add(_loc16_,_loc13_);
                                    }
                                 }
                              }
                           }
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_741 == null)
            {
               ...
               this.var_508.y = 0;
               this.var_508.z = 0;
               this.var_741 = _loc4_.getScreenPoint(this.var_508);
            ...
            this.var_508.y = 0;
            this.var_508.z = 0;
            _loc8_ = _loc4_.getScreenPoint(this.var_508);
            if(_loc8_ != null)
            {
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         if(this.var_428)
         {
            _loc2_ = this.var_428.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
               this.var_1139.push(_loc2_);
            }
         ...
         if(_loc3_ < 8)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(_loc7_ != 0)
                  {
                     this.var_608.add(param1,_loc7_);
                  }
               }
            }
         }
