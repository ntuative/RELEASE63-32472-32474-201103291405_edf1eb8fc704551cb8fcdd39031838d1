   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_317,this.onFigureUpdate);
            }
            if(this._inventory != null)
            {
               this._inventory.events.removeEventListener(HabboInventoryEffectsEvent.const_695,this.onAvatarEffectsChanged);
               this._inventory.events.removeEventListener(HabboInventoryHabboClubEvent.const_660,this.onHabboClubSubscriptionChanged);
            }
            if(this.var_181 != null)
            {
               this.var_181.events.removeEventListener(HabboToolbarEvent.const_65,this.onHabboToolbarEvent);
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_317,this.onFigureUpdate);
         }
         this._inventory = this._container.inventory;
         if(this._inventory != null)
         {
            this._inventory.events.addEventListener(HabboInventoryEffectsEvent.const_695,this.onAvatarEffectsChanged);
            this._inventory.events.addEventListener(HabboInventoryHabboClubEvent.const_660,this.onHabboClubSubscriptionChanged);
         }
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this.var_181 != null)
         {
            _loc5_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_1144,HabboToolbarIconEnum.MEMENU);
            if(_loc1_ != null)
            {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_760);
         _loc1_.push(RoomWidgetDanceMessage.const_655);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_771);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_822);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_915);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_808);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_792);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_356);
         _loc1_.push(RoomWidgetStopEffectMessage.const_769);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1559);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1154);
         _loc1_.push(RoomWidgetToolbarMessage.const_729);
         _loc1_.push(RoomWidgetToolbarMessage.const_786);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_353);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1603);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1078);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_916);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_874);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_887);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1677);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_673);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_772);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_850);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_874:
               ...
               break;
            case RoomWidgetWaveMessage.const_760:
               if(this._container != null && this._container.roomSession != null)
               {
                  this._container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_655:
               if(this._container != null && this._container.roomSession != null)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_771:
               if(this._inventory != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_822:
               if(this._inventory != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_915:
               if(this._inventory != null)
               {
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_356:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1029)
               {
               ...
               if(this._inventory != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_1134:
                        this._catalog.openCatalogPage(CatalogPageName.const_1674,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1123:
                     ...
                     case RoomWidgetOpenInventoryMessage.const_1458:
                        ...
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1690:
                        break;
                     default:
            ...
            case RoomWidgetStopEffectMessage.const_769:
            ...
            case RoomWidgetNavigateToRoomMessage.const_1154:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_916:
               if(this._container != null)
               {
                  this._container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_729:
               ...
               if(this.var_181)
               {
                  this.var_181.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_55,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(this._inventory != null)
                  {
                     _loc12_ = false;
            ...
            case RoomWidgetToolbarMessage.const_786:
               ...
               {
                  this.var_181.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_576,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_353:
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_887:
            ...
            case RoomWidgetStoreSettingsMessage.const_772:
               ...
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_400,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_850:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_733));
      }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_485:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_554));
         }
      }
