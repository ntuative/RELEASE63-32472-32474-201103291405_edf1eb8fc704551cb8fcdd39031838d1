package com.sulake.habbo.ui
{
   ...
   public class FurnitureTeaserWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_835,RoomWidgetViralFurniMessage.const_637,RoomWidgetViralFurniMessage.const_164];
      }
            ...
            case RoomWidgetFurniToWidgetMessage.const_835:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = new RoomWidgetTeaserDataUpdateEvent(RoomWidgetTeaserDataUpdateEvent.const_585);
                     _loc8_ = "+";
               ...
               break;
            case RoomWidgetViralFurniMessage.const_637:
      ...
      {
         return [RoomSessionViralFurniStatusEvent.const_460,RoomSessionViralFurniStatusEvent.const_505];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionViralFurniStatusEvent.const_460:
            ...
            case RoomSessionViralFurniStatusEvent.const_505:
               _loc2_ = param1 as RoomSessionViralFurniStatusEvent;
               _loc3_ = new RoomWidgetTeaserDataUpdateEvent(RoomWidgetTeaserDataUpdateEvent.const_755);
               _loc3_.campaignID = _loc2_.campaignID;
               _loc3_.status = _loc2_.status;
               _loc3_.data = _loc2_.shareId;
               _loc3_.itemCategory = _loc2_.itemCategory;
