package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private static const const_1373:int = 1000;
      ...
      private var var_1142:IRoomWidgetFactory = null;
      ...
      private var var_1070:IHabboHelp = null;
      ...
      public function RoomDesktop(param1:IRoomSession, param2:IAssetLibrary, param3:IConnection)
      {
         ...
         this.var_208 = new DesktopLayoutManager();
      }
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         {
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_358,this.onRoomContentLoaded);
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_438,this.onRoomContentLoaded);
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_827,this.onRoomContentLoaded);
         }
      }
      ...
      {
         this.var_181 = param1;
         this.var_181.events.addEventListener(HabboToolbarEvent.const_534,this.onToolbarRepositionEvent);
         this.var_181.events.addEventListener(HabboToolbarEvent.const_39,this.onHabboToolbarEvent);
      }
      
      public function set layout(param1:XML) : void
      {
         this.var_208.setLayout(param1,this._windowManager,this._config);
         if(this.var_181 != null)
         {
            this.var_208.toolbarSize = this.var_181.size;
            this.var_208.toolbarOrientation = this.var_181.orientation;
         }
      }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_790.length)
            {
               _loc6_ = this.var_790.getWithIndex(_loc1_) as IRoomWidgetHandler;
               if(_loc6_ != null)
               {
                  _loc6_.dispose();
               }
         ...
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_358,this.onRoomContentLoaded);
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_438,this.onRoomContentLoaded);
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_827,this.onRoomContentLoaded);
         }
         ...
         {
            this.var_181.events.removeEventListener(HabboToolbarEvent.const_534,this.onToolbarRepositionEvent);
         ...
         {
            this.var_515.reset();
            this.var_515.removeEventListener(TimerEvent.TIMER,this.onResizeTimerEvent);
            this.var_515 = null;
         }
         this.var_1878 = null;
      }
      ...
      public function init() : void
      {
         if(this._roomEngine != null && this.var_31 != null)
         {
            this.var_793 = this._roomEngine.loadRoomResources(this.var_31.roomResources);
         ...
         if(this.var_299 != null && this.var_31.state == RoomSessionEvent.const_226)
         {
            this.var_1879 = !this.var_299.showInterstitial();
         }
      ...
      {
         if(this.var_793 == null || this.var_793.length == 0)
         {
            return;
         }
         var _loc2_:int = this.var_793.indexOf(param1.contentType);
         if(_loc2_ != -1)
         {
            this.var_793.splice(_loc2_,1);
         }
         if(this.var_793.length == 0)
         {
            this.var_1880 = true;
      ...
      public function createWidget(param1:String) : void
      {
         ...
         _loc2_ = this.var_1142.createWidget(param1);
         if(_loc2_ == null)
         {
            return;
         }
         ...
         this.var_208.addWidgetWindow(_loc2_.mainWindow);
         ...
         if(_loc4_ != null)
         {
            ...
            if(!this.var_790.add(param1,_loc4_))
            {
               _loc4_.dispose();
            }
            _loc6_ = null;
            ...
            if(_loc7_ != null)
            {
               ...
               {
                  _loc6_ = this.var_791.getValue(_loc9_);
                  if(_loc6_ == null)
                  {
                     _loc6_ = [];
                     this.var_791.add(_loc9_,_loc6_);
                  }
                  else
                  {
            ...
            if(_loc8_ != null)
            {
               ...
               {
                  _loc6_ = this.var_792.getValue(_loc10_);
                  if(_loc6_ == null)
                  {
                     _loc6_ = [];
                     this.var_792.add(_loc10_,_loc6_);
                  }
                  _loc6_.push(_loc4_);
               }
            }
         ...
         {
            param1 = "null";
            _loc11_ = new RoomWidgetRoomViewUpdateEvent(param1,this.var_208.roomViewRect);
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         var _loc2_:Array = this.var_792.getValue(param1.type);
         if(_loc2_ != null)
         {
            for each(_loc3_ in _loc2_)
            {
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_774:
            ...
            case RoomEngineObjectEvent.const_481:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_157,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               break;
            case RoomEngineObjectEvent.const_732:
               if(!this.var_31.isRoomController && !this.var_295.isAnyRoomController)
               {
                  return;
               }
            ...
            case RoomEngineObjectEvent.const_136:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_1174,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               this.processWidgetMessage(_loc5_);
               break;
      ...
      public function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_493:
               ...
               break;
            case RoomEngineEvent.const_444:
               _loc2_ = new RoomWidgetRoomEngineUpdateEvent(RoomWidgetRoomEngineUpdateEvent.const_346,param1.roomId,param1.roomCategory);
         }
         if(_loc2_ != null)
         {
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         var _loc21_:* = null;
         var _loc2_:Rectangle = this.var_208.roomViewRect;
         ...
         if(_loc7_ != null)
         {
            ...
            _loc14_ = this._roomEngine.getRoomNumberValue(this.var_31.roomId,this.var_31.roomCategory,RoomVariableEnum.const_890);
            _loc15_ = this._roomEngine.getRoomNumberValue(this.var_31.roomId,this.var_31.roomCategory,RoomVariableEnum.const_926);
            _loc16_ = this._roomEngine.getRoomNumberValue(this.var_31.roomId,this.var_31.roomCategory,RoomVariableEnum.const_823);
         ...
         _loc10_.addEventListener(WindowMouseEvent.const_205,this.canvasMouseHandler);
         ...
         this.var_208.addRoomView(_loc9_);
      ...
      {
         var _loc3_:IWindowContainer = this.var_208.getRoomView() as IWindowContainer;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function getRoomViewRect() : Rectangle
      {
         ...
         return this.var_208.roomViewRect;
      }
      ...
      public function canvasMouseHandler(param1:Event) : void
      {
         ...
         switch(_loc2_.type)
         {
            ...
            case WindowMouseEvent.const_198:
               _loc3_ = "null";
               break;
            case WindowMouseEvent.const_205:
               _loc3_ = "null";
               break;
            default:
               return;
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         this.var_1878 = _loc2_.rectangle;
         this._roomEngine.modifyRoomCanvas(this.var_31.roomId,this.var_31.roomCategory,this.var_321[0],_loc2_.width,_loc2_.height);
         if(this.var_515 == null)
         {
            this.var_515 = new Timer(const_1373,1);
            this.var_515.addEventListener(TimerEvent.TIMER,this.onResizeTimerEvent);
         }
         else
         {
            this.var_515.reset();
      ...
      private function onResizeTimerEvent(param1:TimerEvent) : void
      {
         ...
         this.events.dispatchEvent(new RoomWidgetRoomViewUpdateEvent(_loc2_,this.var_1878));
      }
      ...
      private function onToolbarRepositionEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            this.var_208.toolbarOrientation = param1.orientation;
         }
      }
      ...
      private function trackZoomTime(param1:Boolean) : void
      {
         ...
         {
            _loc2_ = getTimer();
            _loc3_ = Math.round((_loc2_ - this.var_1881) / 1000);
            if(this._habboTracking != null)
            {
               if(param1)
               {
                  this._habboTracking.track("zoomEnded","RoomSession",_loc3_);
               }
               else
               {
      ...
      public function update() : void
      {
         ...
         var _loc1_:int = this.var_380.length;
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
            _loc3_ = this.var_380.getWithIndex(_loc2_) as IRoomWidgetHandler;
            if(_loc3_ != null)
            {
               _loc3_.update();
            }
      ...
      {
         if(this.var_15 != null && this.var_31 != null && this.var_1879 && this.var_1880)
         {
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_511:
               ...
               this.var_228 = this._windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_349,WindowStyle.const_759,WindowParam.const_98) as IToolTipWindow;
               this.var_228.setParamFlag(WindowParam.const_30,false);
      ...
      public function addUpdateListener(param1:IRoomWidgetHandler) : void
      {
         ...
         if(this.var_380.indexOf(param1) == -1)
         {
      ...
      public function removeUpdateListener(param1:IRoomWidgetHandler) : void
      {
         ...
         var _loc2_:int = this.var_380.indexOf(param1);
         if(_loc2_ != -1)
         {
            this.var_380.splice(_loc2_,1);
         }
      }
   }
}
