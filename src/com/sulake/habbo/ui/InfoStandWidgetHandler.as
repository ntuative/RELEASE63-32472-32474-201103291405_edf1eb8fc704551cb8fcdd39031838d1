   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_168,this.onUserTags);
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_168,this.onUserTags);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_575.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_575.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_404);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_830);
         _loc1_.push(RoomWidgetGiveBadgeMessage.GIVE_BADGE);
         _loc1_.push(RoomWidgetFurniActionMessage.const_178);
         _loc1_.push(RoomWidgetFurniActionMessage.const_550);
         _loc1_.push(RoomWidgetFurniActionMessage.const_557);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_832);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_847);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_763);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1662);
         _loc1_.push(RoomWidgetPetCommandMessage.const_577);
         _loc1_.push(RoomWidgetPetCommandMessage.const_668);
         _loc1_.push(RoomWidgetUserActionMessage.const_527);
         _loc1_.push(RoomWidgetUserActionMessage.const_363);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_674);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            else if(param1.type == RoomWidgetUserActionMessage.const_363 || param1.type == RoomWidgetUserActionMessage.const_527 || param1.type == RoomWidgetUserActionMessage.const_510)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_404:
            ...
            case RoomWidgetUserActionMessage.const_818:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1216,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_825:
               ...
               break;
            case RoomWidgetUserActionMessage.const_830:
            ...
            case RoomWidgetRoomTagSearchMessage.const_832:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_847:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_763:
            ...
            case RoomWidgetUserActionMessage.const_664:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_668:
            ...
            case RoomWidgetPetCommandMessage.const_577:
               ...
               break;
            case RoomWidgetChangeMottoMessage.const_674:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_337);
               _loc6_.id = param1.id;
               ...
               if(_loc8_.getString(RoomWidgetEnum.const_548) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetEnum.const_548);
               }
               ...
               {
                  _loc26_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_291);
               ...
               _loc11_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1066);
               _loc12_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1132);
            ...
            case RoomObjectCategoryEnum.const_34:
               ...
               if(_loc13_.type == RoomObjectTypeEnum.const_182)
               {
               ...
               {
                  if(_loc13_.type != RoomObjectTypeEnum.const_806)
                  {
                     return null;
                  }
                  _loc14_ = "null";
               ...
               if(_loc19_ != null)
               {
                  _loc15_.carryItem = _loc19_.getModel().getNumber(RoomObjectVariableEnum.const_467);
               }
               if(_loc14_ == RoomWidgetUserInfoUpdateEvent.const_113)
               {
                  _loc15_.realName = this._container.sessionDataManager.realName;
               }
               if(_loc14_ == RoomWidgetUserInfoUpdateEvent.const_138)
               {
                  ...
                  if(_loc19_ != null)
                  {
                     _loc33_ = _loc19_.getModel().getString(RoomObjectVariableEnum.const_807);
                  ...
                  if(!_loc29_)
                  {
                     _loc15_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1226;
                  }
                  if(!_loc30_)
                  {
                     _loc15_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1043;
                  }
               ...
               if(_loc14_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc16_.push(RoomWidgetUserInfoUpdateEvent.const_1584);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_575.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_575.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_807);
