package com.sulake.habbo.ui
{
   ...
   public class WelcomeGiftWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function addMessageEvents() : void
      {
         ...
         this.var_702 = [];
         this.var_702.push(new WelcomeGiftStatusEvent(this.method_5));
         this.var_702.push(new ChangeEmailResultEvent(this.onChangeEmailResult));
      ...
      {
         var _loc1_:* = null;
         if(!this._container || !this._container.connection || !this.var_702)
         {
            return;
         }
         for each(_loc1_ in this.var_702)
      ...
      private function method_5(param1:WelcomeGiftStatusEvent) : void
      {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetFurniActionMessage.const_801);
         _loc1_.push(RoomWidgetChangeEmailMessage.const_905);
         return _loc1_;
      }
