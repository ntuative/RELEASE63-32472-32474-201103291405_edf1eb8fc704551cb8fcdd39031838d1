package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private const const_1340:String = "room_view";
      ...
      public function setLayout(param1:XML, param2:IHabboWindowManager, param3:IHabboConfigurationManager) : void
      {
         ...
         while(_loc6_ < this.var_52.numChildren)
         {
            ...
            {
               _loc5_.addEventListener(WindowEvent.const_288,this.trimContainer);
            }
            _loc6_++;
         }
      }
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = this.var_52.getChildByTag(this.const_1340) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function set toolbarOrientation(param1:String) : void
      {
         ...
         switch(param1)
         {
            case "LEFT":
               ...
               _loc2_.width = this.var_52.desktop.width - this.var_753;
               _loc2_.y = 0;
            ...
            case "TOP":
               ...
               _loc2_.height = this.var_52.desktop.height - this.var_753;
               break;
            case "BOTTOM":
               _loc2_.x = 0;
               _loc2_.width = this.var_52.desktop.width;
      ...
      public function get roomViewRect() : Rectangle
      {
         ...
         var _loc1_:IWindowContainer = this.var_52.findChildByTag(this.const_1340) as IWindowContainer;
         if(!_loc1_)
         {
            return null;
         }
