package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_427:uint = 3;
      ...
      private var var_1000:IWindowRenderer;
      
      private var var_970:ISkinContainer;
      
      private var var_272:Array;
      
      private var var_1477:IEventDispatcher;
      
      private var var_1230:Boolean = false;
      
      private var var_1893:ProfilerOutput;
      
      private var var_1476:ProfilerAgentTask;
      
      private var var_1475:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_970 = new SkinContainer(_loc4_.content as XML,assets);
         this.var_1000 = new WindowRenderer(this.var_970);
         this._windowContextArray = new Array(const_427);
         ...
         var _loc6_:int = 0;
         while(_loc6_ < const_427)
         {
            this._windowContextArray[_loc6_] = new WindowContext("layer_" + _loc6_,this.var_1000,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this.var_256 = this._windowContextArray[const_1377];
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1893)
            {
               this.var_1893 = new ProfilerOutput(context,this,this.var_1000);
            }
            this.var_1893.profiler = _loc3_;
            this.var_1476 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1476);
            this.var_1475 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1475);
            this.var_1230 = true;
         }
      }
      ...
      {
         return this.var_970.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            this.var_1477.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_427 - 1;
            while(_loc2_ >= 0)
            {
         ...
         this.var_1477.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_427)
         {
         ...
         this.var_1477.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1735,new Date().getTime().toString());
