package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1654:uint = 0;
      ...
      public static const const_1479:uint = 16;
      
      public static const const_1984:uint = 64;
      
      public static const const_2001:uint = 128;
      
      public static const const_1164:uint = 256;
      
      protected static var var_565:uint = 0;
      
      protected static var var_334:uint = 0;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_1586:
               ...
               break;
            case GraphicContext.const_1479:
            ...
            case GraphicContext.const_1164:
               break;
            case GraphicContext.const_1654:
               break;
            default:
         ...
         if(this.var_850)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_334 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2083,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2083,16777215);
                  }
                  var_334 += bitmap.width * bitmap.height * 4;
               }
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(this.var_850)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_334 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
