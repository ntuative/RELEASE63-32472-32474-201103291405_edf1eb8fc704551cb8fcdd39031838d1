package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1403:String = "skin";
      
      private static const const_1401:String = "bitmap";
      
      private static const const_1398:String = "fill";
      
      private static const const_1402:String = "text";
      
      private static const const_1399:String = "label";
      ...
      private var var_2706:Dictionary;
      
      private var var_2705:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_2704 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1935,this.var_2704);
         this.var_2706 = new Dictionary();
         this.var_2705 = new Dictionary();
         StateCodeTable.fillTables(this.var_2706,this.var_2705);
         this.var_454 = new Dictionary();
         this.var_454[const_1403] = BitmapSkinRenderer;
         this.var_454[const_1401] = BitmapDataRenderer;
         this.var_454[const_1398] = FillSkinRenderer;
         this.var_454[const_1402] = TextSkinRenderer;
         this.var_454[const_1399] = LabelRenderer;
         this.var_454[const_1400] = ShapeSkinRenderer;
         this.var_454[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_454[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_335 == null)
         {
            var_335 = new Array();
            var_335.push(WindowState.const_71);
            var_335.push(WindowState.const_83);
            var_335.push(WindowState.const_101);
            var_335.push(WindowState.const_54);
            var_335.push(WindowState.const_99);
            var_335.push(WindowState.const_84);
            var_335.push(WindowState.const_105);
            var_335.push(WindowState.const_95);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_2848 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         ...
         {
            this.var_1017[param1] = new Array(const_1005);
         }
         this.var_1017[param1][param2] = param3;
         if(this.var_1018[param1] == null)
         {
            this.var_1018[param1] = new Array(const_1005);
         }
         this.var_1018[param1][param2] = param4;
      }
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_1018[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_174)
