package com.sulake.core.window.graphics.renderer
{
   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_853:Dictionary;
      ...
      public function BitmapSkinRenderer(param1:String)
      {
         ...
         this.var_853 = new Dictionary(false);
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            this.var_854 = null;
            for(_loc1_ in this.var_853)
            {
               _loc2_ = this.var_853[_loc1_] as BitmapData;
               _loc2_.dispose();
               delete this.var_853[_loc1_];
            }
            this.var_853 = null;
         }
      }
      ...
      override public function draw(param1:IWindow, param2:IBitmapDrawable, param3:Rectangle, param4:uint, param5:Boolean) : void
      {
         ...
         var _loc7_:ISkinLayout = var_463[param4];
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            while(_loc16_ < _loc9_)
            {
               ...
               if(_loc11_ != null)
               {
                  ...
                  if(_loc10_.scaleH == SkinLayoutEntity.const_298)
                  {
                     var_35.x += _loc14_;
                  }
                  else if(_loc10_.scaleH == SkinLayoutEntity.const_596)
                  {
                     _loc12_ = true;
                  ...
                  else if(_loc10_.scaleH == SkinLayoutEntity.const_329)
                  {
                     _loc12_ = true;
                     var_35.right += _loc14_;
                     if(true)
                  ...
                  if(_loc10_.scaleV == SkinLayoutEntity.const_298)
                  {
                     var_35.y += _loc15_;
                  }
                  else if(_loc10_.scaleV == SkinLayoutEntity.const_596)
                  {
                     _loc13_ = true;
                  ...
                  else if(_loc10_.scaleV == SkinLayoutEntity.const_329)
                  {
                     _loc13_ = true;
                     var_35.bottom += _loc15_;
                     if(true)
                  ...
                  else if(_loc10_.scaleV == SkinLayoutEntity.const_329 || _loc10_.scaleH == SkinLayoutEntity.const_329)
                  {
                  ...
                  {
                     this.var_1016.a = 0 / _loc17_.width;
                     this.var_1016.d = 0 / _loc17_.height;
                     _loc30_ = new BitmapData(var_35.width,var_35.height,false);
                     _loc30_.draw(_loc17_,this.var_1016);
                     _loc31_ = new BitmapData(var_35.width,var_35.height,true,0);
                     _loc31_.draw(_loc18_,this.var_1016,null);
      ...
      protected function drawStaticLayoutEntity(param1:BitmapData, param2:Rectangle, param3:ISkinLayout, param4:ISkinLayoutEntity, param5:ISkinTemplate, param6:ISkinTemplateEntity) : void
      {
         ...
         switch(param6.type)
         {
            case "bitmap":
               ...
               if(param4.scaleH == SkinLayoutEntity.const_298)
               {
                  _loc7_.x += param2.width - param3.width;
               }
               if(param4.scaleV == SkinLayoutEntity.const_298)
               {
      ...
      private function getAlphaFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc6_:* = null;
         var _loc3_:String = param2 + "@" + param1.name;
         var _loc4_:BitmapData = this.var_853[_loc3_];
         if(_loc4_ == null)
         {
            _loc5_ = param1.getChildByName(param2) as ISkinTemplateEntity;
            if(_loc5_ == null)
