package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      private static const const_626:String = "{";
      
      private static const const_625:String = "}";
      
      private static const const_1406:String = "/*";
      
      private static const const_1405:String = "*/";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_88[const_193],var_88[ITALIC],var_88[BOLD]];
            var_88.reset();
            var_88[const_193] = _loc5_[0];
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_625);
         if(countSubStrings(param1,const_626) != countSubStrings(param1,const_625))
         {
            throw new Error("Mismatching amount of \"" + const_626 + "\" versus \"" + const_625 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1406) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1405) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_626)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
