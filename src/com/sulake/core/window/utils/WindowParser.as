package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1913:String = "_INCLUDE";
      
      public static const const_1866:String = "_TEMP";
      
      private static const const_1446:String = "layout";
      
      private static const const_1019:String = "window";
      
      private static const const_1021:String = "variables";
      
      private static const const_1020:String = "filters";
      
      private static const const_431:String = "name";
      
      private static const const_1436:String = "style";
      
      private static const const_633:String = "params";
      
      private static const const_1445:String = "tags";
      ...
      private static const const_1435:String = "visible";
      
      private static const const_1443:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_4:String = "background";
      
      private static const const_1204:String = "blend";
      
      private static const const_1442:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1439:String = "treshold";
      
      private static const const_1437:String = "children";
      
      private static const const_1440:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1441:String = "height_min";
      
      private static const const_1438:String = "height_max";
      ...
      private static const const_1444:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1434:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1316:Dictionary;
      
      protected var var_1317:Dictionary;
      
      protected var var_1058:Dictionary;
      
      protected var var_1575:Dictionary;
      
      protected var var_2101:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this.var_1316,this.var_1317);
         this.var_1058 = new Dictionary();
         this.var_1575 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1058,this.var_1575);
         this.var_2101 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1434,const_50);
         return param1.replace(const_1444,const_50);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_1316)
            {
               delete this.var_1316[_loc1_];
            }
            for(_loc1_ in this.var_1317)
            {
               delete this.var_1317[_loc1_];
            }
            for(_loc1_ in this.var_1058)
            {
               delete this.var_1058[_loc1_];
            }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1446)
         {
            _loc8_ = param1.child(const_1021);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_1020).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
            ...
            _loc4_ = param1.child(const_1019);
         ...
         if(param1.localName() == const_1019)
         {
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1316[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_431,variables,"")));
         style = uint(this.parseAttribute(xml,const_1436,variables,style));
         params = uint(this.parseAttribute(xml,const_633,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1445,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_166));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_166));
         rect.width = Number(this.parseAttribute(xml,name_5,variables,const_166));
         rect.height = Number(this.parseAttribute(xml,name_1,variables,const_166));
         visible = this.parseAttribute(xml,const_1435,variables,visible.toString()) == const_634;
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_633).length() > 0)
         {
            list = xml.child(const_633).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
               node = list[i];
               param = this.parseAttribute(node,const_431,variables,"") as String;
               if(this.var_1058[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_431)) + "\"!");
               }
               params |= this.var_1058[param];
               i++;
            }
         }
         caption = !!(params & 0) ? (!!parent ? parent.caption : const_50) : const_50;
         caption = unescape(String(this.parseAttribute(xml,const_1443,variables,caption)));
         if(tag != const_50)
         {
            tags = tag.split(const_1378);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_1021)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1440,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1441,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1438,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_4,variables,window.background.toString()) == const_634;
         blend = Number(this.parseAttribute(xml,const_1204,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1442,variables,window.clipping.toString()) == const_634;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1439,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_1020).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_50;
         var _loc3_:String = this.var_1317[param1.type];
