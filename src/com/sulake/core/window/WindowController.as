package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private var var_359:Rectangle;
      
      private var var_2390:uint;
      ...
      {
         var_466 = param1;
         var_237 = !!var_466 ? uint(var_237 | var_559) : uint(var_237 & 16777215);
      ...
      public function set color(param1:uint) : void
      {
         ...
         var_237 = !!var_466 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_11,WindowRedrawFlag.REDRAW);
      }
      ...
      {
         var_559 = param1 << 24;
         var_237 = !!var_466 ? uint(var_559 | var_237) : uint(16777215 & var_237);
         _context.invalidate(this,var_11,WindowRedrawFlag.REDRAW);
      }
      ...
      public function set blend(param1:Number) : void
      {
         ...
         _context.invalidate(this,var_11,WindowRedrawFlag.const_1204);
      }
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            _state = param1;
            _loc2_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_573,this,null);
      ...
      public function set style(param1:uint) : void
      {
         ...
         {
            var_83 = param1;
            _loc2_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_545,this,null);
            this.update(this,_loc2_);
            _loc2_.recycle();
         }
      }
      ...
      public function set clipping(param1:Boolean) : void
      {
         ...
         {
            var_686 = param1;
            _loc2_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_447,this,null);
            this.update(this,_loc2_);
            _loc2_.recycle();
         }
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this._parent != param1)
         {
            ...
            if(this._parent != null)
            {
               this.var_359 = this._parent.rectangle.clone();
               var_62.x = var_11.x;
               var_62.y = var_11.y;
               var_62.width = var_11.width;
               var_62.height = var_11.height;
               _loc4_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_546,this,this._parent);
            ...
            else
            {
               this.var_359.x = 0;
               this.var_359.y = 0;
               this.var_359.width = 0;
               this.var_359.height = 0;
               _loc4_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1210,this,_loc2_);
               this.update(this,_loc4_);
            }
            _loc4_.recycle();
         }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         ...
         {
            this.var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_814,var_11);
            this.var_21.visible = var_319;
         }
         return this.var_21;
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_83,var_19,_context,var_11,null,this.var_685,this.properties,var_852.concat(),_id) as WindowController;
         _loc2_.var_465 = var_465;
         _loc2_.var_175 = this.var_175;
         _loc2_._debug = this._debug;
         _loc2_.var_359 = this.var_359.clone();
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + this.var_2390 + "]";
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            else if(_loc7_ == WindowParam.const_587)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc9_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1122,this,null,true);
            ...
            if(_loc6_)
            {
               _loc9_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_871,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               _loc9_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_579,this,null);
               this.update(this,_loc9_);
               _loc9_.recycle();
            }
            if(_loc6_)
            {
               _loc9_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_208,this,null);
               this.update(this,_loc9_);
               _loc9_.recycle();
            }
         }
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_41:
                  ...
                  if(testParamFlag(WindowParam.const_408))
                  {
                     _loc3_ = {};
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_228))
                        {
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_208:
                  ...
                  if(param1 == this)
                  {
                     _loc6_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_542,this,null);
                     this.notifyChildren(_loc6_);
                     _loc6_.recycle();
                     if(testParamFlag(WindowParam.const_190,WindowParam.const_171))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_177,WindowParam.const_167))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this._parent != null)
                     {
                        ...
                        if(testParamFlag(WindowParam.const_450))
                        {
               ...
               case WindowNotifyEvent.const_579:
                  _context.invalidate(this,var_11.union(var_62),WindowRedrawFlag.const_514);
                  if(param1 == this)
                  {
                     _loc6_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1032,this,null);
                     this.notifyChildren(_loc6_);
                     _loc6_.recycle();
                     if(this._parent != null)
                     {
                        _loc6_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_282,this._parent,this);
                        this._parent.update(this,_loc6_);
                        _loc6_.recycle();
                     }
                  }
               ...
               case WindowNotifyEvent.const_348:
                  if(param1 == this)
                  {
                     _loc6_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_902,this,null);
                     this.notifyChildren(_loc6_);
                     _loc6_.recycle();
                     if(this._parent != null)
                     {
               ...
               case WindowNotifyEvent.const_573:
                  _context.invalidate(this,var_11,WindowRedrawFlag.const_1114);
                  break;
               ...
               case WindowNotifyEvent.const_447:
                  if(!(var_19 & 0))
                  {
                     if(!this.var_21)
                     {
                        ...
                        _context.invalidate(this,var_11,WindowRedrawFlag.const_514);
                     }
                  }
                  else if(var_19 & 0)
                  {
               ...
               case WindowNotifyEvent.const_542:
                  this._parent.getRegionProperties(null,this.var_359);
                  this.updateScaleRelativeToParent();
                  break;
      ...
      protected function forwardNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_1261:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1709:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1566:
               _loc2_ = "null";
               break;
         ...
         if(this.var_175 && var_465 > 0)
         {
            if(!testParamFlag(WindowParam.const_33))
            {
               if(param1.x <= var_11.width && param1.y <= var_11.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(const_966,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(const_966,param3,param1)) : false;
            }
         }
      ...
      public function setStateFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(_state != _loc3_)
         {
            _loc4_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_573,this,null);
            this.update(this,_loc4_);
            _loc4_.recycle();
         }
      }
      ...
      public function setStyleFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_83 != _loc3_)
         {
            _loc4_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_545,this,null);
            this.update(this,_loc4_);
            _loc4_.recycle();
         }
      }
      ...
      public function setParamFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_19 != _loc3_)
         {
            _loc4_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_447,this,null);
            this.update(this,_loc4_);
            _loc4_.recycle();
         }
      }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc2_:* = !testParamFlag(WindowParam.const_131,WindowParam.const_167);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               _loc4_ = this._parent.width - this.var_359.width;
            ...
            if(_loc2_)
            {
               _loc4_ = this._parent.height - this.var_359.height;
               _loc5_ = uint(var_19 & 0);
      ...
      {
         if(_state == WindowState.const_509)
         {
            return true;
         }
         _state = WindowState.const_509;
      ...
      public function minimize() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1094,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      {
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1086,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function deactivate() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1251,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1169,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1189,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function enable() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1186,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         var _loc3_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_361,this,param1);
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         var _loc4_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_361,this,param1);
         this.update(this,_loc4_);
         _loc4_.recycle();
         return param1;
      }
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         var _loc4_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_826,this,param1);
         this.update(this,_loc4_);
         _loc4_.recycle();
         return param1;
      }
