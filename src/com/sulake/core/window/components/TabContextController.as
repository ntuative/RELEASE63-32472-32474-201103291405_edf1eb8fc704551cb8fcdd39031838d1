package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1423:String = "_SELECTOR";
      
      private static const const_1422:String = "_CONTENT";
       
      
      protected var var_1057:ITabSelectorWindow;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1057 = findChildByTag(const_1423) as ITabSelectorWindow;
            if(this.var_1057 != null)
            {
               this.var_1057.procedure = this.selectorEventProc;
            }
         }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_2098 = findChildByTag(const_1422) as IWindowContainer;
         }
      ...
      {
         return this.var_1057.numSelectables;
      }
