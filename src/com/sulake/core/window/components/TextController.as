package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_805 ? true : null;
         }
      ...
      {
         this.var_855 = param1;
         this._field.scrollH = this.var_855 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_855 * this.maxScrollH,this.var_562 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.antiAliasType != null ? this._field.antiAliasType != _loc2_.antiAliasType : this._field.antiAliasType != PropertyDefaults.const_1045) ? new PropertyStruct(PropertyDefaults.const_876,this._field.antiAliasType,PropertyStruct.const_56,this._field.antiAliasType != AntiAliasType.NORMAL,PropertyDefaults.const_1103) : PropertyDefaults.const_1534);
         _loc1_.push(this._autoSize != PropertyDefaults.const_1155 ? new PropertyStruct(PropertyDefaults.const_779,this._autoSize,PropertyStruct.const_56,true,PropertyDefaults.const_1145) : PropertyDefaults.const_1612);
         ...
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1203 ? new PropertyStruct(PropertyDefaults.const_1253,this._field.gridFitType,PropertyStruct.const_56,true,PropertyDefaults.const_1230) : PropertyDefaults.const_1489);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_882) ? new PropertyStruct(PropertyDefaults.const_394,this._field.textColor,PropertyStruct.const_154,true) : PropertyDefaults.const_1185);
         _loc1_.push(this.var_455 != TextStyleManager.const_193 ? new PropertyStruct(PropertyDefaults.const_391,this.var_455,PropertyStruct.const_56,true,PropertyDefaults.const_927) : PropertyDefaults.const_1087);
         _loc1_.push(this.var_40.left != PropertyDefaults.const_860 ? new PropertyStruct(PropertyDefaults.const_251,this.var_40.left,PropertyStruct.const_42,true) : PropertyDefaults.const_544);
         _loc1_.push(this.var_40.top != PropertyDefaults.const_912 ? new PropertyStruct(PropertyDefaults.const_230,this.var_40.top,PropertyStruct.const_42,true) : PropertyDefaults.const_569);
         _loc1_.push(this.var_40.right != PropertyDefaults.const_907 ? new PropertyStruct(PropertyDefaults.const_269,this.var_40.right,PropertyStruct.const_42,true) : PropertyDefaults.const_433);
         _loc1_.push(this.var_40.bottom != PropertyDefaults.const_785 ? new PropertyStruct(PropertyDefaults.const_266,this.var_40.bottom,PropertyStruct.const_42,true) : PropertyDefaults.const_564);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1082 ? new PropertyStruct(PropertyDefaults.const_861,this._field.mouseWheelEnabled,PropertyStruct.const_38,true) : PropertyDefaults.const_1561);
         ...
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_277,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_277,this._field.thickness != 0));
         ...
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_277,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
