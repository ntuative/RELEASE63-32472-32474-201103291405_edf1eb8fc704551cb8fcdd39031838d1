package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         this.var_2513 = _loc2_.textWidth;
         this.var_2514 = _loc2_.textHeight;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_367 != _loc2_.color : this.var_367 != null && this.var_367 != PropertyDefaults.const_882) ? new PropertyStruct(PropertyDefaults.const_394,this.var_367,PropertyStruct.const_154,true) : PropertyDefaults.const_1185);
         if(this.var_40)
         {
            if(this.var_40.left != PropertyDefaults.const_860)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_251,this.var_40.left,PropertyStruct.const_42,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_544);
            }
            if(this.var_40.top != PropertyDefaults.const_912)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_230,this.var_40.top,PropertyStruct.const_42,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_569);
            }
            if(this.var_40.right != PropertyDefaults.const_907)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_269,this.var_40.right,PropertyStruct.const_42,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_433);
            }
            if(this.var_40.bottom != PropertyDefaults.const_785)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_266,this.var_40.bottom,PropertyStruct.const_42,true));
            }
            else
            {
