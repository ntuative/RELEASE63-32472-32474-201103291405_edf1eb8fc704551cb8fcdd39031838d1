package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      public function set selection(param1:int) : void
      {
         ...
         var _loc2_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_562,this,null,true);
         ...
         if(!_loc2_.isWindowOperationPrevented())
         {
            ...
            this.var_583 = param1;
            this.closeMenuView();
            _loc2_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_366,this,null);
            this.update(this,_loc2_);
         }
         _loc2_.recycle();
      }
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(this.var_182 == null || this.var_182.disposed)
         {
            this.var_182 = context.create(name + "::submenu","",WindowType.const_489,var_83,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_885 = false;
            this.getTitleLabel().text = this.var_583 < this.var_248.length && this.var_583 > -1 ? this.var_248[this.var_583] : caption;
         }
      }
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_499,var_83,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_388,var_83,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         _loc4_.addListItem(_loc10_);
         _loc4_.autoArrangeItems = true;
         this.fitToDesktop(param2);
         param2.activate();
         if(this.var_583 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(this.var_583).setStateFlag(WindowState.const_54,true);
         }
      }
      ...
      {
         var _loc3_:* = 0;
         if(param1.type == WindowMouseEvent.const_41 || param1.type == WindowTouchEvent.const_490)
         {
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_58:
               ...
               break;
            case WindowTouchEvent.const_739:
      ...
      public function open() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1081,this,null);
      ...
      public function close() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1030,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_248.length)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_648,this.var_248,PropertyStruct.const_128,true));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_648)
            {
