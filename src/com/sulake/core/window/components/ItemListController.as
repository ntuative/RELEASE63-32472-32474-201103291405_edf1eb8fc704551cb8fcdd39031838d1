package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_2915:Number = 0.0;
      
      protected var var_2916:Number = 0.0;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_175 = var_466 || !testParamFlag(WindowParam.const_33);
         this._container = _context.create("_CONTAINER","",WindowType.const_388,WindowStyle.const_759,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         this._container.addEventListener(WindowEvent.const_48,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_589,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_288,this.containerEventHandler);
      ...
      {
         return new Rectangle(this.var_688 * this.maxScrollH,this.var_689 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         if(param1 != this.var_688)
         {
            this.var_688 = param1;
            this._container.x = -this.var_688 * this.maxScrollH;
            _context.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.REDRAW);
            dispatchEvent(new WindowEvent(WindowEvent.const_464,this,null));
         }
      }
      ...
      {
         this.var_2915 = Math.max(param1,0);
      }
      
      public function set scrollStepV(param1:Number) : void
      {
         this.var_2916 = Math.max(param1,0);
      }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            ...
            {
               this._container.setParamFlag(WindowParam.const_450,param1);
            }
         }
      }
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_589,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_288,this.containerEventHandler);
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_41:
               this.var_2086 = _loc3_;
               this.var_2088 = _loc4_;
               this.var_1304 = 0;
               this.var_1307 = 0;
               this.var_1306 = true;
               _loc2_ = true;
            ...
            case WindowMouseEvent.const_205:
               if(this.var_1306)
               {
                  this.var_1304 = this.var_2086 - _loc3_;
                  this.var_1307 = this.var_2088 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1304 != 0 && this.var_110 != 0)
                     {
                        this.scrollH += this.var_1304 / this.var_110;
                     }
                  }
                  else if(this.var_1307 != 0 && this.var_95 != 0)
                  {
                     this.scrollV += this.var_1307 / this.var_95;
                  }
                  this.var_2086 = _loc3_;
                  this.var_2088 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_198:
               if(this.var_1306)
               {
                  ...
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1307);
                  }
                  this.var_1306 = false;
                  _loc2_ = true;
               }
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_1051 && !this.var_560 && this._container)
         {
            this.var_560 = true;
      ...
      override public function get properties() : Array
      {
         ...
         if(this._spacing != PropertyDefaults.const_680)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_399,this._spacing,PropertyStruct.const_42,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1074);
         }
         if(this.var_1051 != PropertyDefaults.const_1025)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_828,this.var_1051,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1734);
         }
         if(this.var_467 != PropertyDefaults.const_1040)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_821,this.var_467,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1671);
         }
         if(this.var_1305 != PropertyDefaults.const_1166)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_870,this.var_1305,PropertyStruct.const_38,true));
         }
         else
         {
