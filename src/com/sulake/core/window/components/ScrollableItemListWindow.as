package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_460:IScrollbarWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_460)
         {
            this.var_460.removeEventListener(WindowEvent.const_315,this.scrollBarEventProc);
            this.var_460.removeEventListener(WindowEvent.const_255,this.scrollBarEventProc);
            this.var_460 = null;
         }
         if(this.var_1288)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1288)
         {
            this.var_1288 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_460)
         {
            this.var_460 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_460)
            {
               this.var_460.addEventListener(WindowEvent.const_315,this.scrollBarEventProc);
               this.var_460.addEventListener(WindowEvent.const_255,this.scrollBarEventProc);
            }
         }
         return this.var_460;
      }
