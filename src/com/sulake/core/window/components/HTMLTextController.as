package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private var var_946:String = "RoomPropertyMessageParser";
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1167 == param2)
         {
            return;
         }
         param1.var_1167 = param2;
         param1.var_1787 = null;
         if(param1.var_1167 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1167);
      ...
      {
         if(PropertyDefaults.const_791.indexOf(param1) > -1)
         {
            this.var_946 = param1;
         }
      }
      ...
      {
         return this.var_946 == LinkTarget.const_32 ? defaultLinkTarget : this.var_946;
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_687)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_946 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_672,this.var_946,PropertyStruct.const_56,true,PropertyDefaults.const_791));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            {
               this.var_946 = _loc2_.value as String;
               break;
            }
