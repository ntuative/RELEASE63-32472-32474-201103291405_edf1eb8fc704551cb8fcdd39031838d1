package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1363:String = "_TITLE";
      
      private static const const_1427:String = "_HEADER";
      
      private static const const_1429:String = "_CONTENT";
      
      private static const const_1428:String = "_SCALER";
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1363) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1541 = findChildByTag(const_1427) as IHeaderWindow;
            if(!this.var_1541)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_193 = findChildByTag(const_1429) as IWindowContainer;
            if(!this.var_193)
            {
      ...
      {
         return findChildByTag(const_1428) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1267,_loc2_,false);
      ...
      {
         return this.content != null && this.var_1055 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_287);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_261);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_233);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(_loc2_)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_251,_loc3_.left,PropertyStruct.const_42,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_230,_loc3_.top,PropertyStruct.const_42,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_269,0 - _loc3_.right,PropertyStruct.const_42,_loc2_));
