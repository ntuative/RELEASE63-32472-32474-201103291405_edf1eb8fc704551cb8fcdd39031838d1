package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_21)
         {
            var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_1183,var_11);
         }
         return var_21;
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_697,false,PropertyStruct.const_38,true) : PropertyDefaults.const_1538);
         _loc1_.push(this.var_1303 != PropertyDefaults.const_1208 ? new PropertyStruct(PropertyDefaults.const_679,this.var_1303,PropertyStruct.const_38,true) : PropertyDefaults.const_1732);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1209 ? new PropertyStruct(PropertyDefaults.const_681,_field.selectable,PropertyStruct.const_38,true) : PropertyDefaults.const_1651);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1085 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_38,true) : PropertyDefaults.const_1691);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_679:
                  this.var_1303 = _loc2_.value as Boolean;
                  if(this.var_1303)
                  {
               ...
               case PropertyDefaults.const_697:
                  ...
                  break;
               case PropertyDefaults.const_1108:
