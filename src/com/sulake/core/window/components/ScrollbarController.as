package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1408:String = "increment";
      
      private static const const_1407:String = "decrement";
      
      private static const const_1006:String = "slider_track";
      
      private static const const_627:String = "slider_bar";
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_175 = false;
         this.var_20 = param12;
         this._horizontal = param2 == WindowType.const_453;
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         ...
         {
            this.var_20.removeEventListener(WindowEvent.const_48,this.onScrollableResized);
            this.var_20.removeEventListener(WindowEvent.const_464,this.onScrollableScrolled);
         }
         this.var_20 = param1;
         if(this.var_20 != null && !this.var_20.disposed)
         {
            this.var_20.addEventListener(WindowEvent.const_48,this.onScrollableResized);
            this.var_20.addEventListener(WindowEvent.const_464,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               this.var_1021 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      {
         return findChildByName(const_1006) as WindowController;
      }
      
      protected function get lift() : WindowController
      {
         return this.track.findChildByName(const_627) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_627:
         ...
         if(param1 == this)
         {
            ...
            else if(param2.type == WindowMouseEvent.const_285)
            {
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_41 || param1.type == WindowTouchEvent.const_490)
         {
            ...
            else if(param2.name == const_1407)
            {
               if(this.var_20)
               {
                  this.var_1244 = true;
            ...
            else if(param2.name == const_1006)
            {
               ...
               _loc6_ = WindowController(param2).getChildByName(ScrollbarController.const_627).rectangle;
               if(this._horizontal)
               {
                  if(_loc4_ < _loc6_.x)
                  {
         ...
         if(param1.type == WindowMouseEvent.const_285)
         {
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         {
            _loc1_ = findParentByName(this.var_1021) as IScrollableWindow;
            if(_loc1_ == null && _parent is IWindowContainer)
            {
               _loc1_ = IWindowContainer(_parent).findChildByName(this.var_1021) as IScrollableWindow;
               if(_loc1_)
               {
