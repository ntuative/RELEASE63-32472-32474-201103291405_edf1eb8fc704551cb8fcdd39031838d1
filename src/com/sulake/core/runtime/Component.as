package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      protected static const const_418:String = "_INTERNAL_EVENT_UNLOCKED";
      ...
      protected var var_835:uint = 0;
      
      protected var var_1300:String = "";
      
      protected var var_2079:String = "";
      ...
      private var var_481:InterfaceStructList;
      ...
      public function Component(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_481 = new InterfaceStructList();
      ...
      {
         var _loc3_:InterfaceStruct = this.var_481.getStructByInterface(param1);
         if(_loc3_ == null)
         {
      ...
      public function release(param1:IID) : uint
      {
         ...
         var _loc2_:InterfaceStruct = this.var_481.getStructByInterface(param1);
         if(_loc2_ == null)
         {
         ...
         if(this.var_1417 & const_1176)
         {
            if(_loc3_ == 0)
            {
               if(this.var_481.getTotalReferenceCount() == 0)
               {
      ...
      protected final function unlock() : void
      {
         ...
         {
            this.var_877 = false;
            this._events.dispatchEvent(new LockEvent(const_418,this));
         }
      }
      
      public function toString() : String
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + this.var_835 + "]";
      }
      ...
      public function toXMLString(param1:uint = 0) : String
      {
         ...
         var _loc7_:uint = this.var_481.length;
         var _loc8_:int = 0;
         while(_loc8_ < _loc7_)
         {
            _loc6_ = this.var_481.getStructByIndex(_loc8_);
