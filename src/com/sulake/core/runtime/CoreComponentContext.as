package com.sulake.core.runtime
{
   ...
   public final class CoreComponentContext extends ComponentContext implements ICore
   {
      ...
      private static const const_1341:String = "asset-libraries";
      
      private static const const_1342:String = "library";
      
      private static const const_1348:String = "service-libraries";
      
      private static const const_1345:String = "library";
      
      private static const const_1349:String = "component-libraries";
      
      private static const const_1346:String = "library";
      
      private static const const_1343:String = "error_data";
      
      private static const const_1347:String = "error_cat";
      
      private static const const_1344:String = "error_desc";
       
      
      private var var_363:LibraryLoaderQueue;
      
      private var var_754:IEventDispatcher;
      
      private var var_517:uint;
      
      private var var_362:Function;
      ...
      public function CoreComponentContext(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         switch(param2 & 0)
         {
            case Core.const_1171:
               ...
               this.var_362 = this.simpleFrameUpdateHandler;
               break;
            case Core.const_750:
               debug("Core; using complex frame update handler");
               this.var_362 = this.complexFrameUpdateHandler;
               break;
            case Core.const_820:
               debug("Core; using profiler frame update handler");
               this.var_362 = this.profilerFrameUpdateHandler;
               this.var_204 = new Profiler(this);
               attachComponent(this.var_204,[new IIDProfiler()]);
               var_400.addChild(new ProfilerViewer(this.var_204));
               break;
            case Core.const_484:
               debug("Core; using experimental frame update handler");
               this.var_362 = this.experimentalFrameUpdateHandler;
               break;
            case Core.CORE_SETUP_DEBUG:
               debug("Core; using debug frame update handler");
               this.var_362 = this.debugFrameUpdateHandler;
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            try
            {
               ...
               {
                  receivers = this.var_258[i] as Array;
      ...
      override public function error(param1:String, param2:Boolean, param3:int = -1, param4:Error = null) : void
      {
         ...
         ErrorReportStorage.setParameter(const_1347,String(param3));
         ErrorReportStorage.setParameter(const_1344,param1);
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         this.var_754 = loadingEventDelegate;
         if(this.var_363 == null)
         {
         ...
         try
         {
            node = config.child(const_1341)[0];
            if(node != null)
            {
               list = node.child(const_1342);
         ...
         try
         {
            node = config.child(const_1349)[0];
            if(node != null)
            {
               list = node.child(const_1346);
               for each(item in list)
               {
                  url = item.attribute("url").toString();
                  loader = new LibraryLoader(context,true,_debug);
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         this.error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1504);
         if(!disposed)
         {
      ...
      private function finalizeLoadingEventDelegate() : void
      {
         if(this.var_754)
         {
            this.var_754.dispatchEvent(new Event(Event.COMPLETE));
         }
      }
      ...
      private function updateLoadingProgress(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(this.var_754)
         {
            ...
            this.var_754.dispatchEvent(new LibraryProgressEvent(_loc2_.url,param1.bytesLoaded,param1.bytesTotal,_loc2_.elapsedTime));
         }
      }
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(!disposed)
               {
                  if(this.var_754)
                  {
                     this.var_754.dispatchEvent(new LibraryProgressEvent(_loc2_.url,this.var_517 - this.var_363.length,this.var_517,_loc2_.elapsedTime));
                  }
               }
            }
         }
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:int = !!this.var_204 ? 0 : this.var_1417 & 0;
         if(_loc3_ == Core.const_484)
         {
            this.var_258[param2].push(new UpdateDelegate(param1,this,param2));
         }
         else
         {
            this.var_258[param2].push(param1);
         }
      }
      ...
      override public function removeUpdateReceiver(param1:IUpdateReceiver) : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:* = null;
         var _loc4_:int = !!this.var_204 ? 0 : this.var_1417 & 0;
         var _loc5_:int = 0;
         while(_loc5_ < CoreComponentContext.const_102)
         {
            _loc3_ = this.var_258[_loc5_] as Array;
      ...
      private function onEnterFrame(param1:Event) : void
      {
         ...
         this.var_362(_loc2_,_loc2_ - this._lastUpdateTimeMs);
      ...
      private function simpleFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         while(priority < CoreComponentContext.const_102)
         {
            ...
            receivers = this.var_258[priority];
            index = 0;
            length = receivers.length;
            while(index != length)
            {
