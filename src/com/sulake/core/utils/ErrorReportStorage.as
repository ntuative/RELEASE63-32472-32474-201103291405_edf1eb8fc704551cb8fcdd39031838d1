package com.sulake.core.utils
{
   public class ErrorReportStorage
   {
      ...
      private static var var_1234:Map = new Map();
      
      private static var var_800:Map = new Map();
      ...
      public static function getDebugData() : String
      {
         ...
         while(_loc2_ < var_800.length)
         {
            if(_loc2_ == 0)
            {
               _loc1_ = var_800.getWithIndex(_loc2_);
            }
            else
            {
               _loc1_ = _loc1_ + " ** " + var_800.getWithIndex(_loc2_);
            }
            _loc2_++;
         }
      ...
      {
         var_800.remove(param1);
         var_800.add(param1,param2);
      }
