package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1756:uint = 1;
      
      protected static const const_1757:uint = 2;
      
      protected static const const_1754:uint = 4;
      
      protected static const const_1755:uint = 3;
      ...
      public static const const_1069:Boolean = false;
      
      public static const const_1682:int = 2;
      
      private static var var_1028:Array = new Array();
      
      private static var var_814:Array = new Array();
      ...
      protected var var_1056:Boolean = false;
      
      protected var var_2871:String = "";
      ...
      protected var var_2941:uint = 0;
      
      protected var var_2870:Boolean = true;
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1069)
         {
            ...
            while(_loc2_ > -1)
            {
               _loc1_ = var_814[_loc2_] as LibraryLoader;
               if(_loc1_ && (_loc1_.ready || _loc1_.disposed))
               {
                  var_814.splice(_loc2_,1);
               }
               _loc2_--;
            }
            while(var_814.length < const_1682 && false)
            {
      ...
      {
         return !!this.var_1055 ? uint(this.var_1315 - this.var_2097) : uint(getTimer() - this.var_2097);
      }
      ...
      {
         if(this.var_1056 && !_disposed)
         {
            this.var_1056 = false;
            if(!this.var_1055 && this.var_239)
            {
               this.var_1315 = -1;
      ...
      {
         if(!this.var_1055 && !_disposed && this.var_1314 > 0)
         {
            try
            {
               this.var_42.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_239,const_1726 - this.var_1314);
            if(this.var_2870)
            {
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         if(this.var_470 == LibraryLoader.const_1755)
         {
