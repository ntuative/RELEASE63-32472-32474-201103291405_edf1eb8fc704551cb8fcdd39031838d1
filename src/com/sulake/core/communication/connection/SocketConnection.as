package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1703:int = 10000;
      ...
      private var var_514:ByteArray;
      
      private var var_1160:IEncryption;
      
      private var var_748:IProtocol;
      
      private var _id:String;
      
      private var var_1159:IMessageClassManager;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         this._id = param1;
         this.var_290 = param2;
         this.var_514 = new ByteArray();
         this.var_1159 = new MessageClassManager();
         this.var_82 = new Socket();
         this.var_361 = new Timer(const_1703,1);
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_1159.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
            this.logConnection("Could not find registered message composer for " + param1);
            return false;
         }
         var _loc5_:ByteArray = this.var_748.encoder.encode(_loc4_,param1.getMessageArray(),param2);
         if(this.var_513)
         {
      ...
      {
         this.var_1159.registerMessages(param1);
      }
      ...
      override public function toString() : String
      {
         ...
         _loc1_ += "Protocol Encoder: " + this.var_748.encoder + "\n";
         _loc1_ += "Protocol Decoder: " + this.var_748.decoder + "\n";
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = this.var_748.getMessages(this.var_514,receivedMessages);
         try
         {
            for each(message in receivedMessages)
            {
               ...
               eventClasses = this.var_1159.getMessageEventClasses(id);
               events = new Array();
            ...
            {
               temp = new ByteArray();
               temp.writeBytes(this.var_514,offset);
               this.var_514 = temp;
               this.logConnection("[SOCKET REST] offset: " + offset + " rest: " + this.var_514.toString());
            }
         }
         catch(e:Error)
         {
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         {
            this.var_514.writeByte(this.var_82.readUnsignedByte());
         }
      }
