package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_815:String = "AssetLibraryLoaded";
      
      public static const const_1469:String = "AssetLibraryUnloaded";
      
      public static const const_1615:String = "AssetLibraryLoadError";
      
      private static const const_431:String = "name";
      
      private static const const_946:String = "asset";
      
      private static const const_947:String = "param";
      
      private static const TYPE:String = "mimeType";
      
      private static const const_945:String = "library";
      
      private static var var_291:Dictionary;
      
      private static var var_1626:LazyAssetProcessor = new LazyAssetProcessor();
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_484;
         this.var_411 = new Dictionary(false);
         this.var_483 = new Dictionary(false);
         this.var_883 = new Dictionary(false);
         this.var_154 = new Dictionary(false);
         var_881.push(this);
      }
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         if(param3 == null)
         {
            throw new Error("Library " + param1.var_582 + " doesn\'t contain valid resource class!");
         }
         var _loc5_:XMLList = param2.child(const_945);
         if(_loc5_ == null)
         {
         ...
         if(_loc5_ != null)
         {
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               _loc7_ = _loc6_.attribute(const_431);
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc11_ = _loc6_.child(const_947);
                  if(_loc11_.length())
                  {
               ...
               {
                  Logger.log("Failed to extract asset " + _loc7_ + " from Library " + param1.var_582 + "!");
               }
               _loc15_++;
            }
         }
      ...
      {
         if(this.var_582 == param1.url && this.var_880)
         {
            if(!this.var_882 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_581);
            }
            this.var_882 = param2;
      ...
      public function unload() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for(_loc1_ in this.var_483)
         {
            _loc2_ = this.var_483[_loc1_];
            _loc2_.assetLoader.dispose();
            delete this.var_483[_loc1_];
         }
         for(_loc1_ in this.var_154)
         {
            delete this.var_154[_loc1_];
         }
         for(_loc1_ in this.var_883)
         {
            delete this.var_883[_loc1_];
         }
         if(this.var_42 != null)
         {
            this.var_42.dispose();
      ...
      {
         var _loc2_:Class = this.var_883[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_483[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1161,this.assetLoadEventHandler);
         ...
         this.var_483[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_483[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_29:
               ...
               if(decl != null)
               {
                  ...
                  if(this.var_154[struct.assetName] == null)
                  {
                     ++this.var_410;
                     this.var_412.push(struct.assetName);
                  }
                  this.var_154[struct.assetName] = asset;
               }
               else
               {
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_483[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         var _loc2_:IAsset = this.var_154[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      {
         return this.var_154[param1] != null || (this.var_581 != null ? this.var_581[param1] != null : false);
      }
      
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         var _loc4_:* = this.var_154[param1] == null;
         if((param3 || _loc4_) && param2)
         {
            ...
            {
               var_1626.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(this.var_411.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_411[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         return AssetTypeDeclaration(this.var_411[param1]);
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in this.var_411)
         {
            _loc3_ = AssetTypeDeclaration(this.var_411[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in this.var_411)
         {
            _loc4_ = AssetTypeDeclaration(this.var_411[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1615));
         this.var_42 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this._manifest.child(const_945);
         if(_loc2_ == null)
         {
