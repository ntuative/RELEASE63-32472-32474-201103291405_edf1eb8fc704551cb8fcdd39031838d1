   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._bitmap)
            {
               try
               {
                  var_523 -= this._bitmap.width * this._bitmap.height * 4;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_107 is BitmapDataAsset)
         {
            ...
            this.var_1467 = BitmapDataAsset(this.var_107).var_1467;
            this.var_1468 = BitmapDataAsset(this.var_107).var_1468;
            if(this._bitmap != null)
            {
               this.var_107 = null;
               return;
