package com.sulake.core.assets
{
   ...
   public class AssetLibraryCollection extends EventDispatcher implements IAssetLibrary
   {
      ...
      protected var var_1048:LoaderContext;
      ...
      public function AssetLibraryCollection(param1:String)
      {
         ...
         this.var_1048 = new LoaderContext(false,ApplicationDomain.currentDomain,null);
         this.var_468 = new AssetLibrary("lib-" + this.var_565++);
         this.var_28.push(this.var_468);
      }
      ...
      public function loadFromFile(param1:LibraryLoader, param2:Boolean = false) : void
      {
         ...
         {
            this.loaderContext = this.var_1048;
         }
         var _loc3_:IAssetLibrary = new AssetLibrary("lib-" + this.var_565++);
