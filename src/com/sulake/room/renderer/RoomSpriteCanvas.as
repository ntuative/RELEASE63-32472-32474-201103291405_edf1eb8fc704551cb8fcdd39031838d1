package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_970:Number = 60;
      
      private static const const_1352:Number = 50;
      ...
      private var var_1420:IRoomRenderingCanvasMouseListener = null;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this.var_259.addChild(this.var_99);
      ...
      {
         this.var_520.x -= param1 - this.var_629;
         this.var_629 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_520.y -= param1 - this.var_625;
         this.var_625 = param1;
      }
      ...
      public function set useMask(param1:Boolean) : void
      {
         ...
         {
            this.var_956 = true;
            if(this.var_135 != null && !this.var_259.contains(this.var_135))
            {
               this.var_259.addChild(this.var_135);
               this.var_99.mask = this.var_135;
            }
         }
         else if(!param1 && this.var_956)
         {
            ...
            if(this.var_135 != null && this.var_259.contains(this.var_135))
            {
               this.var_259.removeChild(this.var_135);
      ...
      public function render(param1:int) : void
      {
         ...
         if(this.var_756 != this.var_2500 || this.var_757 != this.var_2502)
         {
            _loc8_ = true;
         }
         if(this.var_99.x != this.var_629 || this.var_99.y != this.var_625)
         {
            this.var_99.x = this.var_629;
            this.var_99.y = this.var_625;
            _loc8_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_521.sortOn("z",0 | 0);
         if(_loc5_ < this.var_521.length)
         {
            this.var_521.splice(_loc5_);
         }
         var _loc9_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc9_ = this.var_521[_loc4_] as SortableSprite;
            if(_loc9_ != null)
            {
         ...
         this.var_2500 = this.var_756;
         this.var_2502 = this.var_757;
      }
      ...
      private function calculateUpdateInterval(param1:int) : void
      {
         ...
         if(this.var_1421 > 0)
         {
            ...
            if(_loc2_ > const_970 * 3)
            {
               Logger.log("Really slow frame update " + _loc2_ + "ms");
               this.var_2501 = _loc2_;
            }
            if(_loc2_ <= MAXIMUM_VALID_FRAME_UPDATE_INTERVAL)
            {
               ++this.var_758;
               if(this.var_758 == const_341 + 1)
               {
                  this.var_491 = _loc2_;
                  this.var_1798 = this.var_2503;
               }
               else if(this.var_758 > const_341 + 1)
               {
                  _loc3_ = Number(this.var_758 - const_341);
                  this.var_491 = this.var_491 * (_loc3_ - 1) / _loc3_ + Number(_loc2_) / _loc3_;
                  this.var_1798 = this.var_1798 * (_loc3_ - 1) / _loc3_ + Number(this.var_2503) / _loc3_;
                  if(this.var_758 > const_341 + const_1353)
                  {
                     this.var_758 = const_341;
                     if(!this.var_1171 && this.var_491 > const_970)
                     {
                        this.var_1171 = true;
                        Logger.log("Room canvas updating really slow - now entering frame skipping mode...");
                     }
                     else if(this.var_1171 && this.var_491 < const_1352)
                     {
                        this.var_1171 = false;
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         _loc6_.update(this._geometry,param3,!_loc9_.isEmpty || param4,this.var_1799 && this.var_1171);
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  _loc19_ = _loc13_ + _loc18_.offsetX + this.var_629;
                  _loc20_ = _loc14_ + _loc18_.offsetY + this.var_625;
                  if(_loc19_ < this.var_756 && _loc19_ + _loc22_.width >= 0 && (_loc20_ < this.var_757 && _loc20_ + _loc22_.height >= 0))
                  {
                     ...
                     if(_loc17_ == null)
                     {
                        ...
                        this.var_521.push(_loc17_);
                        _loc17_.name = param2;
                     }
                     _loc17_.sprite = _loc18_;
                     _loc17_.x = _loc19_ - this.var_629;
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         if(param1 < this.var_755 || this.var_755 == 0)
         {
      ...
      private function getSortableSprite(param1:int) : SortableSprite
      {
         ...
         return this.var_521[param1] as SortableSprite;
      }
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            this.var_948.identity();
            this.var_948.scale(-1,1);
            this.var_948.translate(data.width,0);
            finalData.draw(data,this.var_948);
            if(name.length > 0)
            {
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            {
               finalData = new ExtendedBitmapData(data.width,data.height,true,16777215);
               finalData.copyPixels(data,data.rect,const_614);
            }
            catch(e:Error)
            {
               finalData = new ExtendedBitmapData(1,1,true,16777215);
            }
            this.var_949.redMultiplier = tR;
            this.var_949.greenMultiplier = tG;
            this.var_949.blueMultiplier = tB;
            finalData.colorTransform(finalData.rect,this.var_949);
            if(name.length > 0)
            {
               this.var_260.addBitmapData(cacheName,finalData);
            }
      ...
      private function createMouseEvent(param1:int, param2:int, param3:int, param4:int, param5:String, param6:String, param7:Boolean, param8:Boolean, param9:Boolean, param10:Boolean) : RoomSpriteMouseEvent
      {
         ...
         var _loc12_:Number = param2 - this.var_757 / 2;
         var _loc13_:* = null;
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  if(_loc12_.indexOf(_loc9_) < 0)
                  {
                     ...
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2498 || param2 != this.var_2499)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         while(_loc1_ < this.var_365.length)
         {
            ...
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1420.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
