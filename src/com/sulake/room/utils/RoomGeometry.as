package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_700:Number = 64;
      
      public static const const_1101:Number = 32;
      ...
      private var var_2900:Number = -500.0;
      
      private var var_2901:Number = 500.0;
      
      private var var_268:Number;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_534 = new Vector3d();
         this._direction = new Vector3d();
         this.var_1229 = new Vector3d();
         this.var_1889 = 1;
         this.var_1891 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1890 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         this.var_1892.assign(this.var_172);
         return this.var_1892;
      }
      
      public function get location() : IVector3d
      {
         this.var_534.assign(this.var_93);
         this.var_534.x *= this.var_449;
         this.var_534.y *= this.var_450;
         this.var_534.z *= this.var_451;
         return this.var_534;
      }
      ...
      {
         if(this.var_449 != param1 * this.var_1889)
         {
            this.var_449 = param1 * this.var_1889;
            ++this.var_168;
         }
      }
      ...
      {
         if(this.var_450 != param1 * this.var_1891)
         {
            this.var_450 = param1 * this.var_1891;
            ++this.var_168;
         }
      }
      ...
      {
         if(this.var_451 != param1 * this.var_1890)
         {
            this.var_451 = param1 * this.var_1890;
            ++this.var_168;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_93.x /= this.var_449;
         this.var_93.y /= this.var_450;
         this.var_93.z /= this.var_451;
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1229.assign(_loc22_);
         }
         else
         {
            this.var_1229.assign(_loc17_);
         }
         ++this.var_168;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= this.var_450;
         _loc2_.z *= this.var_451;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1229);
         if(_loc3_ < this.var_2900 || _loc3_ > this.var_2901)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_450;
            _loc2_.z *= this.var_451;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1229);
         }
         _loc2_.x = _loc4_;
         _loc2_.y = _loc5_;
         _loc2_.z = _loc3_;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_93.x * this.var_449,this.var_93.y * this.var_450,this.var_93.z * this.var_451);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_172;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_449,param2.y * this.var_450,param2.z * this.var_451);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_449,param3.y * this.var_450,param3.z * this.var_451);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_449,param4.y * this.var_450,param4.z * this.var_451);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1101;
         }
         else
         {
            this.scale = const_700;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_700;
      }
