package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      public static const const_1095:int = 2;
      ...
      private var var_2927:IRoomContentLoader;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_617 = [];
         this.var_616 = [];
         events.addEventListener(RoomContentLoadedEvent.const_358,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_438,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_827,this.onContentLoaded);
      }
      ...
      {
         var _loc1_:* = null;
         if(this.var_615 == null || this.var_516 == null)
         {
            return;
         }
         this._state = const_1594;
         if(this.var_1164 != null)
         {
            _loc1_ = this.var_1164;
            this.var_1164 = null;
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc17_:IRoomObjectGraphicVisualization = this.var_516.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = this.var_516.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         if(this.var_940.indexOf(_loc2_) < 0)
         {
            this.var_940.push(_loc2_);
         }
      }
      ...
      private function processLoadedContentTypes() : void
      {
         ...
         while(this.var_940.length > 0)
         {
            _loc2_ = this.var_940[0];
            this.var_940.splice(0,1);
      ...
      private function updateObjectContents(param1:String) : void
      {
         ...
         if(this.var_55 == null || this.var_516 == null)
         {
            return;
         }
         ...
         var _loc7_:IRoomObjectVisualizationData = this.var_516.getRoomObjectVisualizationData(param1,_loc5_,_loc2_);
            ...
            if(_loc9_ != null)
            {
               ...
               for each(_loc12_ in _loc11_)
               {
                  ...
                  while(_loc14_ >= 0)
                  {
                     ...
                     if(_loc15_ != null)
                     {
                        _loc16_ = this.var_516.createRoomObjectVisualization(_loc5_);
                        if(_loc16_ != null)
                        {
                           ...
                           else
                           {
                              ...
                              _loc17_ = this.var_615.createRoomObjectLogic(_loc6_);
