package
{
   ...
   public class HabboMain extends Sprite
   {
      ...
      private static const const_939:Number = 0.71;
      ...
      private var var_1318:HabboTracking;
      ...
      public function HabboMain(param1:DisplayObjectContainer)
      {
         ...
         addEventListener(Event.ADDED_TO_STAGE,this.method_1);
      ...
      {
         removeEventListener(Event.ADDED_TO_STAGE,this.method_1);
      ...
      private function initializeCore() : void
      {
         ...
         catch(error:Error)
         {
            ...
            Core.crash("Failed to initialize the core: " + error.message,Core.const_1237,error);
         }
      }
      ...
      protected function method_1(param1:Event = null) : void
      {
         ...
         {
            Habbo.trackLoginStep(Habbo.const_21);
            Habbo.reportCrash("Failed to prepare the core: " + error.message,Core.const_1237,error);
            Core.dispose();
         }
      }
      ...
      private function prepareCore() : void
      {
         ...
         this.var_1318 = HabboTracking.getInstance();
      ...
      private function onProgressEvent(param1:ProgressEvent) : void
      {
         ...
         if(this.var_1)
         {
            ...
            if(param1 is LibraryProgressEvent)
            {
               ...
               {
                  if(this.var_1318 && !this.var_1318.disposed)
                  {
                     this.var_1318.track("libraryLoaded",_loc4_.fileName,_loc4_.elapsedTime);
                  }
               }
            }
         }
      ...
      private function updateLoadingBar(param1:DisplayObjectContainer, param2:Number) : void
      {
         ...
         var _loc12_:Number = 1 - const_939 + this.var_23.getNumberOfFilesLoaded() / _loc11_ * const_939;
         _loc8_.x = 1 + 1;
         _loc8_.y = 1 + 1;
